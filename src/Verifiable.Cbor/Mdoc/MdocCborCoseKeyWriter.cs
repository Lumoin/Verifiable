...
/// <summary>
/// Writes an <see cref="MdocCoseKey"/> to its on-wire CBOR map per
...
public static class MdocCborCoseKeyWriter
{
    ...
    public static ReadOnlyMemory<byte> Write(MdocCoseKey coseKey)
    {
        ...
        {
            writer.WriteInt32(MdocCoseKeyParameters.Alg);
    ...
    private static int CountEntries(MdocCoseKey coseKey)
    {
