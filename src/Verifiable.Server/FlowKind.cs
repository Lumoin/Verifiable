...
/// <see cref="FlowState"/> records and the routing discriminator for
...
/// </list>
/// <para>
/// Each protocol family surfaces its library-provided flow kinds as singletons
/// through its own <c>extension</c> block over <see cref="FlowKind"/>, so the
/// concrete kinds appear alongside the stateless marker in IntelliSense:
/// </para>
/// <code>
...
/// alongside serialised <see cref="FlowState"/> records. Names must remain
