...
/// <summary>
/// HTTP method name constants used by the endpoint host's matchers,
...
public static class WellKnownHttpMethods
{
    ...
    /// </summary>
    public static string Post { get; } = Utf8Constants.ToInternedString(PostUtf8);
    ...
    /// </summary>
    public static string Put { get; } = Utf8Constants.ToInternedString(PutUtf8);
    ...
    /// </summary>
    public static string Patch { get; } = Utf8Constants.ToInternedString(PatchUtf8);
