...
/// the <see cref="EndpointServer"/> needs to process a request: the
...
/// on <see cref="ExchangeContext"/> after the match wins) consume them. The
...
/// <see cref="ServerIntegration.ResolveEndpointUriAsync"/>,
...
public sealed record ServerEndpoint
{
    ...
    /// matched endpoint's capability on <see cref="ExchangeContext"/>
    ...
    /// <see cref="ExchangeContextServerExtensions.SetMatchPayload"/> for the
    /// handler to read.
    /// </para>
    /// <para>
