...
/// <summary>
/// Terminal failure state applicable to any flow.
...
/// <see cref="Verifiable.Foundation.Automata.TraceEntry{TState,TInput}"/> stream emitted during the run.
...
public sealed record FlowFailed: FlowState
{
    /// <summary>
