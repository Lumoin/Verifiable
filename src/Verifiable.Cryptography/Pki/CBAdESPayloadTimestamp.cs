...
/// <see cref="AdESTimestampContainer"/> (clause 5.4.3.3), the container reused verbatim by the unsigned
...
/// carried unsigned) — rather than reusing <see cref="AdESTimestampContainer"/> bare at three call sites
...
/// disposes it. No separate disposed-flag field is kept here — <see cref="Dispose"/> forwards unconditionally
/// and relies on
/// <see cref="AdESTimestampContainer"/>'s own <c>Dispose</c> being idempotent, the same carrier-disposal
/// convention this library's other disposable carriers follow.
/// </para>
/// </remarks>
[DebuggerDisplay("CBAdESPayloadTimestamp: {TimestampContainer}")]
public sealed class CBAdESPayloadTimestamp: IDisposable
{
    /// <summary>
    ...
    public CBAdESPayloadTimestamp(AdESTimestampContainer timestampContainer)
    {
    ...
    /// <see cref="Dispose"/>.
    /// </summary>
    public AdESTimestampContainer TimestampContainer { get; }
