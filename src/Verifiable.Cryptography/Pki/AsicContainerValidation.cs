...
/// validation, and <see cref="Valid"/> is the only success — the same shape every status enumeration in this
/// library has.
/// </remarks>
...
/// </para>
/// <para>
/// <strong>The Annex A.7 chain walk below is a reconstruction.</strong> The annex states how a chain is
    ...
    private sealed class ContainerValidationRun
    {
        ...
        private EvidenceRecord? TryReadEvidenceRecord(AsicZipEntry entry)
        {
            ...
            catch(Exception exception) when(exception is System.Formats.Asn1.AsnContentException or ArgumentException or InvalidOperationException)
            {
                ...
                //is a status, never an exception leaving the validation.
                return null;
            }
        }
