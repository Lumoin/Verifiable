...
public sealed class PremisObjectCharacteristics: IDisposable
{
...
/// </remarks>
[DebuggerDisplay("{DebuggerDisplay,nq}")]
public sealed class PremisRelationship
{
...
/// </remarks>
[DebuggerDisplay("{DebuggerDisplay,nq}")]
public sealed class PremisObject: IDisposable
{
    /// <summary>
...
/// </remarks>
[DebuggerDisplay("{DebuggerDisplay,nq}")]
public sealed class PremisEvent
{
...
/// </remarks>
[DebuggerDisplay("{DebuggerDisplay,nq}")]
public sealed class PremisAgent
{
...
/// </summary>
[DebuggerDisplay("{DebuggerDisplay,nq}")]
public sealed class PremisRightsGranted
{
...
/// </summary>
[DebuggerDisplay("{DebuggerDisplay,nq}")]
public sealed class PremisCopyrightInformation
{
...
/// </summary>
[DebuggerDisplay("{DebuggerDisplay,nq}")]
public sealed class PremisLicenseInformation
{
...
/// </summary>
[DebuggerDisplay("{DebuggerDisplay,nq}")]
public sealed class PremisStatuteInformation
{
...
/// </summary>
[DebuggerDisplay("{DebuggerDisplay,nq}")]
public sealed class PremisOtherRightsInformation
{
...
/// </remarks>
[DebuggerDisplay("{DebuggerDisplay,nq}")]
public sealed class PremisRightsStatement
{
...
/// </remarks>
[DebuggerDisplay("{DebuggerDisplay,nq}")]
public sealed class PremisDocument: IDisposable
{
    /// <summary>
