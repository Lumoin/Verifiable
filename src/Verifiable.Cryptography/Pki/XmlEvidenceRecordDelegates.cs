...
/// successful parse. The shape is the one every seam in this library has.
/// </remarks>
...
public sealed class XmlEvidenceRecordParseResult: IDisposable
{
...
/// context type in this namespace applies.
/// </remarks>
[DebuggerDisplay("XmlEvidenceRecordParseContext: {Document.Length} octets")]
public sealed class XmlEvidenceRecordParseContext
{
...
/// this library reserves zero for "not computed".
/// </remarks>
...
public sealed class XmlEvidenceRecordCanonicalizationResult: IDisposable
{
...
public sealed class XmlEvidenceRecordCanonicalizationContext
{
    /// <summary>The Evidence Record document's octets. The caller retains ownership.</summary>
    public required ReadOnlyMemory<byte> Document { get; init; }
...
public sealed class XmlEvidenceRecordWriteResult: IDisposable
{
...
/// the document, and owns nothing afterwards, the same statelessness every context type in this namespace
/// keeps its delegate to.
/// </remarks>
[DebuggerDisplay("XmlEvidenceRecordWriteContext: {EvidenceRecord.Chains.Count} chains")]
public sealed class XmlEvidenceRecordWriteContext
{
