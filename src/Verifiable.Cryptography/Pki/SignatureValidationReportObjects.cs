...
/// signatures. This library validates one signature at a time and no engine block produces such a reference, so
...
public sealed record ValidationObject
{
    ...
    /// otherwise. No block of this library's engine populates this member.
    /// </summary>
...
/// models for EU trusted lists, and is reused here rather than duplicated (the same reuse principle this
/// library applies for Table 6 evidence).
/// </remarks>
...
/// surface; this member exists for the shape's completeness
