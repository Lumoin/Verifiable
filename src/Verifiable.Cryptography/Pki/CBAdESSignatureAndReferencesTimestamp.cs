...
/// <see cref="AdESTimestampContainer"/> (clause 5.4.3.3), reused verbatim across every time-stamp-token
...
public sealed class CBAdESSignatureAndReferencesTimestamp: IDisposable
{
    /// <summary>
    ...
    public CBAdESSignatureAndReferencesTimestamp(AdESTimestampContainer timestampContainer)
    {
