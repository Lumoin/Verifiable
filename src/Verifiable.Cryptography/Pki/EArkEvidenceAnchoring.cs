...
public sealed class EArkProvenanceAnchorPlan
{
    /// <summary>Gets what stating the plan concluded.</summary>
    public required EArkProvenanceAnchorStatus Status { get; init; }

    /// <summary>Gets the entries the anchor is to cover, in the order they were resolved. Not owned by this instance.</summary>
...
/// </summary>
public sealed class EArkProvenanceAnchorContext
{
    /// <summary>Gets the package snapshot the plan resolves references against. Not owned by this instance.</summary>
...
/// </remarks>
[DebuggerDisplay("{DebuggerDisplay,nq}")]
public sealed class EArkProvenanceAnchorVerification: IDisposable
{
...
/// </summary>
public sealed class EArkProvenanceAnchorVerificationContext
{
...
public static class EArkEvidenceAnchoring
{
    ...
    public static EArkProvenanceAnchorPlan StatePlan(EArkProvenanceAnchorContext context)
    {
        ...
        //relative path may lead with. Ordinal, for the reason every other name comparison in this codebase is:
