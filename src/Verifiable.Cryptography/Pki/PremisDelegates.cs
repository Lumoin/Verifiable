...
public sealed class PremisParseResult: IDisposable
{
...
/// type in this namespace applies.
/// </remarks>
[DebuggerDisplay("PremisParseContext: {Document.Length} octets")]
public sealed class PremisParseContext
{
...
public sealed class PremisEncodeResult: IDisposable
{
...
public sealed class PremisEncodeContext
{
