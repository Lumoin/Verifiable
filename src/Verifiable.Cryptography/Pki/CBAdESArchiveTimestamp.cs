...
/// <see cref="AdESTimestampContainer"/> (clause 5.4.3.3, CB-5.3.5.1-04), reused verbatim by the signed
...
/// variant — implemented at the CBOR layer against the concrete COSE wire structure, not by this type (the
/// algorithm's closing sentence cites "step 11)" for the byte string it means to name;
...
/// relies on <see cref="AdESTimestampContainer"/>'s own <c>Dispose</c> being idempotent.
/// </para>
/// </remarks>
[DebuggerDisplay("CBAdESArchiveTimestamp: {TimestampContainer}")]
public sealed class CBAdESArchiveTimestamp: IDisposable
{
    /// <summary>
    ...
    public CBAdESArchiveTimestamp(AdESTimestampContainer timestampContainer)
    {
