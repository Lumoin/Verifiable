...
/// <see cref="AdESTimestampContainer"/> (clause 5.4.3.3), reused verbatim by the signed <c>adoTst</c>
...
/// (CB-5.3.1-05/06, label <c>1</c>) — rather than reusing <see cref="AdESTimestampContainer"/> bare with
...
public sealed class CBAdESSignatureTimestamp: IDisposable
{
    /// <summary>
    ...
    public CBAdESSignatureTimestamp(AdESTimestampContainer timestampContainer)
    {
