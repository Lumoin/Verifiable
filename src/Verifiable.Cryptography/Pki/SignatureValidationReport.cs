...
/// serialization-agnostic reduction: the specific structured shapes this library
/// knows how to state precisely — a certificate chain, a revocation status, an algorithm assessment — get their
/// own type (<see cref="AssociatedValidationReportDataElement"/>'s dedicated members); this type is reserved for the
...
/// format-facts seam here (<see cref="SignatureFacts"/>) does not yet surface that value as a
...
/// a future revision adds that member. This is a stated reduction, not a silent gap.
/// </para>
/// <para>
...
public sealed class SignatureIdentifierElement
{
...
/// </summary>
/// <remarks>
/// This library treats a TS 119 172-1 policy-file parser as out of scope; no block of this
...
public sealed class IndividualValidationConstraintReport
{
...
public sealed class ValidationConstraintsEvaluationReport
{
...
/// validation run owns.
/// </remarks>
public sealed class SignersDocument
{
...
/// XAdES and JAdES name. Modelling every Annex A shape is out of scope; this record carries the
...
public sealed class SignerInformationElement
{
...
/// integration point this library does not yet wire up: no block of this library's engine populates it.
/// </remarks>
[DebuggerDisplay("SignatureQuality: {QualityIndicators.Count} indicators")]
public sealed class SignatureQuality
{
    /// <summary>Initializes a new <see cref="SignatureQuality"/>.</summary>
    /// <param name="qualityIndicators">The quality URIs.</param>
    public SignatureQuality(IReadOnlyList<string> qualityIndicators)
    {
        QualityIndicators = qualityIndicators;
    }

    /// <summary>The quality URIs.</summary>
    public IReadOnlyList<string> QualityIndicators { get; }
}
...
public sealed class RevocationStatusInformationReportElement
{
    ...
    /// <summary>The CRL or OCSP response used for determining the revocation status, when the run retained it as a distinct object; <see langword="null"/> when it did not (<see cref="CertificateRevocationReportData"/> does not carry it).</summary>
...
public sealed class AdditionalValidationReportData
{
    /// <summary>Initializes a new <see cref="AdditionalValidationReportData"/>.</summary>
    /// <param name="items">The additional information, as type-value tuples.</param>
    public AdditionalValidationReportData(IReadOnlyList<TypedReportData> items)
    {
        Items = items;
    }

    /// <summary>The additional information, as type-value tuples.</summary>
    public IReadOnlyList<TypedReportData> Items { get; }
}
...
/// <remarks>
/// <para>
/// This type does not duplicate the fields of the engine's Table 6 evidence — it
...
public sealed class AssociatedValidationReportDataElement
{
...
public sealed class SignatureValidationReportElement
{
