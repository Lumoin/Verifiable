...
/// <remarks>
/// <para>
/// <strong>Table mislabeling, corrected.</strong> Annex C's printed
/// table mislabels the symbolic OID name of the "Proof of sender", "Proof of approval" and
/// "Proof of creation" rows as <c>id-cti-ets-proofOfOrigin</c> — a spec-original copy/paste
/// defect, verbatim-verified against the source PDF (three of six rows print
/// <c>id-cti-ets-proofOfOrigin OBJECT IDENTIFIER ::= { ... }</c> with a distinct, correct
/// numeric arc suffix per row but a symbolic name copy-pasted from row 1 three times). Callers
