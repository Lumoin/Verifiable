...
[DebuggerDisplay("LocalizedText: {Language}={Value}")]
...
/// </summary>
[DebuggerDisplay("TrustedListPostalAddress: {Locality}, {CountryName}")]
...
public sealed class TrustedListSchemeInformation
{
    ...
    private string DebuggerDisplay => $"TrustedListSchemeInformation({TslType}, territory={SchemeTerritory ?? "none"}, seq={TslSequenceNumber}, {PointersToOtherTrustedLists.Count} pointers)";
}
...
/// </summary>
[DebuggerDisplay("OtherTrustedListPointerAdditionalInformation: territory={SchemeTerritory}, mime={MimeType}")]
public sealed class OtherTrustedListPointerAdditionalInformation
{
