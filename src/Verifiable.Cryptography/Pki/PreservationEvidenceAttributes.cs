...
/// </para>
/// <para>
/// <strong>These attributes and this library's evidence self-description say the same three things.</strong> The
...
/// may carry the standardised attributes and still be read by <see cref="EArkEvidencePlacement"/>, and so a package
...
public static class PreservationEvidenceAttributes
{
    ...
    /// record <see cref="EArkEvidencePlacement"/> reads for placement.
    /// </summary>
    /// <param name="evidenceRecord">The Evidence Record.</param>
    ...
    /// self-description record <see cref="EArkEvidencePlacement"/> reads for placement.
    /// </summary>
    /// <param name="signedData">The Signed Data Object.</param>
    /// <param name="signerIndex">The zero-based index of the <c>SignerInfo</c>.</param>
