...
/// every context type in this namespace applies.
/// </para>
/// <para>
...
public sealed class PreservationMessageEncodeResult: IDisposable
{
...
/// </remarks>
[DebuggerDisplay("{DebuggerDisplay,nq}")]
public sealed class PreservationMessageEncodeContext
{
...
public sealed class PreservationMessageParseResult: IDisposable
{
...
/// </remarks>
[DebuggerDisplay("{DebuggerDisplay,nq}")]
public sealed class PreservationMessageParseContext
{
