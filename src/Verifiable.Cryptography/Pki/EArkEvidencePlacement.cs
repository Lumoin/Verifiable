...
public sealed class EArkEvidenceArtifactFacts
{
    ...
    /// </para>
    /// <para>
    /// <strong>Ownership.</strong> Not owned by this instance: the reader that produced the record disposes it,
...
/// </summary>
public sealed class EArkEvidencePlacementContext
{
    ...
    /// <summary>Gets the artifact's own entry of the package snapshot, whose octets the fixity is computed over. Not owned by this instance.</summary>
...
/// </remarks>
[DebuggerDisplay("{DebuggerDisplay,nq}")]
public sealed class EArkEvidencePlacementResult: IDisposable
{
