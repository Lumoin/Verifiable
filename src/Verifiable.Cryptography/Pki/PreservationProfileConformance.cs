...
/// package assessors in this library already make: an undecided item is not a pass.
/// </para>
/// <para>
...
public static class PreservationProfileConformance
{
    ...
    /// <remarks>
    /// <para>
    /// This is where the one self-description convention this library defines meets the requirement that asked for
