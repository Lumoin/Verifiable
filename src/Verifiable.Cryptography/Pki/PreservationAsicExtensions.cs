...
/// </para>
/// </remarks>
public abstract class PreservationAsicExtensionPayload: IDisposable
{
...
/// </para>
/// <para>
/// Equality is the identifier plus the version, compared ordinally: a container is addressed by the exact
/// characters a service assigned it, so two extensions naming the same container and the same version are the
/// same statement.
/// </para>
/// </remarks>
[DebuggerDisplay("{DebuggerDisplay,nq}")]
public sealed class PreservationContainerIdExtension: PreservationAsicExtensionPayload, IEquatable<PreservationContainerIdExtension>
{
    /// <inheritdoc/>
    ...
    /// <inheritdoc/>
    public bool Equals(PreservationContainerIdExtension? other)
    {
        return other is not null
            && string.Equals(PreservationObjectId, other.PreservationObjectId, StringComparison.Ordinal)
    ...
    {
        return Equals(obj as PreservationContainerIdExtension);
    }
    ...
    {
        return HashCode.Combine(PreservationObjectId, VersionId);
    }


    /// <summary>Reports whether two extensions name the same container identifier and version.</summary>
    public static bool operator ==(PreservationContainerIdExtension? left, PreservationContainerIdExtension? right)
    {
        return left is null ? right is null : left.Equals(right);
    }


    /// <summary>Reports whether two extensions name a different container identifier or version.</summary>
    public static bool operator !=(PreservationContainerIdExtension? left, PreservationContainerIdExtension? right)
    {
        return !(left == right);
    }
...
/// </para>
/// <para>
/// Equality is that day's: the extension states one period and nothing more, so two extensions naming the same
/// calendar day state the same period.
/// </para>
/// </remarks>
[DebuggerDisplay("PreservationPeriodExtension: {Period}")]
public sealed class PreservationPeriodExtension: PreservationAsicExtensionPayload, IEquatable<PreservationPeriodExtension>
{
    /// <inheritdoc/>
    ...
    /// <inheritdoc/>
    public bool Equals(PreservationPeriodExtension? other)
    {
        return other is not null && Period == other.Period;
    }
    ...
    public override bool Equals(object? obj)
    {
        return Equals(obj as PreservationPeriodExtension);
    }
    ...
    /// <summary>Reports whether two extensions name the same preservation period.</summary>
    public static bool operator ==(PreservationPeriodExtension? left, PreservationPeriodExtension? right)
    {
        return left is null ? right is null : left.Equals(right);
    }


    /// <summary>Reports whether two extensions name a different preservation period.</summary>
    public static bool operator !=(PreservationPeriodExtension? left, PreservationPeriodExtension? right)
    {
        return !(left == right);
    }
...
/// </para>
/// <para>
/// Equality follows from that: since the value is kept exactly as written, two extensions naming the same
/// submitter compare equal under an ordinal comparison of <see cref="Submitter"/> and no other rule would be
/// faithful to a value the clause leaves unformatted.
/// </para>
/// </remarks>
[DebuggerDisplay("PreservationSubmitterExtension: {Submitter}")]
public sealed class PreservationSubmitterExtension: PreservationAsicExtensionPayload, IEquatable<PreservationSubmitterExtension>
{
    /// <inheritdoc/>
    ...
    /// <inheritdoc/>
    public bool Equals(PreservationSubmitterExtension? other)
    {
        return other is not null && string.Equals(Submitter, other.Submitter, StringComparison.Ordinal);
    }
    ...
    public override bool Equals(object? obj)
    {
        return Equals(obj as PreservationSubmitterExtension);
    }
    ...
    public override int GetHashCode()
    {
        return HashCode.Combine(Submitter);
    }


    /// <summary>Reports whether two extensions name the same submitter.</summary>
    public static bool operator ==(PreservationSubmitterExtension? left, PreservationSubmitterExtension? right)
    {
        return left is null ? right is null : left.Equals(right);
    }


    /// <summary>Reports whether two extensions name a different submitter.</summary>
    public static bool operator !=(PreservationSubmitterExtension? left, PreservationSubmitterExtension? right)
    {
        return !(left == right);
    }
...
/// </para>
/// <para>
/// Equality is <see cref="Reference"/>'s, compared ordinally — the discipline the CA1056 justification below
/// already states for this property: the reference names a container by its exact characters, and any
/// normalising comparison would let two different containers pass for one.
/// </para>
/// </remarks>
...
public sealed class PreservationIsUpdatedVersionOfExtension: PreservationAsicExtensionPayload, IEquatable<PreservationIsUpdatedVersionOfExtension>
{
    /// <inheritdoc/>
    ...
    /// <inheritdoc/>
    public bool Equals(PreservationIsUpdatedVersionOfExtension? other)
    {
    ...
    public override bool Equals(object? obj)
    {
        return Equals(obj as PreservationIsUpdatedVersionOfExtension);
    }
    ...
    /// <summary>Reports whether two extensions name the same predecessor container.</summary>
    public static bool operator ==(PreservationIsUpdatedVersionOfExtension? left, PreservationIsUpdatedVersionOfExtension? right)
    {
        return left is null ? right is null : left.Equals(right);
    }


    /// <summary>Reports whether two extensions name a different predecessor container.</summary>
    public static bool operator !=(PreservationIsUpdatedVersionOfExtension? left, PreservationIsUpdatedVersionOfExtension? right)
    {
        return !(left == right);
    }
...
/// </para>
/// <para>
/// Equality is the algorithm identifier's, matched ordinally against another instance the same way it is
/// matched against a registry entry — two extensions asking for the same canonicalization are one instruction,
/// whichever parse produced them.
/// </para>
/// </remarks>
...
public sealed class PreservationCanonicalizationMethodExtension: PreservationAsicExtensionPayload, IEquatable<PreservationCanonicalizationMethodExtension>
{
    /// <inheritdoc/>
    ...
    /// <inheritdoc/>
    public bool Equals(PreservationCanonicalizationMethodExtension? other)
    {
        return other is not null && string.Equals(Algorithm, other.Algorithm, StringComparison.Ordinal);
    }
    ...
    public override bool Equals(object? obj)
    {
        return Equals(obj as PreservationCanonicalizationMethodExtension);
    }
    ...
    public override int GetHashCode()
    {
        return HashCode.Combine(Algorithm);
    }


    /// <summary>Reports whether two extensions name the same canonicalization algorithm.</summary>
    public static bool operator ==(PreservationCanonicalizationMethodExtension? left, PreservationCanonicalizationMethodExtension? right)
    {
        return left is null ? right is null : left.Equals(right);
    }


    /// <summary>Reports whether two extensions name a different canonicalization algorithm.</summary>
    public static bool operator !=(PreservationCanonicalizationMethodExtension? left, PreservationCanonicalizationMethodExtension? right)
    {
        return !(left == right);
    }
...
public sealed class PreservationValidationReportExtension: PreservationAsicExtensionPayload
{
    /// <inheritdoc/>
...
/// </para>
/// <para>
/// Equality is an ordinal comparison of <see cref="Reference"/>: the extension asserts one link and is
/// identified by which data object it points at, so the pointer's exact characters decide sameness.
/// </para>
/// </remarks>
...
public sealed class PreservationIsMetaDataOfExtension: PreservationAsicExtensionPayload, IEquatable<PreservationIsMetaDataOfExtension>
{
    /// <inheritdoc/>
    ...
    /// <inheritdoc/>
    public bool Equals(PreservationIsMetaDataOfExtension? other)
    {
        return other is not null && string.Equals(Reference, other.Reference, StringComparison.Ordinal);
    }
    ...
    public override bool Equals(object? obj)
    {
        return Equals(obj as PreservationIsMetaDataOfExtension);
    }
    ...
    /// <summary>Reports whether two extensions name the same described data object.</summary>
    public static bool operator ==(PreservationIsMetaDataOfExtension? left, PreservationIsMetaDataOfExtension? right)
    {
        return left is null ? right is null : left.Equals(right);
    }


    /// <summary>Reports whether two extensions name a different described data object.</summary>
    public static bool operator !=(PreservationIsMetaDataOfExtension? left, PreservationIsMetaDataOfExtension? right)
    {
        return !(left == right);
    }
