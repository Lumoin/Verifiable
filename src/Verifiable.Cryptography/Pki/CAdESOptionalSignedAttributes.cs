...
/// ETSI EN 319 122-1 V1.3.1</see> clause 6.3 that fall outside the mandatory attribute assembly
/// (<c>content-type</c>, <c>message-digest</c>, <c>signing-time</c>, <c>signing-certificate-v2</c>).
/// </summary>
/// <remarks>
/// This is the "options record for the OPTIONAL attribute set only" this library uses when
...
/// </remarks>
public sealed class CAdESOptionalSignedAttributes
{
    /// <summary>
...
/// </summary>
public sealed class CAdESCommitmentType
{
    ...
    /// (<c>COMMITMENT-QUALIFIER</c>, clause 5.2.3) is not separately modelled; a caller that needs
...
/// here.
/// </summary>
public sealed class CAdESSignerLocation
{
...
/// </summary>
public sealed class CAdESContentReference
{
...
/// </summary>
public sealed class CAdESSignaturePolicyIdentifier
{
    ...
    /// <c>SPUserNotice</c>, <c>SPDocSpecification</c>) are not separately modelled; a caller that
...
/// type offers the <c>claimedAttributes</c> arm alone.
/// </summary>
/// <remarks>
/// <para>
...
/// a claimed role with <see cref="CmsAttribute.Create(string, ReadOnlySpan{byte}, BaseMemoryPool)"/>
...
/// </para>
/// </remarks>
public sealed class CAdESSignerAttributesV2
{
    /// <summary>
