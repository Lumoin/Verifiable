...
/// </remarks>
public sealed class CAdESValidationMaterial
{
...
/// </summary>
public sealed class CAdESSignatureTimestampContext
{
...
/// </summary>
public sealed class CAdESArchiveTimestampContext
{
...
/// </remarks>
public sealed class CAdESCountersignatureContext
{
...
/// <see cref="CAdESSignatureAugmentation.AddSignaturePolicyStore"/>, not by this type.
/// </summary>
public sealed class CAdESSignaturePolicyStore
{
...
public static class CAdESSignatureAugmentation
{
    ...
    /// Secure by default: both context types' <c>EnforceSigningCertificateValidity</c> defaults to
