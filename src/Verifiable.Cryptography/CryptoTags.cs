...
public static class CryptoTags
{
    ...
    public static Tag P256PublicKey { get; } = Tag.Create(CryptoAlgorithm.P256).With(Purpose.Verification).With(EncodingScheme.EcCompressed);

    /// <summary>Tag for P-256 private keys used for signing. Raw encoding.</summary>
    public static Tag P256PrivateKey { get; } = Tag.Create(CryptoAlgorithm.P256).With(Purpose.Signing).With(EncodingScheme.Raw);

    /// <summary>Tag for P-256 signature values.</summary>
    public static Tag P256Signature { get; } = Tag.Create(CryptoAlgorithm.P256).With(Purpose.Signature).With(EncodingScheme.Raw);

    /// <summary>
    /// Tag for P-256 public keys used in ECDH key agreement.
    /// Uncompressed encoding: <c>0x04 || X || Y</c>.
    /// </summary>
    public static Tag P256ExchangePublicKey { get; } = Tag.Create(CryptoAlgorithm.P256).With(Purpose.Exchange).With(EncodingScheme.EcUncompressed);

    /// <summary>Tag for P-256 private key scalars used in ECDH key agreement. Raw encoding.</summary>
    public static Tag P256ExchangePrivateKey { get; } = Tag.Create(CryptoAlgorithm.P256).With(Purpose.Exchange).With(EncodingScheme.Raw);

    /// <summary>Tag for P-384 public keys used for signature verification. Compressed encoding.</summary>
    public static Tag P384PublicKey { get; } = Tag.Create(CryptoAlgorithm.P384).With(Purpose.Verification).With(EncodingScheme.EcCompressed);

    /// <summary>Tag for P-384 private keys used for signing. Raw encoding.</summary>
    public static Tag P384PrivateKey { get; } = Tag.Create(CryptoAlgorithm.P384).With(Purpose.Signing).With(EncodingScheme.Raw);

    /// <summary>Tag for P-384 signature values.</summary>
    public static Tag P384Signature { get; } = Tag.Create(CryptoAlgorithm.P384).With(Purpose.Signature).With(EncodingScheme.Raw);

    /// <summary>Tag for P-521 public keys used for signature verification. Compressed encoding.</summary>
    public static Tag P521PublicKey { get; } = Tag.Create(CryptoAlgorithm.P521).With(Purpose.Verification).With(EncodingScheme.EcCompressed);

    /// <summary>Tag for P-521 private keys used for signing. Raw encoding.</summary>
    public static Tag P521PrivateKey { get; } = Tag.Create(CryptoAlgorithm.P521).With(Purpose.Signing).With(EncodingScheme.Raw);

    /// <summary>Tag for P-521 signature values.</summary>
    public static Tag P521Signature { get; } = Tag.Create(CryptoAlgorithm.P521).With(Purpose.Signature).With(EncodingScheme.Raw);

    /// <summary>Tag for secp256k1 public keys used for signature verification. Compressed encoding.</summary>
    public static Tag Secp256k1PublicKey { get; } = Tag.Create(CryptoAlgorithm.Secp256k1).With(Purpose.Verification).With(EncodingScheme.EcCompressed);

    /// <summary>Tag for secp256k1 private keys used for signing. Raw encoding.</summary>
    public static Tag Secp256k1PrivateKey { get; } = Tag.Create(CryptoAlgorithm.Secp256k1).With(Purpose.Signing).With(EncodingScheme.Raw);

    /// <summary>Tag for secp256k1 signature values.</summary>
    public static Tag Secp256k1Signature { get; } = Tag.Create(CryptoAlgorithm.Secp256k1).With(Purpose.Signature).With(EncodingScheme.Raw);

    /// <summary>Tag for RSA-2048 public keys. DER encoding.</summary>
    public static Tag Rsa2048PublicKey { get; } = Tag.Create(CryptoAlgorithm.Rsa2048).With(Purpose.Verification).With(EncodingScheme.Der);

    /// <summary>Tag for RSA-2048 private keys. PKCS#1 encoding.</summary>
    public static Tag Rsa2048PrivateKey { get; } = Tag.Create(CryptoAlgorithm.Rsa2048).With(Purpose.Signing).With(EncodingScheme.Pkcs1);

    /// <summary>Tag for RSA-2048 signature values.</summary>
    public static Tag Rsa2048Signature { get; } = Tag.Create(CryptoAlgorithm.Rsa2048).With(Purpose.Signature).With(EncodingScheme.Raw);

    /// <summary>Tag for RSA-4096 public keys. DER encoding.</summary>
    public static Tag Rsa4096PublicKey { get; } = Tag.Create(CryptoAlgorithm.Rsa4096).With(Purpose.Verification).With(EncodingScheme.Der);

    /// <summary>Tag for RSA-4096 private keys. PKCS#1 encoding.</summary>
    public static Tag Rsa4096PrivateKey { get; } = Tag.Create(CryptoAlgorithm.Rsa4096).With(Purpose.Signing).With(EncodingScheme.Pkcs1);
    ...
    public static Tag RsaSha256PssSignature { get; } = Tag.Create(CryptoAlgorithm.RsaSha256Pss).With(Purpose.Signature).With(EncodingScheme.Raw);

    /// <summary>Tag for RSA-SHA384 PKCS#1 v1.5 signatures.</summary>
    public static Tag RsaSha384Pkcs1Signature { get; } = Tag.Create(CryptoAlgorithm.RsaSha384).With(Purpose.Signature).With(EncodingScheme.Raw);

    /// <summary>Tag for RSA-SHA384 PSS signatures.</summary>
    public static Tag RsaSha384PssSignature { get; } = Tag.Create(CryptoAlgorithm.RsaSha384Pss).With(Purpose.Signature).With(EncodingScheme.Raw);

    /// <summary>Tag for RSA-SHA512 PKCS#1 v1.5 signatures.</summary>
    public static Tag RsaSha512Pkcs1Signature { get; } = Tag.Create(CryptoAlgorithm.RsaSha512).With(Purpose.Signature).With(EncodingScheme.Raw);

    /// <summary>Tag for RSA-SHA512 PSS signatures.</summary>
    public static Tag RsaSha512PssSignature { get; } = Tag.Create(CryptoAlgorithm.RsaSha512Pss).With(Purpose.Signature).With(EncodingScheme.Raw);
    ...
    public static Tag RsaIso9796d2Signature { get; } = Tag.Create(CryptoAlgorithm.RsaIso9796d2).With(Purpose.Signature).With(EncodingScheme.Raw);

    /// <summary>Tag for Ed25519 public keys. Raw encoding.</summary>
    public static Tag Ed25519PublicKey { get; } = Tag.Create(CryptoAlgorithm.Ed25519).With(Purpose.Verification).With(EncodingScheme.Raw);

    /// <summary>Tag for Ed25519 private keys. Raw encoding.</summary>
    public static Tag Ed25519PrivateKey { get; } = Tag.Create(CryptoAlgorithm.Ed25519).With(Purpose.Signing).With(EncodingScheme.Raw);

    /// <summary>Tag for Ed25519 signature values.</summary>
    public static Tag Ed25519Signature { get; } = Tag.Create(CryptoAlgorithm.Ed25519).With(Purpose.Signature).With(EncodingScheme.Raw);

    /// <summary>Tag for X25519 public keys used in ECDH key agreement. Raw encoding.</summary>
    public static Tag X25519PublicKey { get; } = Tag.Create(CryptoAlgorithm.X25519).With(Purpose.Exchange).With(EncodingScheme.Raw);

    /// <summary>Tag for X25519 private keys used in ECDH key agreement. Raw encoding.</summary>
    public static Tag X25519PrivateKey { get; } = Tag.Create(CryptoAlgorithm.X25519).With(Purpose.Exchange).With(EncodingScheme.Raw);

    /// <summary>Tag for Windows platform encrypted data.</summary>
    public static Tag WindowsPlatformEncrypted { get; } = Tag.Create(CryptoAlgorithm.WindowsPlatformEncrypted).With(Purpose.Encryption).With(EncodingScheme.Raw);

    /// <summary>Tag for ML-DSA-44 public keys (NIST FIPS 204, security level 2).</summary>
    public static Tag MlDsa44PublicKey { get; } = Tag.Create(CryptoAlgorithm.MlDsa44).With(Purpose.Verification).With(EncodingScheme.Raw);

    /// <summary>Tag for ML-DSA-44 private keys (NIST FIPS 204, security level 2).</summary>
    public static Tag MlDsa44PrivateKey { get; } = Tag.Create(CryptoAlgorithm.MlDsa44).With(Purpose.Signing).With(EncodingScheme.Raw);

    /// <summary>Tag for ML-DSA-44 signature values.</summary>
    public static Tag MlDsa44Signature { get; } = Tag.Create(CryptoAlgorithm.MlDsa44).With(Purpose.Signature).With(EncodingScheme.Raw);

    /// <summary>Tag for ML-DSA-65 public keys (NIST FIPS 204, security level 3).</summary>
    public static Tag MlDsa65PublicKey { get; } = Tag.Create(CryptoAlgorithm.MlDsa65).With(Purpose.Verification).With(EncodingScheme.Raw);

    /// <summary>Tag for ML-DSA-65 private keys (NIST FIPS 204, security level 3).</summary>
    public static Tag MlDsa65PrivateKey { get; } = Tag.Create(CryptoAlgorithm.MlDsa65).With(Purpose.Signing).With(EncodingScheme.Raw);

    /// <summary>Tag for ML-DSA-65 signature values.</summary>
    public static Tag MlDsa65Signature { get; } = Tag.Create(CryptoAlgorithm.MlDsa65).With(Purpose.Signature).With(EncodingScheme.Raw);

    /// <summary>Tag for ML-DSA-87 public keys (NIST FIPS 204, security level 5).</summary>
    public static Tag MlDsa87PublicKey { get; } = Tag.Create(CryptoAlgorithm.MlDsa87).With(Purpose.Verification).With(EncodingScheme.Raw);

    /// <summary>Tag for ML-DSA-87 private keys (NIST FIPS 204, security level 5).</summary>
    public static Tag MlDsa87PrivateKey { get; } = Tag.Create(CryptoAlgorithm.MlDsa87).With(Purpose.Signing).With(EncodingScheme.Raw);

    /// <summary>Tag for ML-DSA-87 signature values.</summary>
    public static Tag MlDsa87Signature { get; } = Tag.Create(CryptoAlgorithm.MlDsa87).With(Purpose.Signature).With(EncodingScheme.Raw);

    /// <summary>Tag for ML-KEM-512 public keys (NIST FIPS 203, security level 1).</summary>
    public static Tag MlKem512PublicKey { get; } = Tag.Create(CryptoAlgorithm.MlKem512).With(Purpose.Encryption).With(EncodingScheme.Raw);

    /// <summary>Tag for ML-KEM-512 private keys (NIST FIPS 203, security level 1).</summary>
    public static Tag MlKem512PrivateKey { get; } = Tag.Create(CryptoAlgorithm.MlKem512).With(Purpose.Exchange).With(EncodingScheme.Raw);

    /// <summary>Tag for ML-KEM-768 public keys (NIST FIPS 203, security level 3).</summary>
    public static Tag MlKem768PublicKey { get; } = Tag.Create(CryptoAlgorithm.MlKem768).With(Purpose.Encryption).With(EncodingScheme.Raw);

    /// <summary>Tag for ML-KEM-768 private keys (NIST FIPS 203, security level 3).</summary>
    public static Tag MlKem768PrivateKey { get; } = Tag.Create(CryptoAlgorithm.MlKem768).With(Purpose.Exchange).With(EncodingScheme.Raw);

    /// <summary>Tag for ML-KEM-1024 public keys (NIST FIPS 203, security level 5).</summary>
    public static Tag MlKem1024PublicKey { get; } = Tag.Create(CryptoAlgorithm.MlKem1024).With(Purpose.Encryption).With(EncodingScheme.Raw);

    /// <summary>Tag for ML-KEM-1024 private keys (NIST FIPS 203, security level 5).</summary>
    public static Tag MlKem1024PrivateKey { get; } = Tag.Create(CryptoAlgorithm.MlKem1024).With(Purpose.Exchange).With(EncodingScheme.Raw);
    ...
    /// under the same key.
    /// </summary>
    public static Tag AesGcmIv { get; } = Tag.Create(CryptoAlgorithm.P256).With(Purpose.Nonce).With(EncodingScheme.Raw);

    /// <summary>
    /// Tag for AES-GCM ciphertext produced by a P-256 ECDH-ES content encryption operation.
    /// </summary>
    public static Tag AesGcmCiphertext { get; } = Tag.Create(CryptoAlgorithm.P256).With(Purpose.Encryption).With(EncodingScheme.Raw);
    ...
    /// </summary>
    public static Tag AesGcmAuthTag { get; } = Tag.Create(CryptoAlgorithm.P256).With(Purpose.Mac).With(EncodingScheme.Raw);
    ...
    /// </summary>
    public static Tag AesGcmAad { get; } = Tag.Create(CryptoAlgorithm.P256).With(Purpose.Data).With(EncodingScheme.Raw);

    /// <summary>
    /// Tag for plaintext produced by an AES-GCM decryption operation whose content
    /// encryption key was derived via P-256 ECDH-ES.
    /// </summary>
    public static Tag AesGcmDecryptedContent { get; } = Tag.Create(CryptoAlgorithm.P256).With(Purpose.Decrypted).With(EncodingScheme.Raw);

    /// <summary>
    /// Tag for a content encryption key derived via P-256 ECDH-ES and Concat KDF for
    /// use in an AES-GCM operation.
    /// </summary>
    public static Tag AesGcmCek { get; } = Tag.Create(CryptoAlgorithm.P256).With(Purpose.Encryption).With(EncodingScheme.Raw);
    ...
    /// </summary>
    public static Tag Xc20pIv { get; } = Tag.Create(CryptoAlgorithm.X25519).With(Purpose.Nonce).With(EncodingScheme.Raw);

    /// <summary>
    /// Tag for XChaCha20-Poly1305 ciphertext produced by an X25519 ECDH-ES content encryption operation.
    /// </summary>
    public static Tag Xc20pCiphertext { get; } = Tag.Create(CryptoAlgorithm.X25519).With(Purpose.Encryption).With(EncodingScheme.Raw);
    ...
    /// </summary>
    public static Tag Xc20pAuthTag { get; } = Tag.Create(CryptoAlgorithm.X25519).With(Purpose.Mac).With(EncodingScheme.Raw);
    ...
    /// </summary>
    public static Tag Xc20pAad { get; } = Tag.Create(CryptoAlgorithm.X25519).With(Purpose.Data).With(EncodingScheme.Raw);

    /// <summary>
    /// Tag for plaintext produced by an XChaCha20-Poly1305 decryption operation whose content
    /// encryption key was derived via X25519 ECDH-ES.
    /// </summary>
    public static Tag Xc20pDecryptedContent { get; } = Tag.Create(CryptoAlgorithm.X25519).With(Purpose.Decrypted).With(EncodingScheme.Raw);
    ...
    /// </summary>
    public static Tag Xc20pCek { get; } = Tag.Create(CryptoAlgorithm.X25519).With(Purpose.Encryption).With(EncodingScheme.Raw);
    ...
    /// </summary>
    public static Tag AesKwKeyEncryptionKey { get; } = Tag.Create(CryptoAlgorithm.Aes256).With(Purpose.Encryption).With(EncodingScheme.Raw);
    ...
    /// </summary>
    public static Tag AesKwWrappedKey { get; } = Tag.Create(CryptoAlgorithm.Aes256).With(Purpose.Wrapped).With(EncodingScheme.Raw);

    /// <summary>
    /// Tag for a content encryption key recovered by
    /// <see href="https://www.rfc-editor.org/rfc/rfc3394">RFC 3394</see> unwrapping.
    /// </summary>
    public static Tag AesKwUnwrappedKey { get; } = Tag.Create(CryptoAlgorithm.Aes256).With(Purpose.Encryption).With(EncodingScheme.Raw);
    ...
    /// </summary>
    public static Tag AesCbcHmacIv { get; } = Tag.Create(CryptoAlgorithm.Aes256).With(Purpose.Nonce).With(EncodingScheme.Raw);
    ...
    /// </summary>
    public static Tag AesCbcHmacCiphertext { get; } = Tag.Create(CryptoAlgorithm.Aes256).With(Purpose.Encryption).With(EncodingScheme.Raw);
    ...
    /// HMAC-SHA-512 output.
    /// </summary>
    public static Tag AesCbcHmacAuthTag { get; } = Tag.Create(CryptoAlgorithm.Aes256).With(Purpose.Hmac).With(EncodingScheme.Raw);
    ...
    /// </summary>
    public static Tag AesCbcHmacAad { get; } = Tag.Create(CryptoAlgorithm.Aes256).With(Purpose.Data).With(EncodingScheme.Raw);
    ...
    /// </summary>
    public static Tag AesCbcHmacDecryptedContent { get; } = Tag.Create(CryptoAlgorithm.Aes256).With(Purpose.Decrypted).With(EncodingScheme.Raw);
    ...
    /// </summary>
    public static Tag AesCbcHmacCek { get; } = Tag.Create(CryptoAlgorithm.Aes256).With(Purpose.Encryption).With(EncodingScheme.Raw);
    ...
    public static Tag BrainpoolP224r1PublicKey { get; } = Tag.Create(CryptoAlgorithm.BrainpoolP224r1).With(Purpose.Verification).With(EncodingScheme.EcCompressed);

    /// <summary>Tag for Brainpool P-224r1 private keys used for signing. Raw encoding.</summary>
    public static Tag BrainpoolP224r1PrivateKey { get; } = Tag.Create(CryptoAlgorithm.BrainpoolP224r1).With(Purpose.Signing).With(EncodingScheme.Raw);

    /// <summary>Tag for Brainpool P-224r1 signature values (IEEE P1363 r || s).</summary>
    public static Tag BrainpoolP224r1Signature { get; } = Tag.Create(CryptoAlgorithm.BrainpoolP224r1).With(Purpose.Signature).With(EncodingScheme.Raw);

    /// <summary>Tag for Brainpool P-256r1 public keys used for signature verification. Compressed encoding.</summary>
    public static Tag BrainpoolP256r1PublicKey { get; } = Tag.Create(CryptoAlgorithm.BrainpoolP256r1).With(Purpose.Verification).With(EncodingScheme.EcCompressed);

    /// <summary>Tag for Brainpool P-256r1 private keys used for signing. Raw encoding.</summary>
    public static Tag BrainpoolP256r1PrivateKey { get; } = Tag.Create(CryptoAlgorithm.BrainpoolP256r1).With(Purpose.Signing).With(EncodingScheme.Raw);

    /// <summary>Tag for Brainpool P-256r1 signature values (IEEE P1363 r || s).</summary>
    public static Tag BrainpoolP256r1Signature { get; } = Tag.Create(CryptoAlgorithm.BrainpoolP256r1).With(Purpose.Signature).With(EncodingScheme.Raw);

    /// <summary>Tag for Brainpool P-320r1 public keys used for signature verification. Compressed encoding.</summary>
    public static Tag BrainpoolP320r1PublicKey { get; } = Tag.Create(CryptoAlgorithm.BrainpoolP320r1).With(Purpose.Verification).With(EncodingScheme.EcCompressed);

    /// <summary>Tag for Brainpool P-320r1 private keys used for signing. Raw encoding.</summary>
    public static Tag BrainpoolP320r1PrivateKey { get; } = Tag.Create(CryptoAlgorithm.BrainpoolP320r1).With(Purpose.Signing).With(EncodingScheme.Raw);

    /// <summary>Tag for Brainpool P-320r1 signature values (IEEE P1363 r || s).</summary>
    public static Tag BrainpoolP320r1Signature { get; } = Tag.Create(CryptoAlgorithm.BrainpoolP320r1).With(Purpose.Signature).With(EncodingScheme.Raw);

    /// <summary>Tag for Brainpool P-384r1 public keys used for signature verification. Compressed encoding.</summary>
    public static Tag BrainpoolP384r1PublicKey { get; } = Tag.Create(CryptoAlgorithm.BrainpoolP384r1).With(Purpose.Verification).With(EncodingScheme.EcCompressed);

    /// <summary>Tag for Brainpool P-384r1 private keys used for signing. Raw encoding.</summary>
    public static Tag BrainpoolP384r1PrivateKey { get; } = Tag.Create(CryptoAlgorithm.BrainpoolP384r1).With(Purpose.Signing).With(EncodingScheme.Raw);

    /// <summary>Tag for Brainpool P-384r1 signature values (IEEE P1363 r || s).</summary>
    public static Tag BrainpoolP384r1Signature { get; } = Tag.Create(CryptoAlgorithm.BrainpoolP384r1).With(Purpose.Signature).With(EncodingScheme.Raw);

    /// <summary>Tag for Brainpool P-512r1 public keys used for signature verification. Compressed encoding.</summary>
    public static Tag BrainpoolP512r1PublicKey { get; } = Tag.Create(CryptoAlgorithm.BrainpoolP512r1).With(Purpose.Verification).With(EncodingScheme.EcCompressed);

    /// <summary>Tag for Brainpool P-512r1 private keys used for signing. Raw encoding.</summary>
    public static Tag BrainpoolP512r1PrivateKey { get; } = Tag.Create(CryptoAlgorithm.BrainpoolP512r1).With(Purpose.Signing).With(EncodingScheme.Raw);

    /// <summary>Tag for Brainpool P-512r1 signature values (IEEE P1363 r || s).</summary>
    public static Tag BrainpoolP512r1Signature { get; } = Tag.Create(CryptoAlgorithm.BrainpoolP512r1).With(Purpose.Signature).With(EncodingScheme.Raw);
    ...
    public static Tag BrainpoolP224r1ExchangePublicKey { get; } = Tag.Create(CryptoAlgorithm.BrainpoolP224r1).With(Purpose.Exchange).With(EncodingScheme.EcUncompressed);

    /// <summary>Tag for Brainpool P-224r1 private key scalars used in ECDH key agreement. Raw encoding.</summary>
    public static Tag BrainpoolP224r1ExchangePrivateKey { get; } = Tag.Create(CryptoAlgorithm.BrainpoolP224r1).With(Purpose.Exchange).With(EncodingScheme.Raw);

    /// <summary>Tag for Brainpool P-256r1 public keys used in ECDH key agreement. Uncompressed encoding.</summary>
    public static Tag BrainpoolP256r1ExchangePublicKey { get; } = Tag.Create(CryptoAlgorithm.BrainpoolP256r1).With(Purpose.Exchange).With(EncodingScheme.EcUncompressed);

    /// <summary>Tag for Brainpool P-256r1 private key scalars used in ECDH key agreement. Raw encoding.</summary>
    public static Tag BrainpoolP256r1ExchangePrivateKey { get; } = Tag.Create(CryptoAlgorithm.BrainpoolP256r1).With(Purpose.Exchange).With(EncodingScheme.Raw);

    /// <summary>Tag for Brainpool P-320r1 public keys used in ECDH key agreement. Uncompressed encoding.</summary>
    public static Tag BrainpoolP320r1ExchangePublicKey { get; } = Tag.Create(CryptoAlgorithm.BrainpoolP320r1).With(Purpose.Exchange).With(EncodingScheme.EcUncompressed);

    /// <summary>Tag for Brainpool P-320r1 private key scalars used in ECDH key agreement. Raw encoding.</summary>
    public static Tag BrainpoolP320r1ExchangePrivateKey { get; } = Tag.Create(CryptoAlgorithm.BrainpoolP320r1).With(Purpose.Exchange).With(EncodingScheme.Raw);

    /// <summary>Tag for Brainpool P-384r1 public keys used in ECDH key agreement. Uncompressed encoding.</summary>
    public static Tag BrainpoolP384r1ExchangePublicKey { get; } = Tag.Create(CryptoAlgorithm.BrainpoolP384r1).With(Purpose.Exchange).With(EncodingScheme.EcUncompressed);

    /// <summary>Tag for Brainpool P-384r1 private key scalars used in ECDH key agreement. Raw encoding.</summary>
    public static Tag BrainpoolP384r1ExchangePrivateKey { get; } = Tag.Create(CryptoAlgorithm.BrainpoolP384r1).With(Purpose.Exchange).With(EncodingScheme.Raw);

    /// <summary>Tag for Brainpool P-512r1 public keys used in ECDH key agreement. Uncompressed encoding.</summary>
    public static Tag BrainpoolP512r1ExchangePublicKey { get; } = Tag.Create(CryptoAlgorithm.BrainpoolP512r1).With(Purpose.Exchange).With(EncodingScheme.EcUncompressed);

    /// <summary>Tag for Brainpool P-512r1 private key scalars used in ECDH key agreement. Raw encoding.</summary>
    public static Tag BrainpoolP512r1ExchangePrivateKey { get; } = Tag.Create(CryptoAlgorithm.BrainpoolP512r1).With(Purpose.Exchange).With(EncodingScheme.Raw);
    ...
    /// </para>
    /// </remarks>
    public static Tag MdocIssuerSignedItemRandom { get; } = Tag.Create(Purpose.Salt).With(EncodingScheme.Raw);
    ...
    /// </para>
    /// </remarks>
    public static Tag CoseEncodedSign1 { get; } = Tag.Create(Purpose.Signature).With(EncodingScheme.Cose);
    ...
    /// </para>
    /// </remarks>
    public static Tag AlgorithmAgnosticSignature { get; } = Tag.Create(Purpose.Signature).With(EncodingScheme.Raw);
    ...
    /// </summary>
    public static Tag CoseEncodedMac0 { get; } = Tag.Create(Purpose.Mac).With(EncodingScheme.Cose);
    ...
    /// </para>
    /// </remarks>
    public static Tag CoseEncodedProtectedHeader { get; } = Tag.Create(Purpose.Data).With(EncodingScheme.Cose);
    ...
    /// </summary>
    public static Tag CmsEncodedSignedData { get; } = Tag.Create(Purpose.Signature).With(EncodingScheme.Der);
    ...
    /// Uncompressed encoding: <c>0x04 || X || Y</c>.
    /// </summary>
    public static Tag P384ExchangePublicKey { get; } = Tag.Create(CryptoAlgorithm.P384).With(Purpose.Exchange).With(EncodingScheme.EcUncompressed);

    /// <summary>Tag for P-384 private key scalars used in ECDH key agreement. Raw encoding.</summary>
    public static Tag P384ExchangePrivateKey { get; } = Tag.Create(CryptoAlgorithm.P384).With(Purpose.Exchange).With(EncodingScheme.Raw);

    /// <summary>
    /// Tag for P-521 public keys used in ECDH key agreement.
    /// Uncompressed encoding: <c>0x04 || X || Y</c>.
    /// </summary>
    public static Tag P521ExchangePublicKey { get; } = Tag.Create(CryptoAlgorithm.P521).With(Purpose.Exchange).With(EncodingScheme.EcUncompressed);

    /// <summary>Tag for P-521 private key scalars used in ECDH key agreement. Raw encoding.</summary>
    public static Tag P521ExchangePrivateKey { get; } = Tag.Create(CryptoAlgorithm.P521).With(Purpose.Exchange).With(EncodingScheme.Raw);
    ...
    /// </summary>
    public static Tag Sha256Digest { get; } = Tag.Create(HashAlgorithmName.SHA256).With(Purpose.Digest).With(EncodingScheme.Raw);

    /// <summary>
    /// Tag for SHA-384 digest values. Carries
    /// <see cref="HashAlgorithmName.SHA384"/>, <see cref="Purpose.Digest"/>, raw encoding.
    /// </summary>
    public static Tag Sha384Digest { get; } = Tag.Create(HashAlgorithmName.SHA384).With(Purpose.Digest).With(EncodingScheme.Raw);
    ...
    public static Tag HmacSha256Key { get; } = Tag.Create(HashAlgorithmName.SHA256).With(Purpose.Hmac).With(EncodingScheme.Raw);

    /// <summary>Tag for HMAC-SHA-384 keys.</summary>
    public static Tag HmacSha384Key { get; } = Tag.Create(HashAlgorithmName.SHA384).With(Purpose.Hmac).With(EncodingScheme.Raw);

    /// <summary>Tag for HMAC-SHA-512 keys.</summary>
    public static Tag HmacSha512Key { get; } = Tag.Create(HashAlgorithmName.SHA512).With(Purpose.Hmac).With(EncodingScheme.Raw);

    /// <summary>Tag for HMAC-SHA-256 output values.</summary>
    public static Tag HmacSha256Value { get; } = Tag.Create(HashAlgorithmName.SHA256).With(Purpose.Hmac).With(EncodingScheme.Raw);

    /// <summary>Tag for HMAC-SHA-384 output values.</summary>
    public static Tag HmacSha384Value { get; } = Tag.Create(HashAlgorithmName.SHA384).With(Purpose.Hmac).With(EncodingScheme.Raw);

    /// <summary>Tag for HMAC-SHA-512 output values.</summary>
    public static Tag HmacSha512Value { get; } = Tag.Create(HashAlgorithmName.SHA512).With(Purpose.Hmac).With(EncodingScheme.Raw);
    ...
    public static Tag TripleDesCbc { get; } = Tag.Create(CryptoAlgorithm.TripleDes).With(Purpose.Encryption).With(EncodingScheme.Raw);

    /// <summary>Tag for plaintext recovered by a two-key Triple-DES CBC decryption.</summary>
    public static Tag TripleDesCbcDecryptedContent { get; } = Tag.Create(CryptoAlgorithm.TripleDes).With(Purpose.Decrypted).With(EncodingScheme.Raw);
    ...
    /// </summary>
    public static Tag RetailMac { get; } = Tag.Create(CryptoAlgorithm.TripleDes).With(Purpose.Mac).With(EncodingScheme.Raw);
    ...
    public static Tag Aes128Cbc { get; } = Tag.Create(CryptoAlgorithm.Aes128).With(Purpose.Encryption).With(EncodingScheme.Raw);

    /// <summary>Tag for plaintext recovered by an AES-128 CBC decryption.</summary>
    public static Tag Aes128CbcDecryptedContent { get; } = Tag.Create(CryptoAlgorithm.Aes128).With(Purpose.Decrypted).With(EncodingScheme.Raw);

    /// <summary>
    /// Tag for AES-128 CMAC (RFC 4493) keys and the MAC values produced under them.
    /// </summary>
    public static Tag Aes128Cmac { get; } = Tag.Create(CryptoAlgorithm.Aes128).With(Purpose.Mac).With(EncodingScheme.Raw);
