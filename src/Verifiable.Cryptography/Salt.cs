...
public sealed class Salt(IMemoryOwner<byte> sensitiveMemory, Tag tag): SensitiveMemory(sensitiveMemory, tag), IEquatable<Salt>
{
        ...
        MemoryPool<byte> pool)
    {
        ...
        Purpose purpose = tag.TryGet<Purpose>(out Purpose p) ? p : Purpose.Data;
