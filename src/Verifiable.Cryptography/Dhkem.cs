...
public static class Dhkem
{
    ...
    /// </summary>
    private static readonly byte[] HpkeV1Prefix = "HPKE-v1"u8.ToArray();

    /// <summary>
    /// The Section 4.1 ASCII prefix a KEM's <c>suite_id</c> begins with:
    /// <c>suite_id = concat("KEM", I2OSP(kem_id, 2))</c>.
    /// </summary>
    private static readonly byte[] KemSuiteIdPrefix = "KEM"u8.ToArray();

    /// <summary>
    /// The Section 4.1 label naming DHKEM's extract stage: <c>eae_prk = LabeledExtract("",
    /// "eae_prk", dh)</c>.
    /// </summary>
    private static readonly byte[] EaePrkLabel = "eae_prk"u8.ToArray();
    ...
    /// </summary>
    private static readonly byte[] SharedSecretLabel = "shared_secret"u8.ToArray();
    ...
    /// HKDF-SHA256.
    /// </summary>
    public static readonly DhkemSuite P256HkdfSha256 = new(KemId: 0x0010, NSecret: 32, HashAlgorithm: HashAlgorithmName.SHA256);
