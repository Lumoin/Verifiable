...
public static class WellKnownJwkMemberNames
{
    ...
    public static readonly string Oth = "oth";
    ...
    /// <summary>
    /// The RFC 7518 private / secret JWK members: the EC/OKP private scalar
    /// (<see cref="D"/>), the RSA private factors (<see cref="D"/>, <see cref="P"/>,
    /// <see cref="Q"/>, <see cref="Dp"/>, <see cref="Dq"/>, <see cref="Qi"/>,
    /// <see cref="Oth"/>), and the symmetric key value (<see cref="K"/>). A PUBLISHED
    /// JWK — a DPoP proof header, a federation Entity Statement <c>jwks</c>, a
