namespace Verifiable.JCose
{
    ...
    public static class WellKnownJwkValues
    {
        ...
        /// <summary>
        /// The <c>jwt</c> JOSE header parameter used to carry a Verifier Attestation JWT in a
        /// signed Authorization Request Object per
        /// <see href="https://openid.net/specs/openid-4-verifiable-presentations-1_0.html#section-12">OID4VP 1.0 §12</see>
        /// and
        /// <see href="https://www.rfc-editor.org/rfc/rfc7515#section-4.1">RFC 7515 §4.1</see>.
        /// </summary>
        ...
        /// <summary>
        /// The <c>keys</c> member of a JWK Set document contains an array of JWK values.
        /// Required at the top level of every JWK Set per
        /// <see href="https://www.rfc-editor.org/rfc/rfc7517#section-5.1">RFC 7517 §5.1</see>.
        /// </summary>
        ...
        /// <summary>
        /// The "pub" parameter carries raw public-key bytes for post-quantum JWK
        /// representations. Applied to <c>kty=AKP</c> keys such as ML-DSA-44, ML-DSA-65,
        /// and ML-DSA-87 where the public key is not composed of named curve coordinates
        /// or RSA factors.
        /// </summary>
        /// <remarks>
        /// See more at <see href="https://datatracker.ietf.org/doc/draft-ietf-jose-pqc-kem">JOSE Post-Quantum Drafts</see>.
        /// </remarks>
        ...
        /// <summary>
        /// The <c>sig</c> value for the <see cref="Use"/> parameter, indicating the key
        /// is used for computing digital signatures or MACs per
        /// <see href="https://www.rfc-editor.org/rfc/rfc7517#section-4.2">RFC 7517 §4.2</see>.
        /// </summary>
        public static readonly string UseSig = "sig";

        /// <summary>
        /// The <c>enc</c> value for the <see cref="Use"/> parameter, indicating the key
        /// is used for encryption per
        /// <see href="https://www.rfc-editor.org/rfc/rfc7517#section-4.2">RFC 7517 §4.2</see>.
        /// </summary>
        /// <remarks>
        /// Distinct from <see cref="Enc"/> which is the <c>enc</c> JWE header parameter
        /// NAME per RFC 7516 §4.1.2. Same string, different semantic context.
        /// </remarks>
        ...
        /// <summary>
        /// The <c>JWT</c> value for the <see cref="Typ"/> parameter per
        ...
        /// <summary>
        /// If <paramref name="property"/> is <see cref="Keys"/> or not.
        /// </summary>
        /// <param name="property">The property</param>.
        /// <returns><see langword="true" /> if is <see cref="Keys"/>; otherwise, <see langword="false" /></returns>.
        public static bool IsKeys(string property)
        {
            return Equals(Keys, property);
        }
        ...
        /// <summary>
        /// If <paramref name="property"/> is <see cref="Jwt"/> or not.
        /// </summary>
        /// <param name="property">The property</param>.
        /// <returns><see langword="true" /> if is <see cref="Jwt"/>; otherwise, <see langword="false" /></returns>.
        public static bool IsJwt(string property)
        {
            return Equals(Jwt, property);
        }
        ...
        public static string GetCanonicalizedValue(string property) => property switch
        {
            ...
            string _ when IsJwt(property) => Jwt,
            ...
            string _ when IsKeys(property) => Keys,
