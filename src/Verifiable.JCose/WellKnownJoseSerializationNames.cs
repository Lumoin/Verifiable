...
public static class WellKnownJoseSerializationNames
{
    ...
    public static string Protected { get; } = Utf8Constants.ToInternedString(ProtectedUtf8);
    ...
    public static string Payload { get; } = Utf8Constants.ToInternedString(PayloadUtf8);
    ...
    public static string Signature { get; } = Utf8Constants.ToInternedString(SignatureUtf8);
    ...
    public static string Signatures { get; } = Utf8Constants.ToInternedString(SignaturesUtf8);
    ...
    public static string Recipients { get; } = Utf8Constants.ToInternedString(RecipientsUtf8);
    ...
    public static string EncryptedKey { get; } = Utf8Constants.ToInternedString(EncryptedKeyUtf8);
    ...
    public static string Iv { get; } = Utf8Constants.ToInternedString(IvUtf8);
    ...
    public static string Ciphertext { get; } = Utf8Constants.ToInternedString(CiphertextUtf8);
    ...
    public static string Tag { get; } = Utf8Constants.ToInternedString(TagUtf8);
    ...
    public static string Aad { get; } = Utf8Constants.ToInternedString(AadUtf8);
}
