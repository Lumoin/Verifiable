...
namespace Verifiable.JCose
{
    ...
    public static class WellKnownJwaValues
    {
        ...
        public static string Hs256 { get; } = Utf8Constants.ToInternedString(Hs256Utf8);
        ...
        /// </summary>
        /// <remarks>See more at <see href="https://www.rfc-editor.org/rfc/rfc7518#section-3.2">HMAC with SHA-2 Functions</see>.</remarks>
        public static string Hs384 { get; } = Utf8Constants.ToInternedString(Hs384Utf8);
        ...
        /// </summary>
        /// <remarks>See more at <see href="https://www.rfc-editor.org/rfc/rfc7518#section-3.2">HMAC with SHA-2 Functions</see>.</remarks>
        public static string Hs512 { get; } = Utf8Constants.ToInternedString(Hs512Utf8);
        ...
        public static string Es256 { get; } = Utf8Constants.ToInternedString(Es256Utf8);
        ...
        /// </summary>
        /// <remarks>See more at <see href="https://www.rfc-editor.org/rfc/rfc7518#section-3.4">Digital Signature with ECDSA</see>.</remarks>
        public static string Es384 { get; } = Utf8Constants.ToInternedString(Es384Utf8);
        ...
        /// </summary>
        /// <remarks>See more at <see href="https://www.rfc-editor.org/rfc/rfc7518#section-3.4">Digital Signature with ECDSA</see>.</remarks>
        public static string Es512 { get; } = Utf8Constants.ToInternedString(Es512Utf8);
        ...
        public static string Es256K { get; } = Utf8Constants.ToInternedString(Es256KUtf8);
        ...
        public static string Ps256 { get; } = Utf8Constants.ToInternedString(Ps256Utf8);
        ...
        /// </summary>
        /// <remarks>See more at <see href="https://www.rfc-editor.org/rfc/rfc7518#section-3.5">Digital Signature with ECDSA</see>.</remarks>
        public static string Ps384 { get; } = Utf8Constants.ToInternedString(Ps384Utf8);
        ...
        /// </summary>
        /// <remarks>See more at <see href="https://www.rfc-editor.org/rfc/rfc7518#section-3.5">Digital Signature with ECDSA</see>.</remarks>
        public static string Ps512 { get; } = Utf8Constants.ToInternedString(Ps512Utf8);
        ...
        public static string Rs256 { get; } = Utf8Constants.ToInternedString(Rs256Utf8);
        ...
        /// </summary>
        /// <remarks>See more at <see href="https://www.rfc-editor.org/rfc/rfc7518#section-3.3">Digital Signature with RSASSA-PKCS1-v1_5</see>.</remarks>
        public static string Rs384 { get; } = Utf8Constants.ToInternedString(Rs384Utf8);
        ...
        /// </summary>
        public static string Ecdha { get; } = Utf8Constants.ToInternedString(EcdhaUtf8);
        ...
        /// </remarks>
        public static string MlDsa44 { get; } = Utf8Constants.ToInternedString(MlDsa44Utf8);
        ...
        /// See <see href="https://datatracker.ietf.org/doc/draft-ietf-cose-dilithium/">ML-DSA for JOSE and COSE</see>.
        /// </remarks>
        public static string MlDsa65 { get; } = Utf8Constants.ToInternedString(MlDsa65Utf8);
        ...
        /// See <see href="https://datatracker.ietf.org/doc/draft-ietf-cose-dilithium/">ML-DSA for JOSE and COSE</see>.
        /// </remarks>
        public static string MlDsa87 { get; } = Utf8Constants.ToInternedString(MlDsa87Utf8);
        ...
        /// </summary>
        public static string Esb256 { get; } = Utf8Constants.ToInternedString(Esb256Utf8);
        ...
        /// </summary>
        public static string Esb320 { get; } = Utf8Constants.ToInternedString(Esb320Utf8);
        ...
        /// </summary>
        public static string Esb384 { get; } = Utf8Constants.ToInternedString(Esb384Utf8);
        ...
        /// </summary>
        public static string Esb512 { get; } = Utf8Constants.ToInternedString(Esb512Utf8);
        ...
        {
            string when IsNone(alg) => None,
            string when IsHs256(alg) => Hs256,
            string when IsHs384(alg) => Hs384,
            string when IsHs512(alg) => Hs512,
            string when IsEs256(alg) => Es256,
            string when IsEs384(alg) => Es384,
            string when IsEs512(alg) => Es512,
            string when IsEs256K(alg) => Es256K,
            string when IsPs256(alg) => Ps256,
            string when IsPs384(alg) => Ps384,
            string when IsPs512(alg) => Ps512,
            string when IsRs256(alg) => Rs256,
            string when IsRs384(alg) => Rs384,
            string when IsRs512(alg) => Rs512,
            string when IsEdDsa(alg) => EdDsa,
            string when IsMlDsa44(alg) => MlDsa44,
            string when IsMlDsa65(alg) => MlDsa65,
            string when IsMlDsa87(alg) => MlDsa87,
            string when IsEsb256(alg) => Esb256,
            string when IsEsb320(alg) => Esb320,
            string when IsEsb384(alg) => Esb384,
            string when IsEsb512(alg) => Esb512,
            string => alg
        };
        ...
        {
            return object.ReferenceEquals(algA, algB) || StringComparer.Ordinal.Equals(algA, algB);
        }
    }
}
