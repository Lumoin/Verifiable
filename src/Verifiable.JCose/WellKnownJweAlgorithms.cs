...
namespace Verifiable.JCose
{
    ...
    public static class WellKnownJweAlgorithms
    {
        ...
        {
            string when IsRsa15(algorithm) => Rsa15,
            string when IsRsaOaep(algorithm) => RsaOaep,
            string when IsRsaOaep256(algorithm) => RsaOaep256,
            string when IsA128Kw(algorithm) => A128Kw,
            string when IsA192Kw(algorithm) => A192Kw,
            string when IsA256Kw(algorithm) => A256Kw,
            string when IsDir(algorithm) => Dir,
            string when IsEcdhEs(algorithm) => EcdhEs,
            string when IsEcdhEsA128Kw(algorithm) => EcdhEsA128Kw,
            string when IsEcdhEsA192Kw(algorithm) => EcdhEsA192Kw,
            string when IsEcdhEsA256Kw(algorithm) => EcdhEsA256Kw,
            string when IsEcdh1Pu(algorithm) => Ecdh1Pu,
            string when IsEcdh1PuA128Kw(algorithm) => Ecdh1PuA128Kw,
            string when IsEcdh1PuA192Kw(algorithm) => Ecdh1PuA192Kw,
            string when IsEcdh1PuA256Kw(algorithm) => Ecdh1PuA256Kw,
            string when IsA128GcmKw(algorithm) => A128GcmKw,
            string when IsA192GcmKw(algorithm) => A192GcmKw,
            string when IsA256GcmKw(algorithm) => A256GcmKw,
            string when IsPbes2Hs256A128Kw(algorithm) => Pbes2Hs256A128Kw,
            string when IsPbes2Hs384A192Kw(algorithm) => Pbes2Hs384A192Kw,
            string when IsPbes2Hs512A256Kw(algorithm) => Pbes2Hs512A256Kw,
            string => algorithm
        };
