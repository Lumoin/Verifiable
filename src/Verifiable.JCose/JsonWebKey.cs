...
/// <c>jwk[WellKnownJwkMemberNames.Kty] = "EC"</c>; both end up as the same dictionary
...
public class JsonWebKey: Dictionary<string, object>, IEquatable<JsonWebKey>
{
    ...
    public string? Kty
    {
        get => TryGetValue(WellKnownJwkMemberNames.Kty, out object? value) ? value as string : null;
        set => SetOrRemove(WellKnownJwkMemberNames.Kty, value);
    }
    ...
    public string? Alg
    {
        get => TryGetValue(WellKnownJwkMemberNames.Alg, out object? value) ? value as string : null;
        set => SetOrRemove(WellKnownJwkMemberNames.Alg, value);
    }
    ...
    public string? Use
    {
        get => TryGetValue(WellKnownJwkMemberNames.Use, out object? value) ? value as string : null;
        set => SetOrRemove(WellKnownJwkMemberNames.Use, value);
    }
    ...
    public string? Kid
    {
        get => TryGetValue(WellKnownJwkMemberNames.Kid, out object? value) ? value as string : null;
        set => SetOrRemove(WellKnownJwkMemberNames.Kid, value);
    }
    ...
    public string? Crv
    {
        get => TryGetValue(WellKnownJwkMemberNames.Crv, out object? value) ? value as string : null;
        set => SetOrRemove(WellKnownJwkMemberNames.Crv, value);
    }
    ...
    public string? X
    {
        get => TryGetValue(WellKnownJwkMemberNames.X, out object? value) ? value as string : null;
        set => SetOrRemove(WellKnownJwkMemberNames.X, value);
    }
    ...
    public string? Y
    {
        get => TryGetValue(WellKnownJwkMemberNames.Y, out object? value) ? value as string : null;
        set => SetOrRemove(WellKnownJwkMemberNames.Y, value);
    }
    ...
    public string? N
    {
        get => TryGetValue(WellKnownJwkMemberNames.N, out object? value) ? value as string : null;
        set => SetOrRemove(WellKnownJwkMemberNames.N, value);
    }
    ...
    public string? E
    {
        get => TryGetValue(WellKnownJwkMemberNames.E, out object? value) ? value as string : null;
        set => SetOrRemove(WellKnownJwkMemberNames.E, value);
    }
    ...
    public string? Pub
    {
        get => TryGetValue(WellKnownJwkMemberNames.Pub, out object? value) ? value as string : null;
        set => SetOrRemove(WellKnownJwkMemberNames.Pub, value);
    }
