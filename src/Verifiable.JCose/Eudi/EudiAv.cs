...
public static class EudiAv
{
    ...
    /// rulebook convention.
    /// </summary>
    public static readonly string AttestationType = "eu.europa.ec.eudi.pseudonym.age_over_18.1";
    ...
    /// </summary>
    public static readonly string DefaultCredentialQueryId = "age_verification";
    ...
    /// </summary>
    public static readonly string SdJwtVct = "urn:eudi:av:1";
    ...
    public static class SdJwt
    {
        ...
        public static readonly string AgeEqualOrOver18 = "age_equal_or_over.18";
