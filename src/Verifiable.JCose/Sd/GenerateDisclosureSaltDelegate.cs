...
/// </para>
/// <para>
/// Test wiring typically uses <see cref="Salt.Generate(int, Tag, System.Buffers.MemoryPool{byte})"/>
/// directly with <c>SensitiveMemoryPool&lt;byte&gt;.Shared</c>; production wiring binds
/// to the application's entropy backend (e.g.,
/// <c>MicrosoftEntropyFunctions.GenerateSalt</c> or
/// <c>BouncyCastleEntropyFunctions.GenerateSalt</c>).
/// </para>
/// </remarks>
