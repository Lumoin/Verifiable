...
public static class TpmEoConstantsExtensions
{
    ...
    /// defines (TPM 2.0 Library Specification, Part 2: Structures, clause 6.8, Table 20). An undefined <c>TPM_EO</c>
    ...
    /// <c>TpmEoComparator.TryEvaluate</c> throwing while a trial session silently folds it unchecked.
    /// </summary>
