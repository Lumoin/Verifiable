...
/// </list>
/// <para>
/// See TPM 2.0 Library Specification, Part 2: Structures, Section 10.12.3, Table 157 (Definition of TPMS_AUTH_RESPONSE Structure).
/// </para>
/// </remarks>
...
public sealed class TpmsAuthResponse: ITpmWireType, IDisposable
{
    ...
    /// </para>
    /// <para>
    /// This enables zero-copy transfer of the nonce to the engine's <c>Sessions.TpmSession</c>
