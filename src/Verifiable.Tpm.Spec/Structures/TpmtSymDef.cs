...
/// </para>
/// <para>
/// <b>Wire format (TPM 2.0 Library Part 2, clause 11.1.6, Table 162):</b>
/// </para>
/// <code>
/// typedef struct {
...
///   <b>no mode</b> for XOR (Part 2, clause 11.1.4, Table 160 - the mode union is empty under the XOR selector).</description></item>
...
/// </list>
/// <para>
/// The <c>details</c> union (Part 2, clause 11.1.5, Table 161) is empty for every algorithm and contributes no
/// wire octets.
/// </para>
/// </remarks>
...
public readonly record struct TpmtSymDef
{
    ...
    /// member overloads the 16-bit field with a <c>TPMI_ALG_HASH</c> selector (Part 2, clause 11.1.3).
    /// </remarks>
    ...
    /// XOR mask KDF uses "the hash algorithm associated with the session" (Part 1, clause 18.2), which the TPM and this
