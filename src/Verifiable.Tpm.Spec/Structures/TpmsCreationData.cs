...
/// </para>
/// <para>
/// Specification reference: TPM 2.0 Library Part 2, clause 15.1, Table 261.
/// </para>
/// </remarks>
...
public sealed class TpmsCreationData: IDisposable
{
    ...
    /// size-zero digest (TPM 2.0 Library Part 4's <c>Object_spt.c</c>'s <c>FillInCreationData()</c>).
    /// <see cref="Parse"/> accepts both
