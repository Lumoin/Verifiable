...
/// </code>
/// <para>
/// Modelled <c>sigAlg</c> arms: <c>TPM_ALG_ECDSA</c>, <c>TPM_ALG_RSASSA</c>, <c>TPM_ALG_RSAPSS</c>, and
/// <c>TPM_ALG_HMAC</c> (<see cref="Hmac"/>). The NULL signature (<c>sigAlg</c> of <c>TPM_ALG_NULL</c>, which
/// selects no member) is not modelled: <see cref="Parse"/> and <see cref="Create"/> refuse it through
/// <see cref="TpmuSignature"/>'s selector check.
/// </para>
/// <para>
/// Specification reference: TPM 2.0 Library Part 2, Section 11.3.6, Table 219.
/// </para>
/// </remarks>
...
public sealed class TpmtSignature: ITpmWireType, IDisposable
{
    ...
    /// buffer — a wire parse of <c>TPMS_SIGNATURE_ECC</c> (Part 2, Section 11.3.2, Table 214), where
