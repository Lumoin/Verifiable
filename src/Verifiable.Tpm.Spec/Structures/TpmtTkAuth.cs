...
/// </para>
/// <para>
/// Specification reference: TPM 2.0 Library Part 2, clause 10.6.6, Table 114.
/// </para>
/// </remarks>
...
public sealed class TpmtTkAuth: IDisposable, ITpmWireType
{
    ...
    /// <summary>
    /// Returns the same metadata-only summary the debugger shows — the tag, the hierarchy and the
    /// digest's octet count, never the digest octets themselves — so an enclosing type's own
