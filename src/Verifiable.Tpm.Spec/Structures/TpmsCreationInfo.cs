...
/// </code>
/// <para>
/// Specification reference: TPM 2.0 Library Part 2, clause 10.11.7, Table 149.
/// </para>
/// </remarks>
...
public sealed class TpmsCreationInfo: ITpmWireType, IDisposable
{
    ...
    /// <summary>
    /// Returns the same metadata-only summary the debugger shows — the object name's and creation
    /// hash's octet lengths, never the octets themselves — so an enclosing type's own diagnostic
