...
/// </code>
/// <para>
/// Specification reference: TPM 2.0 Library Part 2, clause 11.1.16, Table 172.
/// </para>
/// </remarks>
...
public sealed class Tpm2bSensitiveCreate: IDisposable
{
    ...
    /// new object's <c>userAuth</c> plus the secret as the sensitive data (TPM 2.0 Library Part 2, clause 11.1.15).
    ...
    /// key octets as the sensitive data (TPM 2.0 Library Part 2, clause 11.1.15). This is the identical
