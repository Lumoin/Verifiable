...
public static class WellKnownCtapMakeCredentialResponseKeys
{
    ...
    /// (CTAP 2.3 §7.1). Set to <see langword="true"/> exactly when mc Step 9 grants an
    /// enterprise attestation; this authenticator never emits an explicit <see langword="false"/> for
    /// this member, though the writer faithfully round-trips one if given it.
    /// </summary>
    ...
    /// <summary>The <c>unsignedExtensionOutputs</c> member (<c>0x06</c>, Optional): unsigned extension outputs. Not modeled.</summary>
