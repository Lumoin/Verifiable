...
/// (CTAP 2.3 §6.7) — <see cref="WellKnownCtapLastEnrollSampleStatuses.Good"/>
...
/// knob — the outcome-injection seam mirroring <see cref="Verifiable.Cryptography.FillEntropyDelegate"/>'s
