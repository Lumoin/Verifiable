...
/// iterative: every length-prefixed value is checked against a fixed maximum before any allocation,
...
/// shape have already parsed successfully (both are fail-closed, but personalization mismatch
