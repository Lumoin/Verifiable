...
/// boundary — never a live reference into a <see cref="Automata.CtapAuthenticatorState"/>
...
/// <remarks>
/// Persist-then-respond: <see cref="Automata.CtapAuthenticatorSimulator"/> awaits this
