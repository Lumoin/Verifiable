...
/// <summary>
/// Encodes the PERSISTENT subset of a <see cref="CtapAuthenticatorState"/>, plus
/// its personalization fingerprint, into a versioned CBOR snapshot payload.
/// </summary>
/// <param name="state">
...
/// records those secrets came from; the caller owns and must dispose the returned payload.
/// </returns>
/// <remarks>
/// <para>
/// Mirrors the CTAP wire-codec delegate seam's own shape exactly, but this
...
/// </para>
/// <para>
/// A leading format-version integer and the personalization fingerprint are the FIRST bytes written, so
