...
/// so a later <see cref="TryLoadSnapshotAsyncDelegate"/> call observes "no snapshot" (the
...
/// per-call context parameter this delegate takes instead of closing over any caller state
/// (house rule: no closure capture).
/// </param>
/// <param name="cancellationToken">A cancellation token.</param>
/// <remarks>
/// <see cref="Automata.CtapAuthenticatorSimulator"/> drives this delegate — never
