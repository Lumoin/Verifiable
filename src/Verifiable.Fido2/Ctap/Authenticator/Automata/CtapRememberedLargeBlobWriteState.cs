...
/// sibling to <see cref="CtapRememberedGetAssertionState"/>/<see cref="CtapRememberedEnumerateRpsState"/>/
...
/// into <see cref="PendingBuffer"/>, rented ONCE at <see cref="ExpectedLength"/> bytes up front
/// rather than growing per fragment; advanced by every accepted continuation fragment (lines
...
/// GLOBAL discipline, CTAP 2.3 section 6 item 2, line 2871's "MAY assume this globally"; see
...
/// sequence, or <see langword="null"/> when the sequence was installed TOKENLESS (the gate was
...
/// tokenless sequence, since no token exists to expire (documented).
/// </param>
