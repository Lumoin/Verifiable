...
/// <summary>
/// Encodes an <c>authenticatorGetAssertion</c> response model into its CTAP2-canonical CBOR payload
...
/// serialization-agnostic — mirrors <see cref="EncodeCtapMakeCredentialResponseDelegate"/>'s seam shape.
/// The shipped default, <c>Verifiable.Cbor.Ctap.CtapGetAssertionResponseCborWriter.Write</c>, is
/// method-group-compatible with this delegate.
/// </remarks>
public delegate TaggedMemory<byte> EncodeCtapGetAssertionResponseDelegate(CtapGetAssertionResponse response);
