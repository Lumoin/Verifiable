...
/// <summary>
/// Decodes the CTAP2-canonical CBOR parameter map of an <c>authenticatorGetAssertion</c> request into
...
/// </param>
/// <param name="pool">
/// The memory pool the returned model's <see cref="CtapGetAssertionRequest.ClientDataHash"/> and any
/// <see cref="CtapGetAssertionRequest.AllowList"/> credential identifiers rent from.
/// </param>
...
/// <c>Verifiable.Cbor.Ctap.CtapGetAssertionRequestCborReader.Read</c>, is method-group-compatible with
...
/// </exception>
public delegate CtapGetAssertionRequest DecodeCtapGetAssertionRequestDelegate(ReadOnlyMemory<byte> parametersCbor, MemoryPool<byte> pool);
