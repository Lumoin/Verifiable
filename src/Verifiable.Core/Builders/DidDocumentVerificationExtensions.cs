...
namespace Verifiable.Core.Builders
{
    ...
    public static class DidDocumentVerificationExtensions
    {
        extension(DidDocument document)
        {
            ...
            /// </exception>
            /// <remarks>
            /// This method replaces any existing authentication relationships. If multiple authentication
            /// methods are needed, they should be added in a single call or through custom logic.
            /// The verification method referenced by <paramref name="verificationMethodId"/> should exist
            /// in the document's verification method array.
            /// </remarks>
            /// <example>
            /// <code>
            ...
            public DidDocument WithAuthentication(string verificationMethodId)
            {
                ...
                document.Authentication = document.Authentication == null
                    ? [new AuthenticationMethod(verificationMethodId)] : [.. document.Authentication, new AuthenticationMethod(verificationMethodId)];
            ...
            public DidDocument WithAssertionMethod(string verificationMethodId)
            {
                ...
                document.AssertionMethod = document.AssertionMethod == null
                    ? [new AssertionMethod(verificationMethodId)] : [.. document.AssertionMethod, new AssertionMethod(verificationMethodId)];
            ...
            public DidDocument WithKeyAgreement(string verificationMethodId)
            {
                ...
                document.KeyAgreement = document.KeyAgreement == null
                    ? [new KeyAgreementMethod(verificationMethodId)] : [.. document.KeyAgreement, new KeyAgreementMethod(verificationMethodId)];
            ...
            public DidDocument WithCapabilityInvocation(string verificationMethodId)
            {
                ...
                document.CapabilityInvocation = document.CapabilityInvocation == null
                    ? [new CapabilityInvocationMethod(verificationMethodId)] : [.. document.CapabilityInvocation, new CapabilityInvocationMethod(verificationMethodId)];
            ...
            public DidDocument WithCapabilityDelegation(string verificationMethodId)
            {
                ...
                document.CapabilityDelegation = document.CapabilityDelegation == null
                    ? [new CapabilityDelegationMethod(verificationMethodId)] : [.. document.CapabilityDelegation, new CapabilityDelegationMethod(verificationMethodId)];
