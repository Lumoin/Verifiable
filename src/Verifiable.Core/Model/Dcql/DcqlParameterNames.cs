...
public static class DcqlParameterNames
{
    ...
    public static string Meta { get; } = Utf8Constants.ToInternedString(MetaUtf8);
    ...
    public static string ClaimSets { get; } = Utf8Constants.ToInternedString(ClaimSetsUtf8);
    ...
    public static string TrustedAuthorities { get; } = Utf8Constants.ToInternedString(TrustedAuthoritiesUtf8);
    ...
    public static string Multiple { get; } = Utf8Constants.ToInternedString(MultipleUtf8);
    ...
    public static string RequireCryptographicHolderBinding { get; } = Utf8Constants.ToInternedString(RequireCryptographicHolderBindingUtf8);
    ...
    public static string Path { get; } = Utf8Constants.ToInternedString(PathUtf8);
    ...
    public static string Values { get; } = Utf8Constants.ToInternedString(ValuesUtf8);
    ...
    public static string IntentToRetain { get; } = Utf8Constants.ToInternedString(IntentToRetainUtf8);
    ...
    public static string VctValues { get; } = Utf8Constants.ToInternedString(VctValuesUtf8);
    ...
    public static string DoctypeValue { get; } = Utf8Constants.ToInternedString(DoctypeValueUtf8);
    ...
    public static string CredentialSets { get; } = Utf8Constants.ToInternedString(CredentialSetsUtf8);
