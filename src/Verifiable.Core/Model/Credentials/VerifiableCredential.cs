...
namespace Verifiable.Core.Model.Credentials
{
    ...
    public class VerifiableCredential
    {
        ...
        /// <remarks>
        /// <para>
        /// For Data Integrity proofs, each proof contains the cryptosuite identifier,
        /// verification method reference, and the signature value.
        /// </para>
        /// <para>
    ...
    /// <summary>
    /// Represents a related resource with integrity protection as defined in VC Data Model 2.0.
    /// </summary>
    /// <remarks>
    /// <para>
    /// Related resources enable credentials to reference external content while ensuring
    /// that content has not been modified since the credential was issued.
    /// </para>
    /// <para>
    /// See <see href="https://www.w3.org/TR/vc-data-model-2.0/#integrity-of-related-resources">
    /// VC Data Model 2.0 §5.3 Integrity of Related Resources</see>.
    ...
    public class RelatedResource
    {
        ...
        /// <summary>
        /// A cryptographic digest of the resource content for integrity verification.
        /// </summary>
        /// <remarks>
        /// The value is a Subresource Integrity string containing the digest algorithm
        /// and base64-encoded hash value (e.g., <c>sha384-...</c>).
        /// </remarks>
        public string? DigestSRI { get; set; }

        /// <summary>
        /// A multibase-encoded multihash digest of the resource content.
        /// </summary>
    ...
    /// <summary>
    /// Represents a refresh service for obtaining updated credentials as defined in VC Data Model 2.0.
    /// </summary>
    /// <remarks>
    /// <para>
    /// See <see href="https://www.w3.org/TR/vc-data-model-2.0/#refreshing">
    ...
    /// <summary>
    /// Represents terms of use for a credential as defined in VC Data Model 2.0.
    /// </summary>
    /// <remarks>
    /// <para>
    /// Terms of use can express conditions, obligations, or prohibitions that apply
    /// to the credential. They can be specified by either the issuer or the holder.
    /// </para>
    /// <para>
    /// See <see href="https://www.w3.org/TR/vc-data-model-2.0/#terms-of-use">
    /// VC Data Model 2.0 §5.5 Terms of Use</see>.
    ...
    /// <summary>
    /// Represents evidence supporting the claims in a credential as defined in VC Data Model 2.0.
    /// </summary>
    /// <remarks>
    /// <para>
    /// Evidence provides information about the verification process performed before
    /// issuing a credential, supporting the trustworthiness of the claims.
    /// </para>
    /// <para>
    /// See <see href="https://www.w3.org/TR/vc-data-model-2.0/#evidence">
    /// VC Data Model 2.0 §5.6 Evidence</see>.
