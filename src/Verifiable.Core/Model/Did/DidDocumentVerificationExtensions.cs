...
namespace Verifiable.Core.Model.Did
{
    ...
    public static class DidDocumentVerificationExtensions
    {
        ...
        /// <summary>
        /// Helper for adding verification method references to verification relationship arrays.
        /// This method provides the common array manipulation pattern used across all verification relationship types.
        /// </summary>
        /// <typeparam name="T">The specific verification method reference type.</typeparam>
        ...
        /// <param name="factory">Factory function to create the specific reference type.</param>
        ...
        /// <remarks>
        /// This method eliminates repetitive array manipulation code while maintaining optimal efficiency.
        /// The factory function creates the appropriate subclass of <see cref="VerificationMethodReference"/>
        /// for the specific verification relationship type.
        /// </remarks>
        private static DidDocument AddRelationship<T>(
            ...
            Action<DidDocument, T[]> setter) where T : VerificationMethodReference
        {
            ...
            T[] updated = existing is null ? [newItem] : [.. existing, newItem];
