...
public static class DidBuilderExtensions
{
    ...
    /// </code>
    /// </example>
    public static Func<DidDocument, TBuilder, TState?, ValueTask<DidDocument>> CreateDefaultContextTransformation<TBuilder, TState>()
    ...
    /// </code>
    /// </example>
    public static Func<DidDocument, TBuilder, TState?, ValueTask<DidDocument>> CreateContextTransformation<TBuilder, TState>(Context context)
        where TBuilder : IBuilder
    {
        ArgumentNullException.ThrowIfNull(context);
