...
public static class DidBuilderExtensions
{
    ...
    /// </code>
    /// </example>
    public static Func<DidDocument, TBuilder, TState?, DidDocument> CreateDefaultContextTransformation<TBuilder, TState>()
    ...
    /// </code>
    /// </example>
    public static Func<DidDocument, TBuilder, TState?, DidDocument> CreateContextTransformation<TBuilder, TState>(Context context)
        where TBuilder : IBuilder
    {
        ArgumentNullException.ThrowIfNull(context);
