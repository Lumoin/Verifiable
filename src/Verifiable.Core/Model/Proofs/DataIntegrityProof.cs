...
public sealed class DataIntegrityProof: IEquatable<DataIntegrityProof>
{
    ...
    /// <remarks>
    /// <para>
    /// If included, must be an XML Schema <c>dateTimeStamp</c> string in UTC (denoted
    /// by Z at the end) or with a time zone offset.
    /// </para>
    /// <para>
    /// See <see href="https://www.w3.org/TR/vc-data-integrity/#proofs">Data Integrity 1.0 §2.1 Proofs</see>.
    /// </para>
    ...
    /// Must be an XML Schema <c>dateTimeStamp</c> string.
    /// </para>
    /// <para>
    /// See <see href="https://www.w3.org/TR/vc-data-integrity/#proofs">Data Integrity 1.0 §2.1 Proofs</see>.
    /// </para>
