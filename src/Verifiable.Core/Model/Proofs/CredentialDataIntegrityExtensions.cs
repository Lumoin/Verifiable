...
public static class CredentialDataIntegrityExtensions
{
    ...
    extension(VerifiableCredential credential)
    {
        ...
        /// Time provider for proof creation timestamp. If null, <see cref="TimeProvider.System"/> is used.
        /// </param>
            ...
            CancellationToken cancellationToken = default)
        {
            ...
            var proofCreated = DateTimeStampFormat.Format(effectiveTimeProvider.GetUtcNow().UtcDateTime);
        ...
        /// <param name="memoryPool">Memory pool for signature allocation.</param>
        /// <param name="timeProvider">
        /// Time provider for validity period checks. If null, <see cref="TimeProvider.System"/> is used.
        /// </param>
        /// <param name="cancellationToken">Cancellation token.</param>
        /// <returns>The verification result indicating success or the reason for failure.</returns>
        /// <remarks>
        /// <para>
        /// This method implements the proof verification algorithm:
        /// </para>
        /// <list type="number">
        /// <item><description>Check credential validity period.</description></item>
            ...
            CancellationToken cancellationToken = default)
        {
            ...
            var effectiveTimeProvider = timeProvider ?? TimeProvider.System;
            var validityResult = CheckCredentialValidity(credential, effectiveTimeProvider);
    ...
    /// <summary>
    /// Checks the credential's validity period against the current time.
    /// </summary>
    ...
    /// <returns>Success if valid, or failure with the appropriate reason.</returns>
    private static CredentialVerificationResult CheckCredentialValidity(
