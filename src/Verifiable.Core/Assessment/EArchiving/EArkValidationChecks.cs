...
public static class EArkValidationChecks
{
    ...
    /// other name comparison in this codebase is: a reader that folded case would resolve a reference to a file the
    ...
    /// names coverage without handing over what proves it has told the rule nothing it can check, and this
    /// library's fail-closed reading of that is <see cref="EArkClaimReason.SubjectNotSupplied"/> — the same answer a rule
