...
namespace Verifiable.Core.Assessment
{
    ...
    /// <param name="archivingId">
    /// The identifier the calling <see cref="AssessmentArchiver"/> minted for this operation. The
    /// delegate persists the assessment under this identifier and returns a result whose
    /// <see cref="ArchivingResult.ArchivingId"/> is this same value.
    /// </param>
    ...
    /// <param name="ArchivingId">
    /// Identifier for this particular archiving operation, minted by the calling
    /// <see cref="AssessmentArchiver"/> and echoed back unchanged by the archiving delegate.
    /// </param>
    /// <param name="ArchiveId">
    /// Unique identifier for the archive, assigned by the archiving delegate itself to identify
    /// the stored data — distinct from <see cref="ArchivingId"/>, which belongs to the archiver.
    /// </param>
