...
namespace Verifiable.Core.Disclosure;

using JsonPointerType = global::Verifiable.JsonPointer.JsonPointer;
...
/// </para>
/// <para>
/// This type composes <see cref="Verifiable.JsonPointer.JsonPointer"/> rather than
/// duplicating its functionality. For pure JSON Pointer operations without N-Quad
/// support, use <see cref="Verifiable.JsonPointer.JsonPointer"/> directly.
/// </para>
/// <para>
