...
public static class RiscEventTypes
{
    ...
    public static string AccountCredentialChangeRequired { get; } = Utf8Constants.ToInternedString(AccountCredentialChangeRequiredUtf8);
    ...
    public static string AccountPurged { get; } = Utf8Constants.ToInternedString(AccountPurgedUtf8);
    ...
    public static string AccountDisabled { get; } = Utf8Constants.ToInternedString(AccountDisabledUtf8);
    ...
    public static string AccountEnabled { get; } = Utf8Constants.ToInternedString(AccountEnabledUtf8);
    ...
    public static string IdentifierChanged { get; } = Utf8Constants.ToInternedString(IdentifierChangedUtf8);
    ...
    public static string IdentifierRecycled { get; } = Utf8Constants.ToInternedString(IdentifierRecycledUtf8);
    ...
    public static string CredentialCompromise { get; } = Utf8Constants.ToInternedString(CredentialCompromiseUtf8);
    ...
    public static string OptIn { get; } = Utf8Constants.ToInternedString(OptInUtf8);
    ...
    public static string OptOutInitiated { get; } = Utf8Constants.ToInternedString(OptOutInitiatedUtf8);
    ...
    public static string OptOutCancelled { get; } = Utf8Constants.ToInternedString(OptOutCancelledUtf8);
    ...
    public static string OptOutEffective { get; } = Utf8Constants.ToInternedString(OptOutEffectiveUtf8);
    ...
    public static string RecoveryActivated { get; } = Utf8Constants.ToInternedString(RecoveryActivatedUtf8);
    ...
    public static string RecoveryInformationChanged { get; } = Utf8Constants.ToInternedString(RecoveryInformationChangedUtf8);
    ...
    public static string SessionsRevoked { get; } = Utf8Constants.ToInternedString(SessionsRevokedUtf8);
