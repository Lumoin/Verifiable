...
public static class SsfStreamConfigParameterNames
{
    ...
    public static string StreamId { get; } = Utf8Constants.ToInternedString(StreamIdUtf8);
    ...
    public static string EventsSupported { get; } = Utf8Constants.ToInternedString(EventsSupportedUtf8);
    ...
    public static string EventsRequested { get; } = Utf8Constants.ToInternedString(EventsRequestedUtf8);
    ...
    public static string EventsDelivered { get; } = Utf8Constants.ToInternedString(EventsDeliveredUtf8);
    ...
    public static string Delivery { get; } = Utf8Constants.ToInternedString(DeliveryUtf8);
    ...
    public static string MinVerificationInterval { get; } = Utf8Constants.ToInternedString(MinVerificationIntervalUtf8);
    ...
    public static string InactivityTimeout { get; } = Utf8Constants.ToInternedString(InactivityTimeoutUtf8);
}
