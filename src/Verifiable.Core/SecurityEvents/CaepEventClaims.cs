...
public static class CaepEventClaimNames
{
    ...
    public static string InitiatingEntity { get; } = Utf8Constants.ToInternedString(InitiatingEntityUtf8);
...
public static class CaepInitiatingEntityValues
{
    ...
    public static string Admin { get; } = Utf8Constants.ToInternedString(AdminUtf8);
    ...
    public static string Policy { get; } = Utf8Constants.ToInternedString(PolicyUtf8);
    ...
    public static string System { get; } = Utf8Constants.ToInternedString(SystemUtf8);
