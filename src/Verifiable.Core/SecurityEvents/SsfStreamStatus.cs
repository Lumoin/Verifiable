...
public static class SsfStreamStatusValues
{
    ...
    public static string Enabled { get; } = Utf8Constants.ToInternedString(EnabledUtf8);
    ...
    public static string Paused { get; } = Utf8Constants.ToInternedString(PausedUtf8);
    ...
    public static string Disabled { get; } = Utf8Constants.ToInternedString(DisabledUtf8);
