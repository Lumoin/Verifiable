...
public static class SsfMetadataParameterNames
{
    ...
    /// </summary>
    public static string SpecVersion { get; } = Utf8Constants.ToInternedString(SpecVersionUtf8);
    ...
    public static string DeliveryMethodsSupported { get; } = Utf8Constants.ToInternedString(DeliveryMethodsSupportedUtf8);
    ...
    public static string ConfigurationEndpoint { get; } = Utf8Constants.ToInternedString(ConfigurationEndpointUtf8);
    ...
    public static string StatusEndpoint { get; } = Utf8Constants.ToInternedString(StatusEndpointUtf8);
    ...
    public static string AddSubjectEndpoint { get; } = Utf8Constants.ToInternedString(AddSubjectEndpointUtf8);
    ...
    public static string RemoveSubjectEndpoint { get; } = Utf8Constants.ToInternedString(RemoveSubjectEndpointUtf8);
    ...
    public static string VerificationEndpoint { get; } = Utf8Constants.ToInternedString(VerificationEndpointUtf8);
    ...
    /// </summary>
    public static string CriticalSubjectMembers { get; } = Utf8Constants.ToInternedString(CriticalSubjectMembersUtf8);
    ...
    /// </summary>
    public static string AuthorizationSchemes { get; } = Utf8Constants.ToInternedString(AuthorizationSchemesUtf8);
    ...
    /// </summary>
    [SuppressMessage("Design", "CA1056:URI-like properties should not be strings",
        Justification = "This member is the JSON claim NAME literal 'spec_urn' (a wire key compared and serialised as a string), not a dereferenceable System.Uri.")]
    public static string SpecUrn { get; } = Utf8Constants.ToInternedString(SpecUrnUtf8);
    ...
    /// </summary>
    public static string DefaultSubjects { get; } = Utf8Constants.ToInternedString(DefaultSubjectsUtf8);
    ...
    public static string DefaultSubjectsAll { get; } = Utf8Constants.ToInternedString(DefaultSubjectsAllUtf8);
    ...
    public static string DefaultSubjectsNone { get; } = Utf8Constants.ToInternedString(DefaultSubjectsNoneUtf8);
    ...
    /// </remarks>
    [SuppressMessage("Design", "CA1056:URI-like properties should not be strings",
        Justification = "This value is a protocol-naming URN string (urn:ietf:rfc:6749) compared ordinally against the spec_urn member, not a dereferenceable System.Uri.")]
    public static string AuthorizationSchemeSpecUrnOAuth2 { get; } =
