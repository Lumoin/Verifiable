...
public static class SubjectIdentifierMemberNames
{
    ...
    [SuppressMessage("Design", "CA1056:URI-like properties should not be strings",
        Justification = "This member is the JSON claim NAME literal 'url' (a wire key compared and serialised as a string), not a dereferenceable System.Uri.")]
    ...
    public static string Identifiers { get; } = Utf8Constants.ToInternedString(IdentifiersUtf8);
    ...
    public static string AssertionId { get; } = Utf8Constants.ToInternedString(AssertionIdUtf8);
