...
/// </summary>
/// <remarks>
/// This is the <c>TContext</c> the <see cref="Verifiable.Cryptography.EventLogs.LogReplayer{TState,TOperation,TProof,TContext}"/>
...
public sealed record WebVhValidationContext
{
    ...
    /// <summary>The digest implementation (caller-supplied or the registered default) for the SCID, entryHash and pre-rotation SHA-256 hashes.</summary>
