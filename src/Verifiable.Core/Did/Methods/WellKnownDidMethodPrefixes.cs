...
public static class WellKnownDidMethodPrefixes
{
    ...
    /// <summary>
    /// Returns <see langword="true"/> when <paramref name="didPrefix"/> is <see cref="WebVhDidMethodPrefix"/>.
    /// </summary>
    ...
    /// <summary>
    /// Returns <see langword="true"/> when <paramref name="didPrefix"/> is <see cref="PeerDidMethodPrefix"/>.
    /// </summary>
    public static bool IsPeerDidPrefix(string didPrefix) => Equals(PeerDidMethodPrefix, didPrefix);
