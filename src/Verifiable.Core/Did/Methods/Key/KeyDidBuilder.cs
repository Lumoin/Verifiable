...
namespace Verifiable.Core.Did.Methods.Key
{
    ...
    public sealed class KeyDidBuilder: Builder<DidDocument, KeyDidBuildState, KeyDidBuilder>
    {
        ...
        /// <summary>
        /// Creates a DID document with the JSON-LD context required by the <c>did:key</c> specification:
        /// the DID v1 context followed by the Multikey suite context, per the did:key Context Creation
        /// Algorithm (a Multikey verification method, not the JWS-2020 suite).
        /// </summary>
        /// <returns>A DID document with the did:key context applied.</returns>
