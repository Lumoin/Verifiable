...
namespace Verifiable.Core.Did
{
    ...
    public static class VerificationMethodExtensions
    {
            ...
            MemoryPool<byte> memoryPool)
        {
            ...
            var rawKeyMaterial = VerifiableCryptoFormatConversions.DefaultVerificationMethodToAlgorithmConverter(verificationMethod, memoryPool);
        ...
        public static bool DetermineSigningSupport(this VerificationMethod verificationMethod)
        {
            ...
            try
            {
                using var tempMemoryPool = ExactSizeMemoryPool<byte>.Shared;
                var rawKeyMaterial = VerifiableCryptoFormatConversions.DefaultVerificationMethodToAlgorithmConverter(verificationMethod, tempMemoryPool);
                using(rawKeyMaterial.keyMaterial)
                {
