...
namespace Verifiable.Core.StatusLists;
...
public static class StatusListTokenClaims
{
    ...
    /// <param name="pool">The pool the decompressed <see cref="Core.StatusLists.StatusList"/> is allocated from.</param>
        ...
        out StatusListTokenClaimsDefect defectKind)
    {
        ...
        try
        {
            ...
            statusList = Core.StatusLists.StatusList.FromCompressed(
