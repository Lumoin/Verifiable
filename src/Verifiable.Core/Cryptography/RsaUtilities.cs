...
namespace Verifiable.Core.Cryptography
{
    ...
    {
        /// <summary>
        /// The exponent used by did:key RSA keys and is a common default value in RSA cryptography.
        /// </summary>
        /// <remarks>
        ...
        public static byte[] Encode(ReadOnlySpan<byte> rsaModulusBytes)
        {
            ...
            //Only RSA 2048 and 4096 byte lengths are supported. So it is sufficient to check
        ...
        public static byte[] Decode(ReadOnlySpan<byte> encodedRsaModulusBytes)
        {
            ...
            //so the list of these two encoding lengths is exhaustive and the length can be relied on.
