...
namespace Verifiable.Core.Cryptography
{
    ...
    public delegate TResult VerificationFunction<TPublicKeyBytes, TDataToVerify, in TSignature, out TResult>(ReadOnlyMemory<TPublicKeyBytes> publicKeyBytes, ReadOnlyMemory<TDataToVerify> dataToVerify, TSignature signature);
