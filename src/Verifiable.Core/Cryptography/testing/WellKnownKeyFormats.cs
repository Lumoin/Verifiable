...
namespace Verifiable.Core
{
    ...
    ///
    /// <para>The choice of a key format is inherently linked to the cryptographic suite (<see cref="CryptographicSuite"/>) in use.
    ...
    /// <param name="cryptoSuite">The cryptosuite. If this is known to <c>Verifiable</c> it is inherited from <see cref="CryptographicSuite"/>.</param>
    ...
    public delegate Type KeyFormatSelector(Type didMethod, CryptographicSuite cryptoSuite, Type? preferredFormat = null);
    ...
    {
        public static KeyFormatSelector DefaultKeyFormatSelector { get; set; } = (Type didMethod, CryptographicSuite cryptoSuite, Type? preferredFormat) =>
        {
