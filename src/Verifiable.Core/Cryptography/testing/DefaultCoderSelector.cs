...
namespace Verifiable.Cryptography
{
    ...
    public static class DefaultCoderSelector
    {
        ...
        /// If the format type is known to <c>Verifiable</c>, it is enumerated in <see cref="KeyFormatFactory"/>.
        /// </para>
        ///
    ...
    {
        public static void InitializeProviders(EncodeDelegate base58BtcEncoder, DecodeDelegate base58BtcDecoder, HashFunction sha256Implementation)
        {
