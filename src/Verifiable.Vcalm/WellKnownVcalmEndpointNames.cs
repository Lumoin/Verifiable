...
public static class WellKnownVcalmEndpointNames
{
    ...
    public static string VcalmCredentialsVerify { get; } = Utf8Constants.ToInternedString(VcalmCredentialsVerifyUtf8);
    ...
    public static string VcalmPresentationsVerify { get; } = Utf8Constants.ToInternedString(VcalmPresentationsVerifyUtf8);
    ...
    public static string VcalmCreateChallenge { get; } = Utf8Constants.ToInternedString(VcalmCreateChallengeUtf8);
    ...
    public static string VcalmCredentialsIssue { get; } = Utf8Constants.ToInternedString(VcalmCredentialsIssueUtf8);
    ...
    public static string VcalmGetCredential { get; } = Utf8Constants.ToInternedString(VcalmGetCredentialUtf8);
    ...
    public static string VcalmDeleteCredential { get; } = Utf8Constants.ToInternedString(VcalmDeleteCredentialUtf8);
    ...
    /// status-service MUST.
    /// </summary>
    public static string VcalmCredentialsStatus { get; } = Utf8Constants.ToInternedString(VcalmCredentialsStatusUtf8);
    ...
    public static string VcalmCreateStatusList { get; } = Utf8Constants.ToInternedString(VcalmCreateStatusListUtf8);
    ...
    public static string VcalmGetStatusList { get; } = Utf8Constants.ToInternedString(VcalmGetStatusListUtf8);
    ...
    public static string VcalmCredentialsDerive { get; } = Utf8Constants.ToInternedString(VcalmCredentialsDeriveUtf8);
    ...
    public static string VcalmCreatePresentation { get; } = Utf8Constants.ToInternedString(VcalmCreatePresentationUtf8);
    ...
    public static string VcalmGetPresentations { get; } = Utf8Constants.ToInternedString(VcalmGetPresentationsUtf8);
    ...
    public static string VcalmGetPresentation { get; } = Utf8Constants.ToInternedString(VcalmGetPresentationUtf8);
    ...
    public static string VcalmDeletePresentation { get; } = Utf8Constants.ToInternedString(VcalmDeletePresentationUtf8);
    ...
    public static string VcalmCreateExchange { get; } = Utf8Constants.ToInternedString(VcalmCreateExchangeUtf8);
    ...
    /// </summary>
    public static string VcalmGetExchangeProtocols { get; } = Utf8Constants.ToInternedString(VcalmGetExchangeProtocolsUtf8);
    ...
    /// </summary>
    public static string VcalmParticipateInExchange { get; } = Utf8Constants.ToInternedString(VcalmParticipateInExchangeUtf8);
    ...
    /// VCALM endpoint.
    /// </summary>
    public static string VcalmGetExchangeState { get; } = Utf8Constants.ToInternedString(VcalmGetExchangeStateUtf8);
    ...
    /// </summary>
    public static string VcalmCreateWorkflow { get; } = Utf8Constants.ToInternedString(VcalmCreateWorkflowUtf8);
    ...
    /// </summary>
    public static string VcalmGetWorkflow { get; } = Utf8Constants.ToInternedString(VcalmGetWorkflowUtf8);
    ...
    /// infeasible to guess)."
    /// </summary>
    public static string VcalmExchangeStepCallback { get; } = Utf8Constants.ToInternedString(VcalmExchangeStepCallbackUtf8);
    ...
    /// </summary>
    public static string VcalmInteractionProtocols { get; } = Utf8Constants.ToInternedString(VcalmInteractionProtocolsUtf8);
    ...
    /// </summary>
    public static string VcalmInviteRequest { get; } = Utf8Constants.ToInternedString(VcalmInviteRequestUtf8);
}
