...
public static class VcalmParameterNames
{
    ...
    /// </summary>
    public static string VerifiablePresentation { get; } = Utf8Constants.ToInternedString(VerifiablePresentationUtf8);
    ...
    /// </summary>
    public static string Presentation { get; } = Utf8Constants.ToInternedString(PresentationUtf8);
    ...
    public static string Options { get; } = Utf8Constants.ToInternedString(OptionsUtf8);
    ...
    public static string ReturnResults { get; } = Utf8Constants.ToInternedString(ReturnResultsUtf8);
    ...
    public static string ReturnProblemDetails { get; } = Utf8Constants.ToInternedString(ReturnProblemDetailsUtf8);
    ...
    public static string ReturnCredential { get; } = Utf8Constants.ToInternedString(ReturnCredentialUtf8);
    ...
    public static string ReturnPresentation { get; } = Utf8Constants.ToInternedString(ReturnPresentationUtf8);
    ...
    /// sub-result member.
    /// </summary>
    public static string Challenge { get; } = Utf8Constants.ToInternedString(ChallengeUtf8);
    ...
    public static string Domain { get; } = Utf8Constants.ToInternedString(DomainUtf8);
    ...
    public static string Credential { get; } = Utf8Constants.ToInternedString(CredentialUtf8);
    ...
    public static string ProblemDetails { get; } = Utf8Constants.ToInternedString(ProblemDetailsUtf8);
    ...
    public static string Results { get; } = Utf8Constants.ToInternedString(ResultsUtf8);
    ...
    public static string Input { get; } = Utf8Constants.ToInternedString(InputUtf8);
    ...
    public static string Value { get; } = Utf8Constants.ToInternedString(ValueUtf8);
    ...
    public static string Credentials { get; } = Utf8Constants.ToInternedString(CredentialsUtf8);
    ...
    public static string ProblemType { get; } = Utf8Constants.ToInternedString(ProblemTypeUtf8);
    ...
    public static string ProblemTitle { get; } = Utf8Constants.ToInternedString(ProblemTitleUtf8);
    ...
    public static string ProblemDetail { get; } = Utf8Constants.ToInternedString(ProblemDetailUtf8);
    ...
    /// </summary>
    public static string MandatoryPointers { get; } = Utf8Constants.ToInternedString(MandatoryPointersUtf8);
    ...
    /// </summary>
    public static string CredentialId { get; } = Utf8Constants.ToInternedString(CredentialIdUtf8);
    ...
    /// </summary>
    public static string StatusPurpose { get; } = Utf8Constants.ToInternedString(StatusPurposeUtf8);
    ...
    public static string StatusListIndex { get; } = Utf8Constants.ToInternedString(StatusListIndexUtf8);
    ...
    public static string StatusListCredential { get; } = Utf8Constants.ToInternedString(StatusListCredentialUtf8);
    ...
    /// </summary>
    public static string IndexAllocator { get; } = Utf8Constants.ToInternedString(IndexAllocatorUtf8);
    ...
    /// </summary>
    public static string EncodedList { get; } = Utf8Constants.ToInternedString(EncodedListUtf8);
    ...
    /// </summary>
    public static string SelectivePointers { get; } = Utf8Constants.ToInternedString(SelectivePointersUtf8);
    ...
    public static string Cryptosuite { get; } = Utf8Constants.ToInternedString(CryptosuiteUtf8);
    ...
    /// </summary>
    public static string VerificationMethod { get; } = Utf8Constants.ToInternedString(VerificationMethodUtf8);
    ...
    public static string ProofPurpose { get; } = Utf8Constants.ToInternedString(ProofPurposeUtf8);
    ...
    /// system time.").
    /// </summary>
    public static string Created { get; } = Utf8Constants.ToInternedString(CreatedUtf8);
    ...
    public static string CredentialQuery { get; } = Utf8Constants.ToInternedString(CredentialQueryUtf8);
    ...
    /// </summary>
    public static string Example { get; } = Utf8Constants.ToInternedString(ExampleUtf8);
    ...
    /// </summary>
    public static string AcceptedIssuers { get; } = Utf8Constants.ToInternedString(AcceptedIssuersUtf8);
    ...
    /// </summary>
    public static string RecognizedIn { get; } = Utf8Constants.ToInternedString(RecognizedInUtf8);
    ...
    /// </summary>
    public static string AcceptedCryptosuites { get; } = Utf8Constants.ToInternedString(AcceptedCryptosuitesUtf8);
    ...
    /// </summary>
    public static string AcceptedEnvelopes { get; } = Utf8Constants.ToInternedString(AcceptedEnvelopesUtf8);
    ...
    public static string MediaType { get; } = Utf8Constants.ToInternedString(MediaTypeUtf8);
    ...
    /// </summary>
    public static string AcceptedMethods { get; } = Utf8Constants.ToInternedString(AcceptedMethodsUtf8);
    ...
    /// </summary>
    public static string CapabilityQuery { get; } = Utf8Constants.ToInternedString(CapabilityQueryUtf8);
    ...
    public static string ReferenceId { get; } = Utf8Constants.ToInternedString(ReferenceIdUtf8);
    ...
    public static string AllowedAction { get; } = Utf8Constants.ToInternedString(AllowedActionUtf8);
    ...
    public static string Controller { get; } = Utf8Constants.ToInternedString(ControllerUtf8);
    ...
    public static string InvocationTarget { get; } = Utf8Constants.ToInternedString(InvocationTargetUtf8);
    ...
    /// </summary>
    public static string Variables { get; } = Utf8Constants.ToInternedString(VariablesUtf8);
    ...
    /// </summary>
    public static string Protocols { get; } = Utf8Constants.ToInternedString(ProtocolsUtf8);
    ...
    public static string Vcapi { get; } = Utf8Constants.ToInternedString(VcapiUtf8);
    ...
    public static string OpenId4Vp { get; } = Utf8Constants.ToInternedString(OpenId4VpUtf8);
    ...
    public static string OpenId4Vci { get; } = Utf8Constants.ToInternedString(OpenId4VciUtf8);
    ...
    public static string Interact { get; } = Utf8Constants.ToInternedString(InteractUtf8);
    ...
    /// </summary>
    public static string VerifiablePresentationRequest { get; } = Utf8Constants.ToInternedString(VerifiablePresentationRequestUtf8);
    ...
    [SuppressMessage("Design", "CA1056:URI-like properties should not be strings",
        Justification = "This member is the wire member NAME 'redirectUrl' (compared and serialised as a string), not a dereferenceable System.Uri.")]
    public static string RedirectUrl { get; } = Utf8Constants.ToInternedString(RedirectUrlUtf8);
    ...
    public static string Sequence { get; } = Utf8Constants.ToInternedString(SequenceUtf8);
    ...
    public static string Step { get; } = Utf8Constants.ToInternedString(StepUtf8);
    ...
    public static string LastError { get; } = Utf8Constants.ToInternedString(LastErrorUtf8);
    ...
    public static string InitialStep { get; } = Utf8Constants.ToInternedString(InitialStepUtf8);
    ...
    public static string Steps { get; } = Utf8Constants.ToInternedString(StepsUtf8);
    ...
    public static string CredentialTemplates { get; } = Utf8Constants.ToInternedString(CredentialTemplatesUtf8);
    ...
    public static string Template { get; } = Utf8Constants.ToInternedString(TemplateUtf8);
    ...
    public static string CreateChallenge { get; } = Utf8Constants.ToInternedString(CreateChallengeUtf8);
    ...
    [SuppressMessage("Design", "CA1056:URI-like properties should not be strings",
        Justification = "This member is the wire member NAME 'url' (compared and serialised as a string), not a dereferenceable System.Uri.")]
    public static string Url { get; } = Utf8Constants.ToInternedString(UrlUtf8);
    ...
    public static string IssueRequests { get; } = Utf8Constants.ToInternedString(IssueRequestsUtf8);
    ...
    public static string CredentialTemplateId { get; } = Utf8Constants.ToInternedString(CredentialTemplateIdUtf8);
    ...
    public static string CredentialTemplateIndex { get; } = Utf8Constants.ToInternedString(CredentialTemplateIndexUtf8);
    ...
    /// </summary>
    public static string NextStep { get; } = Utf8Constants.ToInternedString(NextStepUtf8);
    ...
    /// </summary>
    public static string PresentationSchema { get; } = Utf8Constants.ToInternedString(PresentationSchemaUtf8);
    ...
    public static string Event { get; } = Utf8Constants.ToInternedString(EventUtf8);
    ...
    public static string Data { get; } = Utf8Constants.ToInternedString(DataUtf8);
    ...
    /// </summary>
    public static string ExchangeId { get; } = Utf8Constants.ToInternedString(ExchangeIdUtf8);
    ...
    /// </summary>
    public static string Iuv { get; } = Utf8Constants.ToInternedString(IuvUtf8);
    ...
    /// </summary>
    public static string InviteRequest { get; } = Utf8Constants.ToInternedString(InviteRequestUtf8);
    ...
    /// </summary>
    public static string Purpose { get; } = Utf8Constants.ToInternedString(PurposeUtf8);
}
