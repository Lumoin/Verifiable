...
public abstract class TpmSessionBase
{
    ...
    /// </para>
    /// <para>
    /// See TPM 2.0 Library Part 2, clause 8.4 - TPMA_SESSION.
    /// </para>
    /// </remarks>
    ...
    /// <remarks>
    /// <para>
    /// The caller provides a fresh nonceCaller for each command in a session (TPM 2.0 Library Part 1, clause 16.6).
    ...
    /// clause 18.2) and runs before cpHash is computed (clause 18.1). The base implementation is a no-op for
    ...
    /// clause 18.2) and runs only after the response HMAC verifies (clause 18.1: rpHash is computed over the
