...
/// Library Part 1, Section 16.6.16, "the password takes precedence and must be present in hmac"). The command
...
/// Section 23.18) — so a single authPolicy accepts either authorization style; see
...
/// </para>
/// <para>
/// Command structure (TPM 2.0 Part 3, Section 23.18, Table 174):
/// </para>
/// <list type="bullet">
