...
/// <remarks>
/// <para>
/// Response structure (TPM 2.0 Library Part 3, clause 18.4):
/// </para>
/// <list type="bullet">
...
public sealed class QuoteResponse: IDisposable, ITpmWireType
{
    ...
    public static QuoteResponse Parse(ref TpmReader reader, BaseMemoryPool pool)
    {
        ...
        try
        {
            //A TPM2_Quote response's attestation type is fixed to TPM_ST_ATTEST_QUOTE (Part 3, clause 18.4). Reject a
