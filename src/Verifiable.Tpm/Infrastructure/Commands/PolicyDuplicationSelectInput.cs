...
/// (TPM 2.0 Part 3, Section 23.15); see <see cref="TpmPolicyDigest.ExtendForDuplicationSelect"/>. The object Name
...
/// </para>
/// <para>
/// Command structure (TPM 2.0 Part 3, Section 23.15, Table 168):
/// </para>
/// <list type="bullet">
...
public readonly record struct PolicyDuplicationSelectInput(uint PolicySession, ReadOnlyMemory<byte> ObjectName, ReadOnlyMemory<byte> NewParentName, bool IsObjectIncluded): ITpmCommandInput
{
    ...
    /// <summary>
    /// Refuses a Name the <c>TPM2B_NAME</c> wire type cannot carry (TPM 2.0 Part 2, Section 10.4.3, Table 105:
