...
/// simulator refuses a TPM_ST_SESSIONS frame with TPM_RC_BAD_TAG (a recorded limitation), matching
/// <see cref="SignSequenceStartInput"/>'s posture for its own no-authorization handle.
/// </para>
/// <para>
