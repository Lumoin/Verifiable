...
/// <c>TPM_CC_NV_ChangeAuth</c> (TPM 2.0 Library Part 1, clause 16.2; clause 34.2.3). A password or HMAC
...
/// TPM 2.0 Library Part 3, clause 31.15 (Table 269/270).
/// </para>
/// </remarks>
public sealed class NvChangeAuthInput: ITpmCommandInput, IDisposable
{
    ...
    /// eligible for session-based parameter encryption (TPM 2.0 Library Part 1, clause 18.1). This is the
