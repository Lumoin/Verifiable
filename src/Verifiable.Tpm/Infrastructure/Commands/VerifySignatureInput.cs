...
/// </para>
/// <para>
/// Command structure (TPM 2.0 Library Part 3, clause 20.2, Table 116):
/// </para>
/// <list type="bullet">
...
public sealed class VerifySignatureInput: ITpmCommandInput, IDisposable
{
    ...
    /// <inheritdoc/>
    /// <remarks>
    /// <c>digest</c> (<c>TPM2B_DIGEST</c>) is the first entry of the parameter area and carries an explicit
    /// size field (TPM 2.0 Library Part 3, clause 20.2, Table 116; deprecated in this revision, still
    /// mandatory), which is what TPM 2.0 Library Part 1, clause 18.1 requires of an encryptable parameter. A
    /// session without the <c>decrypt</c> attribute is unaffected.
    /// </remarks>
    public bool FirstCommandParameterIsEncryptable => true;

    /// <inheritdoc/>
    /// <remarks>
    /// <c>keyHandle</c> carries Auth Index None (TPM 2.0 Library Part 3, clause 20.2, Table 116) — the first
