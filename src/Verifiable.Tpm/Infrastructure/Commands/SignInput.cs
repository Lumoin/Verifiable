...
/// </para>
/// <para>
/// Command structure (TPM 2.0 Part 3, Section 20.5):
/// </para>
/// <list type="bullet">
...
public sealed class SignInput: ITpmCommandInput, IDisposable
{
    ...
    /// the digest was computed outside the TPM (TPM 2.0 Part 2, Section 10.6.7 (TPMT_TK_HASHCHECK), with
    /// the NULL-ticket convention at Section 10.6.2).
    /// </remarks>
