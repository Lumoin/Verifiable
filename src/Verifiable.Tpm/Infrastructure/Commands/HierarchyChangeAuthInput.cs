...
/// a per-hierarchy nameAlg (hierarchies have none) - TPM 2.0 Library Part 1, Section 16.6.4.2. The response HMAC
...
/// <c>TPM_ST_SESSIONS</c>. See TPM 2.0 Library Part 3, Section 24.8 (Table 205/206).
/// </para>
/// </remarks>
public sealed class HierarchyChangeAuthInput: ITpmCommandInput, IDisposable
{
    ...
    /// eligible for session-based parameter encryption (TPM 2.0 Library Part 1, Section 18.1). A separate
