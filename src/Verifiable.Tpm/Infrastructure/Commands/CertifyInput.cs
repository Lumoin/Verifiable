...
/// </para>
/// <para>
/// Command structure (TPM 2.0 Library Part 3, clause 18.2):
/// </para>
/// <list type="bullet">
...
public sealed class CertifyInput: ITpmCommandInput, IDisposable
{
    ...
    /// explicit size field (TPM 2.0 Library Part 3, clause 18.2, Table 97), which is what TPM 2.0 Library Part 1,
        ...
        BaseMemoryPool pool)
    {
        ...
        return new CertifyInput(
            objectHandle, signHandle, owner, owner.Memory[..qualifyingData.Length], signatureScheme, schemeHashAlg);
    }
