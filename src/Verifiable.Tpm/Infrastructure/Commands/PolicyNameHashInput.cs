...
/// <c>policyDigest = H(policyDigestold || TPM_CC_PolicyNameHash || nameHash)</c> (TPM 2.0 Library Part 3, clause
...
/// </para>
/// <para>
/// Command structure (TPM 2.0 Library Part 3, clause 23.14, Table 166):
/// </para>
/// <list type="bullet">
...
public readonly record struct PolicyNameHashInput(uint PolicySession, ReadOnlyMemory<byte> NameHash): ITpmCommandInput
{
    ...
    /// <inheritdoc/>
    /// <remarks>
    /// <c>policySession</c> carries Auth Index None (TPM 2.0 Library Part 3, clause 23.14.2, Table 166) — the
