...
/// <c>policyDigest = H(policyDigestold || TPM_CC_PolicyCpHash || cpHashA)</c> (TPM 2.0 Library Part 3, clause 23.13);
...
/// </para>
/// <para>
/// Command structure (TPM 2.0 Library Part 3, clause 23.13, Table 164):
/// </para>
/// <list type="bullet">
...
public readonly record struct PolicyCpHashInput(uint PolicySession, ReadOnlyMemory<byte> CpHashA): ITpmCommandInput
{
    ...
    /// <inheritdoc/>
    /// <remarks>
    /// <c>policySession</c> carries Auth Index None (TPM 2.0 Library Part 3, clause 23.13.2, Table 164) — the
