...
/// <param name="OperandB">The value to compare the NV data against, at most <see cref="Tpm2bOperand.MaxSize"/> octets. The caller owns the underlying memory.</param>
...
{
    /// <summary>
    /// Gets the value the NV data is compared against, bounded at construction by
