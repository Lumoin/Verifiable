...
/// <summary>
/// The per-register PCR attributes of the TCG PC Client Platform TPM Profile (PTP 1.07, Table 14
/// "PCR Attributes", and Table 15 "PCR Initial and Reset Values"), rendered for the one locality
