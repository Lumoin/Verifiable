...
/// </param>
/// <param name="Timeout">
/// The session's own tracked deadline (<c>policySession-&gt;timeout</c>, Part 3, Section 23.2.4), or zero when
...
/// <c>TPM_RC_EXPIRED</c> at authorization time — the companion half of the same normative rule, out of this
/// slice's scope.
/// </param>
    ...
    bool IsBoundToLockout = false): IDisposable
{
    ...
    /// Section 23.2.4 and the unlatching half of the same clause's context reset. The dispose-immune empty
