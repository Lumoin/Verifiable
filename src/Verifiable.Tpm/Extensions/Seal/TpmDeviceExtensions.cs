...
public static class TpmDeviceExtensions
{
        ...
        CancellationToken cancellationToken)
    {
        ...
        return await OpenEnvelopeAsync(envelope, unsealResult, aeadDecrypt, cancellationToken).ConfigureAwait(false);
    }
    ...
    private static async ValueTask<TpmResult<DecryptedContent>> OpenEnvelopeAsync(
        TpmSealedEnvelope envelope, TpmResult<UnsealResponse> unsealResult, AeadDecryptDelegate aeadDecrypt, CancellationToken cancellationToken)
    {
