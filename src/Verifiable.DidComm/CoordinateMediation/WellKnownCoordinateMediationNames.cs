...
public static class WellKnownCoordinateMediationNames
{
    ...
    public static readonly string CoordinateMediationProtocol = Utf8Constants.ToInternedString(CoordinateMediationProtocolUtf8);
    ...
    public static readonly string MediateRequestType = Utf8Constants.ToInternedString(MediateRequestTypeUtf8);
    ...
    /// </summary>
    public static readonly string MediateDenyType = Utf8Constants.ToInternedString(MediateDenyTypeUtf8);
    ...
    public static readonly string MediateGrantType = Utf8Constants.ToInternedString(MediateGrantTypeUtf8);
    ...
    /// </summary>
    public static readonly string KeylistUpdateType = Utf8Constants.ToInternedString(KeylistUpdateTypeUtf8);
    ...
    /// </summary>
    public static readonly string KeylistUpdateResponseType = Utf8Constants.ToInternedString(KeylistUpdateResponseTypeUtf8);
    ...
    public static readonly string KeylistQueryType = Utf8Constants.ToInternedString(KeylistQueryTypeUtf8);
    ...
    /// </summary>
    public static readonly string KeylistType = Utf8Constants.ToInternedString(KeylistTypeUtf8);
    ...
    public static readonly string RoutingDid = Utf8Constants.ToInternedString(RoutingDidUtf8);
    ...
    public static readonly string Updates = Utf8Constants.ToInternedString(UpdatesUtf8);
    ...
    public static readonly string Updated = Utf8Constants.ToInternedString(UpdatedUtf8);
    ...
    public static readonly string RecipientDid = Utf8Constants.ToInternedString(RecipientDidUtf8);
    ...
    public static readonly string Result = Utf8Constants.ToInternedString(ResultUtf8);
    ...
    public static readonly string Paginate = Utf8Constants.ToInternedString(PaginateUtf8);
    ...
    public static readonly string Pagination = Utf8Constants.ToInternedString(PaginationUtf8);
    ...
    public static readonly string Remaining = Utf8Constants.ToInternedString(RemainingUtf8);
