...
public static class WellKnownMessagePickupNames
{
    ...
    public static readonly string MessagePickupProtocol = Utf8Constants.ToInternedString(MessagePickupProtocolUtf8);
    ...
    public static readonly string StatusRequestType = Utf8Constants.ToInternedString(StatusRequestTypeUtf8);
    ...
    public static readonly string DeliveryRequestType = Utf8Constants.ToInternedString(DeliveryRequestTypeUtf8);
    ...
    /// </summary>
    public static readonly string DeliveryType = Utf8Constants.ToInternedString(DeliveryTypeUtf8);
    ...
    /// </summary>
    public static readonly string MessagesReceivedType = Utf8Constants.ToInternedString(MessagesReceivedTypeUtf8);
    ...
    /// </summary>
    public static readonly string LiveDeliveryChangeType = Utf8Constants.ToInternedString(LiveDeliveryChangeTypeUtf8);
    ...
    public static readonly string MessageCount = Utf8Constants.ToInternedString(MessageCountUtf8);
    ...
    public static readonly string LongestWaitedSeconds = Utf8Constants.ToInternedString(LongestWaitedSecondsUtf8);
    ...
    public static readonly string NewestReceivedTime = Utf8Constants.ToInternedString(NewestReceivedTimeUtf8);
    ...
    public static readonly string OldestReceivedTime = Utf8Constants.ToInternedString(OldestReceivedTimeUtf8);
    ...
    public static readonly string TotalBytes = Utf8Constants.ToInternedString(TotalBytesUtf8);
    ...
    public static readonly string LiveDelivery = Utf8Constants.ToInternedString(LiveDeliveryUtf8);
    ...
    public static readonly string MessageIdList = Utf8Constants.ToInternedString(MessageIdListUtf8);
