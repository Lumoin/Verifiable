...
public static class WellKnownDidCommMemberNames
{
    ...
    public static string From { get; } = Utf8Constants.ToInternedString(FromUtf8);
    ...
    public static string To { get; } = Utf8Constants.ToInternedString(ToUtf8);
    ...
    public static string ThreadId { get; } = Utf8Constants.ToInternedString(ThreadIdUtf8);
    ...
    public static string ParentThreadId { get; } = Utf8Constants.ToInternedString(ParentThreadIdUtf8);
    ...
    public static string CreatedTime { get; } = Utf8Constants.ToInternedString(CreatedTimeUtf8);
    ...
    public static string ExpiresTime { get; } = Utf8Constants.ToInternedString(ExpiresTimeUtf8);
    ...
    public static string FromPrior { get; } = Utf8Constants.ToInternedString(FromPriorUtf8);
    ...
    public static string PleaseAck { get; } = Utf8Constants.ToInternedString(PleaseAckUtf8);
    ...
    public static string Ack { get; } = Utf8Constants.ToInternedString(AckUtf8);
    ...
    public static string Body { get; } = Utf8Constants.ToInternedString(BodyUtf8);
    ...
    public static string Attachments { get; } = Utf8Constants.ToInternedString(AttachmentsUtf8);
    ...
    public static string Filename { get; } = Utf8Constants.ToInternedString(FilenameUtf8);
    ...
    public static string LastModifiedTime { get; } = Utf8Constants.ToInternedString(LastModifiedTimeUtf8);
    ...
    public static string ByteCount { get; } = Utf8Constants.ToInternedString(ByteCountUtf8);
    ...
    public static string Jws { get; } = Utf8Constants.ToInternedString(JwsUtf8);
    ...
    public static string Hash { get; } = Utf8Constants.ToInternedString(HashUtf8);
    ...
    public static string Links { get; } = Utf8Constants.ToInternedString(LinksUtf8);
    ...
    public static string Base64 { get; } = Utf8Constants.ToInternedString(Base64Utf8);
