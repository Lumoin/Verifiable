...
public static class WellKnownDiscoverFeaturesNames
{
    ...
    public static string DiscoverFeaturesProtocol { get; } = Utf8Constants.ToInternedString(DiscoverFeaturesProtocolUtf8);
    ...
    /// </summary>
    public static string QueryType { get; } = Utf8Constants.ToInternedString(QueryTypeUtf8);
    ...
    public static string DiscloseType { get; } = Utf8Constants.ToInternedString(DiscloseTypeUtf8);
    ...
    public static string Queries { get; } = Utf8Constants.ToInternedString(QueriesUtf8);
    ...
    public static string Disclosures { get; } = Utf8Constants.ToInternedString(DisclosuresUtf8);
    ...
    public static string FeatureType { get; } = Utf8Constants.ToInternedString(FeatureTypeUtf8);
    ...
    public static string Match { get; } = Utf8Constants.ToInternedString(MatchUtf8);
