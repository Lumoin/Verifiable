...
/// <see cref="RoutingForwardExtensions.WrapInForwardAsync(DidCommEncryptedMessage, string, System.Collections.Generic.IReadOnlyList{string}, Verifiable.Core.Resolvers.DidResolver, Verifiable.Core.ExchangeContext, Verifiable.DidComm.Routing.EphemeralKeyPairFactory, string, Verifiable.DidComm.DidCommMessageSerializer, Verifiable.JCose.JwtHeaderSerializer, Verifiable.Cryptography.EncodeDelegate, Verifiable.JCose.TagToEpkCrvDelegate, Verifiable.Cryptography.GenerateNonceDelegate, Lumoin.Base.BaseMemoryPool, System.Threading.CancellationToken)"/>
