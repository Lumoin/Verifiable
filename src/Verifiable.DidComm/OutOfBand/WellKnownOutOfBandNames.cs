...
public static class WellKnownOutOfBandNames
{
    ...
    /// </summary>
    public static string InvitationType { get; } = Utf8Constants.ToInternedString(InvitationTypeUtf8);
    ...
    /// </summary>
    public static string OobQueryKey { get; } = Utf8Constants.ToInternedString(OobQueryKeyUtf8);
    ...
    /// </summary>
    public static string OobIdQueryKey { get; } = Utf8Constants.ToInternedString(OobIdQueryKeyUtf8);
    ...
    /// </summary>
    public static string GoalCode { get; } = Utf8Constants.ToInternedString(GoalCodeUtf8);
    ...
    /// </summary>
    public static string Goal { get; } = Utf8Constants.ToInternedString(GoalUtf8);
