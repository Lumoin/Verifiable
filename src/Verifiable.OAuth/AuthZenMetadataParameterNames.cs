...
public static class AuthZenMetadataParameterNames
{
    ...
    /// scheme (§9.1, REQUIRED).
    /// </summary>
    public static string PolicyDecisionPoint { get; } = Utf8Constants.ToInternedString(PolicyDecisionPointUtf8);
    ...
    /// </summary>
    public static string AccessEvaluationEndpoint { get; } = Utf8Constants.ToInternedString(AccessEvaluationEndpointUtf8);
    ...
    /// </summary>
    public static string AccessEvaluationsEndpoint { get; } = Utf8Constants.ToInternedString(AccessEvaluationsEndpointUtf8);
    ...
    /// </summary>
    public static string SearchSubjectEndpoint { get; } = Utf8Constants.ToInternedString(SearchSubjectEndpointUtf8);
    ...
    /// </summary>
    public static string SearchResourceEndpoint { get; } = Utf8Constants.ToInternedString(SearchResourceEndpointUtf8);
    ...
    /// </summary>
    public static string SearchActionEndpoint { get; } = Utf8Constants.ToInternedString(SearchActionEndpointUtf8);
    ...
    /// </summary>
    public static string Capabilities { get; } = Utf8Constants.ToInternedString(CapabilitiesUtf8);
