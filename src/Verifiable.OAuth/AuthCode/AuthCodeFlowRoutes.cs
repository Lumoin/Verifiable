...
public static class AuthCodeFlowRoutes
{
    ...
    /// </summary>
    public static readonly string Base = "/oauth";
    ...
    /// </summary>
    public static readonly string Par = "par";
    ...
    /// </summary>
    public static readonly string Revocation = "revoke";
    ...
    /// </summary>
    public static readonly string FlowIdField = "flow_id";
}
