...
/// <see cref="AuthorizationServerIntegration.ExtractTenantIdAsync"/> at the start of
...
/// from <see cref="AuthorizationServerCryptography.SigningKeyResolver"/> using a
/// <see cref="KeyId"/> that the state may carry. The state holds the identifier;
/// the action handler resolves the material.
/// </para>
/// <para>
/// Configuration delegates. Anything on <see cref="AuthorizationServer"/>
