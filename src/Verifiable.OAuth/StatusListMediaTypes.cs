...
public static class StatusListMediaTypes
{
    ...
    /// </summary>
    public static readonly string StatusListJwt = "statuslist+jwt";

    /// <summary>
    /// The HTTP content type for JWT-format Status List Tokens.
    /// </summary>
    public static readonly string StatusListJwtContentType = "application/statuslist+jwt";

    /// <summary>
    /// The CWT content type identifier for Status List Tokens.
    /// </summary>
    public static readonly string StatusListCwt = "application/statuslist+cwt";
}
