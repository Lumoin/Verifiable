...
public static class FederationMetadataParameterNames
{
    ...
    /// </summary>
    public static string FetchEndpoint { get; } = Utf8Constants.ToInternedString(FetchEndpointUtf8);
    ...
    /// </summary>
    public static string ListEndpoint { get; } = Utf8Constants.ToInternedString(ListEndpointUtf8);
    ...
    /// </summary>
    public static string ResolveEndpoint { get; } = Utf8Constants.ToInternedString(ResolveEndpointUtf8);
    ...
    /// </summary>
    public static string TrustMarkStatusEndpoint { get; } = Utf8Constants.ToInternedString(TrustMarkStatusEndpointUtf8);
    ...
    /// </summary>
    public static string TrustMarkListEndpoint { get; } = Utf8Constants.ToInternedString(TrustMarkListEndpointUtf8);
    ...
    /// </summary>
    public static string TrustMarkEndpoint { get; } = Utf8Constants.ToInternedString(TrustMarkEndpointUtf8);
    ...
    /// </summary>
    public static string HistoricalKeysEndpoint { get; } = Utf8Constants.ToInternedString(HistoricalKeysEndpointUtf8);
    ...
    /// </summary>
    public static string FetchEndpointAuthMethods { get; } = Utf8Constants.ToInternedString(FetchEndpointAuthMethodsUtf8);
    ...
    /// </summary>
    public static string ListEndpointAuthMethods { get; } = Utf8Constants.ToInternedString(ListEndpointAuthMethodsUtf8);
    ...
    /// </summary>
    public static string ResolveEndpointAuthMethods { get; } = Utf8Constants.ToInternedString(ResolveEndpointAuthMethodsUtf8);
    ...
    /// </summary>
    public static string TrustMarkStatusEndpointAuthMethods { get; } = Utf8Constants.ToInternedString(TrustMarkStatusEndpointAuthMethodsUtf8);
    ...
    /// </summary>
    public static string TrustMarkListEndpointAuthMethods { get; } = Utf8Constants.ToInternedString(TrustMarkListEndpointAuthMethodsUtf8);
    ...
    /// </summary>
    public static string TrustMarkEndpointAuthMethods { get; } = Utf8Constants.ToInternedString(TrustMarkEndpointAuthMethodsUtf8);
    ...
    /// </summary>
    public static string HistoricalKeysEndpointAuthMethods { get; } = Utf8Constants.ToInternedString(HistoricalKeysEndpointAuthMethodsUtf8);
    ...
    /// </summary>
    public static string EndpointAuthSigningAlgValuesSupported { get; } = Utf8Constants.ToInternedString(EndpointAuthSigningAlgValuesSupportedUtf8);
    ...
    /// </summary>
    [SuppressMessage("Design", "CA1056:URI-like properties should not be strings",
        Justification = "This member is the JSON claim NAME literal 'signed_jwks_uri' (a wire key compared and serialised as a string), not a dereferenceable System.Uri.")]
    public static string SignedJwksUri { get; } = Utf8Constants.ToInternedString(SignedJwksUriUtf8);
}
