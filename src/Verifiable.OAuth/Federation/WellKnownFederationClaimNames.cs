...
public static class WellKnownFederationClaimNames
{
    ...
    /// </summary>
    public static string AuthorityHints { get; } = Utf8Constants.ToInternedString(AuthorityHintsUtf8);
    ...
    /// </summary>
    public static string TrustAnchorHints { get; } = Utf8Constants.ToInternedString(TrustAnchorHintsUtf8);
    ...
    /// </summary>
    public static string Metadata { get; } = Utf8Constants.ToInternedString(MetadataUtf8);
    ...
    /// <see href="https://openid.net/specs/openid-federation-connect-1_1-final.html#section-12">Connect-1.1 §12</see>.
    ...
    /// </summary>
    public static string ClientRegistrationTypesSupported { get; } = Utf8Constants.ToInternedString(ClientRegistrationTypesSupportedUtf8);
    ...
    /// </summary>
    public static string MetadataPolicy { get; } = Utf8Constants.ToInternedString(MetadataPolicyUtf8);
    ...
    /// </summary>
    public static string MetadataPolicyCrit { get; } = Utf8Constants.ToInternedString(MetadataPolicyCritUtf8);
    ...
    /// Federation §6.2.
    /// </summary>
    public static string Constraints { get; } = Utf8Constants.ToInternedString(ConstraintsUtf8);
    ...
    /// </summary>
    public static string MaxPathLength { get; } = Utf8Constants.ToInternedString(MaxPathLengthUtf8);
    ...
    /// </summary>
    public static string NamingConstraints { get; } = Utf8Constants.ToInternedString(NamingConstraintsUtf8);
    ...
    /// per Federation §6.2.
    /// </summary>
    public static string AllowedEntityTypes { get; } = Utf8Constants.ToInternedString(AllowedEntityTypesUtf8);
    ...
    /// per Federation §7.
    /// </summary>
    public static string TrustMarks { get; } = Utf8Constants.ToInternedString(TrustMarksUtf8);
    ...
    /// </summary>
    public static string TrustMarkIssuers { get; } = Utf8Constants.ToInternedString(TrustMarkIssuersUtf8);
    ...
    /// </summary>
    public static string TrustMarkOwners { get; } = Utf8Constants.ToInternedString(TrustMarkOwnersUtf8);
    ...
    /// </summary>
    public static string SourceEndpoint { get; } = Utf8Constants.ToInternedString(SourceEndpointUtf8);
    ...
    /// governs.
    /// </summary>
    public static string Crit { get; } = Utf8Constants.ToInternedString(CritUtf8);
    ...
    /// </summary>
    public static string TrustChain { get; } = Utf8Constants.ToInternedString(TrustChainUtf8);
    ...
    /// </summary>
    public static string PeerTrustChain { get; } = Utf8Constants.ToInternedString(PeerTrustChainUtf8);
    ...
    /// </summary>
    public static string Delegation { get; } = Utf8Constants.ToInternedString(DelegationUtf8);
    ...
    /// </summary>
    public static string Ref { get; } = Utf8Constants.ToInternedString(RefUtf8);
}
