...
public static class WellKnownFederationAssessorIds
{
    ...
    /// 27 validation steps.
    /// </summary>
    public static string ValidateEntityStatement { get; } = Utf8Constants.ToInternedString(ValidateEntityStatementUtf8);
    ...
    /// </summary>
    public static string ValidateTrustChain { get; } = Utf8Constants.ToInternedString(ValidateTrustChainUtf8);
    ...
    /// Federation §6.1.4.
    /// </summary>
    public static string ApplyMetadataPolicy { get; } = Utf8Constants.ToInternedString(ApplyMetadataPolicyUtf8);
    ...
    /// </summary>
    public static string ApproveParty { get; } = Utf8Constants.ToInternedString(ApprovePartyUtf8);
    ...
    /// </summary>
    public static string VerifyTrustMark { get; } = Utf8Constants.ToInternedString(VerifyTrustMarkUtf8);
}
