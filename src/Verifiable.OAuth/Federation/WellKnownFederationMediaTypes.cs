...
public static class WellKnownFederationMediaTypes
{
    ...
    /// </summary>
    public static readonly string EntityStatementJwt = "entity-statement+jwt";
    ...
    /// Statement.
    /// </summary>
    public static readonly string ResolveResponseJwt = "resolve-response+jwt";
    ...
    /// Statement.
    /// </summary>
    public static readonly string ExplicitRegistrationResponseJwt = "explicit-registration-response+jwt";
    ...
    /// </summary>
    public static readonly string TrustMarkJwt = "trust-mark+jwt";
    ...
    /// </summary>
    public static readonly string TrustMarkDelegationJwt = "trust-mark-delegation+jwt";
    ...
    /// Statement.
    /// </summary>
    public static readonly string HistoricalKeysJwt = "jwk-set+jwt";
}
