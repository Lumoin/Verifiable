...
public static class WellKnownGrantTypes
{
    ...
    public static string AuthorizationCode { get; } = Utf8Constants.ToInternedString(AuthorizationCodeUtf8);
    ...
    public static string ClientCredentials { get; } = Utf8Constants.ToInternedString(ClientCredentialsUtf8);
    ...
    public static string TokenExchange { get; } = Utf8Constants.ToInternedString(TokenExchangeUtf8);
    ...
    public static string Saml2Bearer { get; } = Utf8Constants.ToInternedString(Saml2BearerUtf8);
    ...
    public static string Ciba { get; } = Utf8Constants.ToInternedString(CibaUtf8);
