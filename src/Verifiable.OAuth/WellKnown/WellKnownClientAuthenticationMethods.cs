...
public static class WellKnownClientAuthenticationMethods
{
    ...
    public static string ClientSecretBasic { get; } = Utf8Constants.ToInternedString(ClientSecretBasicUtf8);
    ...
    public static string ClientSecretPost { get; } = Utf8Constants.ToInternedString(ClientSecretPostUtf8);
    ...
    public static string ClientSecretJwt { get; } = Utf8Constants.ToInternedString(ClientSecretJwtUtf8);
    ...
    public static string PrivateKeyJwt { get; } = Utf8Constants.ToInternedString(PrivateKeyJwtUtf8);
    ...
    public static string TlsClientAuth { get; } = Utf8Constants.ToInternedString(TlsClientAuthUtf8);
    ...
    public static string SelfSignedTlsClientAuth { get; } = Utf8Constants.ToInternedString(SelfSignedTlsClientAuthUtf8);
    ...
    public static string AttestJwtClientAuth { get; } = Utf8Constants.ToInternedString(AttestJwtClientAuthUtf8);
    ...
    public static string SpiffeJwt { get; } = Utf8Constants.ToInternedString(SpiffeJwtUtf8);
