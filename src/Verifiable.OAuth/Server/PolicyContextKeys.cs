...
public static class PolicyContextKeys
{
    ...
    /// </summary>
    public static readonly string EnforceNoOverDisclosure = "policy.enforceNoOverDisclosure";
    ...
    /// </summary>
    public static readonly string EnforceMinimumSaltLength = "policy.enforceMinimumSaltLength";
    ...
    /// </summary>
    public static readonly string RequirePushedAuthorizationRequests = "policy.requirePushedAuthorizationRequests";
