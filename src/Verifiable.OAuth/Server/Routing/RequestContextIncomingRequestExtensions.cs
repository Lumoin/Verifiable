...
/// <see cref="RequestContext"/>. Separate from
/// <see cref="RequestContextExtensions"/> so it can land additively
...
/// on <see cref="RequestContextExtensions"/> remain in use by the current
...
public static class RequestContextIncomingRequestExtensions
{
    /// <summary>
    /// The well-known key under which the typed <see cref="IncomingRequest"/>
    /// is stored on a <see cref="RequestContext"/>.
    /// </summary>
