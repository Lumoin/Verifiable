...
/// <see cref="RequestFields"/> and <see cref="RequestContext"/>. Token-aware
...
/// <see cref="RequestContext"/> via the
/// <see cref="RequestContextExtensions.SetMatchPayload"/> extension before
/// invoking the matched endpoint's handler; the handler reads it through
/// <see cref="RequestContextExtensions.MatchPayload"/> and pattern-matches
...
public abstract record MatchPayload
{
    ...
    /// itself from <see cref="RequestFields"/> and <see cref="RequestContext"/>.
    /// </summary>
