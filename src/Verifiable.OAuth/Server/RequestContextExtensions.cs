...
public static class RequestContextExtensions
{
    extension(RequestContext context)
    {
        ...
        /// </returns>
        public ServerCapabilityName? Capability =>
            context.TryGetValue(AuthorizationServerHandlers.CapabilityKey, out object? v)
                && v is ServerCapabilityName c ? c : default(ServerCapabilityName?);
        ...
        public void SetCapability(ServerCapabilityName capability)
        {
