...
/// <see cref="Verifiable.OAuth.Server.ServerCapabilityName"/>: a readonly
/// struct whose canonical values are static readonly properties, with
/// equality determined by <see cref="Code"/>. The wire-format string is
/// looked up via the companion <see cref="GrantTypeNames"/> class.
/// </para>
/// <para>
