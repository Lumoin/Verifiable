...
public sealed record VerifierResponseReceivedState: OAuthFlowState
{
    ...
    /// The <see cref="DecryptResponseAction"/> handler uses each as a lookup
    /// key against the decrypted <c>vp_token</c> JSON object per OID4VP 1.0
    /// §8.1; multi-credential presentations carry multiple entries.
    /// </summary>
    ...
    /// <see cref="DecryptResponseAction"/> handler can validate the Wallet's
    /// echoed hashes.
    /// </summary>
