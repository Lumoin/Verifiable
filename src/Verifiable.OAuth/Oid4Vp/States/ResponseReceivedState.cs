...
/// <summary>
/// The <c>direct_post.jwt</c> authorization response has been received. This is the
/// second DB persistence point.
/// </summary>
/// <remarks>
/// <para>
/// The encrypted JWT body is retained verbatim for audit and replay testing. Transitions
/// to <see cref="PresentationVerifiedState"/> after successful ECDH-ES decryption and
/// vp_token verification, or to <see cref="FlowFailed"/> on any error.
/// </para>
/// <para>
...
/// The live key material is resolved by the application's key resolver using
/// <see cref="DecryptionKeyId"/> and is never stored in this state.
/// </para>
/// </remarks>
...
public sealed record ResponseReceivedState: OAuthFlowState
{
    ...
    /// <see cref="EncryptedResponseJwt"/> via ECDH-ES. The application's key resolver
    /// maps this identifier to the live key material at decryption time.
    /// </summary>
