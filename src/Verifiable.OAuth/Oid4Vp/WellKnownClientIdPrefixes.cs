...
public static class WellKnownClientIdPrefixes
{
    ...
    /// </summary>
    public static readonly string DecentralizedIdentifier = "decentralized_identifier";
    ...
    /// HAIP 1.0 mandatory.
    /// </summary>
    public static readonly string VerifierAttestation = "verifier_attestation";
    ...
    /// HAIP 1.0 mandatory.
    /// </summary>
    public static readonly string X509SanDns = "x509_san_dns";
    ...
    /// </summary>
    public static readonly string X509Hash = "x509_hash";
