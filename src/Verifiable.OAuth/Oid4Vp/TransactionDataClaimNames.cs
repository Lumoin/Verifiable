...
public static class TransactionDataClaimNames
{
    ...
    public static readonly string CredentialIds = "credential_ids";
    ...
    public static readonly string HashesAlg = "transaction_data_hashes_alg";
    ...
    public static readonly string Hashes = "transaction_data_hashes";
    ...
    public static readonly string DefaultHashesAlg = "sha-256";
}
