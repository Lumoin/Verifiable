...
public static class Oid4VpClientMetadataParameterNames
{
    ...
    public static string VpFormatsSupported { get; } = Utf8Constants.ToInternedString(VpFormatsSupportedUtf8);
    ...
    public static string EncryptedResponseEncValuesSupported { get; } = Utf8Constants.ToInternedString(EncryptedResponseEncValuesSupportedUtf8);
    ...
    public static string EncryptedResponseAlgValuesSupported { get; } = Utf8Constants.ToInternedString(EncryptedResponseAlgValuesSupportedUtf8);
