...
public static class Oid4VciCredentialParameterNames
{
    ...
    /// </summary>
    public static string CredentialConfigurationId { get; } = Utf8Constants.ToInternedString(CredentialConfigurationIdUtf8);
    ...
    /// </summary>
    public static string CredentialIdentifier { get; } = Utf8Constants.ToInternedString(CredentialIdentifierUtf8);
    ...
    /// </summary>
    public static string Proofs { get; } = Utf8Constants.ToInternedString(ProofsUtf8);
    ...
    /// </summary>
    public static string JwtProofType { get; } = Utf8Constants.ToInternedString(JwtProofTypeUtf8);
    ...
    /// strings.
    /// </summary>
    public static string DiVpProofType { get; } = Utf8Constants.ToInternedString(DiVpProofTypeUtf8);
    ...
    /// </summary>
    public static string NotificationId { get; } = Utf8Constants.ToInternedString(NotificationIdUtf8);
    ...
    /// </summary>
    public static string CredentialIdentifiers { get; } = Utf8Constants.ToInternedString(CredentialIdentifiersUtf8);
    ...
    /// </summary>
    public static string TransactionId { get; } = Utf8Constants.ToInternedString(TransactionIdUtf8);
    ...
    /// </summary>
    public static string Interval { get; } = Utf8Constants.ToInternedString(IntervalUtf8);
    ...
    /// event.
    /// </summary>
    public static string EventDescription { get; } = Utf8Constants.ToInternedString(EventDescriptionUtf8);
    ...
    public static string Zip { get; } = Utf8Constants.ToInternedString(ZipUtf8);
}
...
public static class Oid4VciCredentialErrors
{
    ...
    /// malformed.
    /// </summary>
    public static string InvalidCredentialRequest { get; } = Utf8Constants.ToInternedString(InvalidCredentialRequestUtf8);
    ...
    public static string UnknownCredentialConfiguration { get; } = Utf8Constants.ToInternedString(UnknownCredentialConfigurationUtf8);
    ...
    public static string UnknownCredentialIdentifier { get; } = Utf8Constants.ToInternedString(UnknownCredentialIdentifierUtf8);
    ...
    /// </summary>
    public static string InvalidProof { get; } = Utf8Constants.ToInternedString(InvalidProofUtf8);
    ...
    /// </summary>
    public static string InvalidNonce { get; } = Utf8Constants.ToInternedString(InvalidNonceUtf8);
    ...
    /// </summary>
    public static string InvalidEncryptionParameters { get; } = Utf8Constants.ToInternedString(InvalidEncryptionParametersUtf8);
    ...
    /// </summary>
    public static string CredentialRequestDenied { get; } = Utf8Constants.ToInternedString(CredentialRequestDeniedUtf8);
    ...
    /// obtain a Credential.
    /// </summary>
    public static string InvalidTransactionId { get; } = Utf8Constants.ToInternedString(InvalidTransactionIdUtf8);
    ...
    /// </summary>
    public static string InvalidNotificationId { get; } = Utf8Constants.ToInternedString(InvalidNotificationIdUtf8);
    ...
    /// </summary>
    public static string InvalidNotificationRequest { get; } = Utf8Constants.ToInternedString(InvalidNotificationRequestUtf8);
}
