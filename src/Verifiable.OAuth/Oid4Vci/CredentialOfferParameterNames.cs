...
public static class CredentialOfferParameterNames
{
    ...
    /// </summary>
    public static string CredentialOffer { get; } = Utf8Constants.ToInternedString(CredentialOfferUtf8);
    ...
    [SuppressMessage("Design", "CA1056:URI-like properties should not be strings",
        Justification = "This member is the wire parameter NAME 'credential_offer_uri' (compared and serialised as a string), not a dereferenceable System.Uri.")]
    public static string CredentialOfferUri { get; } = Utf8Constants.ToInternedString(CredentialOfferUriUtf8);
    ...
    /// </summary>
    public static string CredentialConfigurationIds { get; } = Utf8Constants.ToInternedString(CredentialConfigurationIdsUtf8);
    ...
    /// its parameters.
    /// </summary>
    public static string Grants { get; } = Utf8Constants.ToInternedString(GrantsUtf8);
    ...
    /// </summary>
    public static string AuthorizationServer { get; } = Utf8Constants.ToInternedString(AuthorizationServerUtf8);
    ...
    /// </summary>
    public static string InputMode { get; } = Utf8Constants.ToInternedString(InputModeUtf8);
    ...
    public static string Length { get; } = Utf8Constants.ToInternedString(LengthUtf8);
...
public static class TxCodeInputModes
{
    ...
    public static string Numeric { get; } = Utf8Constants.ToInternedString(NumericUtf8);
    ...
    public static string Text { get; } = Utf8Constants.ToInternedString(TextUtf8);
}
