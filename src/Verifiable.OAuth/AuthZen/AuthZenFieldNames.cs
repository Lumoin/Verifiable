...
public static class AuthZenFieldNames
{
    ...
    public static string Subject { get; } = Utf8Constants.ToInternedString(SubjectUtf8);
    ...
    public static string Properties { get; } = Utf8Constants.ToInternedString(PropertiesUtf8);
    ...
    public static string Decision { get; } = Utf8Constants.ToInternedString(DecisionUtf8);
    ...
    /// </summary>
    public static string Evaluations { get; } = Utf8Constants.ToInternedString(EvaluationsUtf8);
    ...
    /// </summary>
    public static string EvaluationsSemantic { get; } = Utf8Constants.ToInternedString(EvaluationsSemanticUtf8);
    ...
    public static string Page { get; } = Utf8Constants.ToInternedString(PageUtf8);
    ...
    public static string NextToken { get; } = Utf8Constants.ToInternedString(NextTokenUtf8);
    ...
    public static string Total { get; } = Utf8Constants.ToInternedString(TotalUtf8);
}
