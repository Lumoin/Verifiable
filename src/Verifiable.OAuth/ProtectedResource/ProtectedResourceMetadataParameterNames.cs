...
public static class ProtectedResourceMetadataParameterNames
{
    ...
    [SuppressMessage("Design", "CA1056:URI-like properties should not be strings",
        Justification = "This member is the wire parameter NAME 'jwks_uri' (compared and serialised as a string), not a dereferenceable System.Uri.")]
    ...
    public static string BearerMethodsSupported { get; } = Utf8Constants.ToInternedString(BearerMethodsSupportedUtf8);
    ...
    public static string ResourceSigningAlgValuesSupported { get; } = Utf8Constants.ToInternedString(ResourceSigningAlgValuesSupportedUtf8);
    ...
    public static string ResourceName { get; } = Utf8Constants.ToInternedString(ResourceNameUtf8);
    ...
    public static string ResourceDocumentation { get; } = Utf8Constants.ToInternedString(ResourceDocumentationUtf8);
    ...
    [SuppressMessage("Design", "CA1056:URI-like properties should not be strings",
        Justification = "This member is the wire parameter NAME 'resource_policy_uri' (compared and serialised as a string), not a dereferenceable System.Uri.")]
    public static string ResourcePolicyUri { get; } = Utf8Constants.ToInternedString(ResourcePolicyUriUtf8);
    ...
    [SuppressMessage("Design", "CA1056:URI-like properties should not be strings",
        Justification = "This member is the wire parameter NAME 'resource_tos_uri' (compared and serialised as a string), not a dereferenceable System.Uri.")]
    public static string ResourceTosUri { get; } = Utf8Constants.ToInternedString(ResourceTosUriUtf8);
    ...
    public static string TlsClientCertificateBoundAccessTokens { get; } = Utf8Constants.ToInternedString(TlsClientCertificateBoundAccessTokensUtf8);
    ...
    public static string DpopBoundAccessTokensRequired { get; } = Utf8Constants.ToInternedString(DpopBoundAccessTokensRequiredUtf8);
...
public static class BearerMethodValues
{
    ...
    public static string Header { get; } = Utf8Constants.ToInternedString(HeaderUtf8);
