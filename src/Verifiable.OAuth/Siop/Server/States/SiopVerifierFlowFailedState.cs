...
/// <summary>
/// Terminal failure of the SIOPv2 RP flow. Also serves, with an empty <see cref="OAuthFlowState.FlowId"/>,
...
public sealed record SiopVerifierFlowFailedState: OAuthFlowState
{
