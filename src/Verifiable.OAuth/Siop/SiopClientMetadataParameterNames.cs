...
public static class SiopClientMetadataParameterNames
{
    ...
    /// member (§6.1).
    /// </summary>
    public static string SubjectSyntaxTypesSupported { get; } = Utf8Constants.ToInternedString(SubjectSyntaxTypesSupportedUtf8);
    ...
    /// </summary>
    public static string IdTokenSignedResponseAlg { get; } = Utf8Constants.ToInternedString(IdTokenSignedResponseAlgUtf8);
    ...
    /// </summary>
    public static string IdTokenTypesSupported { get; } = Utf8Constants.ToInternedString(IdTokenTypesSupportedUtf8);
