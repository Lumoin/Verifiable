...
public static class TerminalAuthenticationObjectIdentifier
{
    ...
    private static byte[] EcdsaSha1 { get; } = [0x04, 0x00, 0x7F, 0x00, 0x07, 0x02, 0x02, 0x02, 0x02, 0x01];
    private static byte[] EcdsaSha224 { get; } = [0x04, 0x00, 0x7F, 0x00, 0x07, 0x02, 0x02, 0x02, 0x02, 0x02];
    private static byte[] EcdsaSha256 { get; } = [0x04, 0x00, 0x7F, 0x00, 0x07, 0x02, 0x02, 0x02, 0x02, 0x03];
    private static byte[] EcdsaSha384 { get; } = [0x04, 0x00, 0x7F, 0x00, 0x07, 0x02, 0x02, 0x02, 0x02, 0x04];
    private static byte[] EcdsaSha512 { get; } = [0x04, 0x00, 0x7F, 0x00, 0x07, 0x02, 0x02, 0x02, 0x02, 0x05];
    private static byte[] RsaPkcs1Sha1 { get; } = [0x04, 0x00, 0x7F, 0x00, 0x07, 0x02, 0x02, 0x02, 0x01, 0x01];
    private static byte[] RsaPkcs1Sha256 { get; } = [0x04, 0x00, 0x7F, 0x00, 0x07, 0x02, 0x02, 0x02, 0x01, 0x02];
    private static byte[] RsaPkcs1Sha512 { get; } = [0x04, 0x00, 0x7F, 0x00, 0x07, 0x02, 0x02, 0x02, 0x01, 0x05];
    private static byte[] RsaPssSha1 { get; } = [0x04, 0x00, 0x7F, 0x00, 0x07, 0x02, 0x02, 0x02, 0x01, 0x03];
    private static byte[] RsaPssSha256 { get; } = [0x04, 0x00, 0x7F, 0x00, 0x07, 0x02, 0x02, 0x02, 0x01, 0x04];
    private static byte[] RsaPssSha512 { get; } = [0x04, 0x00, 0x7F, 0x00, 0x07, 0x02, 0x02, 0x02, 0x01, 0x06];
