...
dotnet build Verifiable.slnx
dotnet tool run dotnet-coverage collect --output $CoverageOutputFile --output-format cobertura test/Verifiable.Tests/bin/Debug/net11.0/Verifiable.Tests.exe --report-trx --report-trx-filename testresults.trx --results-directory $CoverageTargetDir
