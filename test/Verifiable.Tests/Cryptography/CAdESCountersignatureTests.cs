...
/// the verification side being unchanged here.
/// </para>
/// </remarks>
[TestClass]
internal sealed class CAdESCountersignatureTests
{
    ...
    /// ETSI EN 319 122-1 V1.3.1</see> 6.3-table1a-countersignature.
    /// </remarks>
    [TestMethod]
    public async Task ACountersignedBaselineSignatureVerifiesUnderTheShippedPathAndBothIndependentReaders()
    {
        ...
        Assert.AreEqual(AdESBaselineLevel.BB, verification.Level, "A countersignature is not a level: Table 1 gives it cardinality >= 0 at every level and clause 6.1 defines the levels by their time-stamps.");
    ...
    /// <remarks>
    /// Proves <see href="https://www.etsi.org/deliver/etsi_en/319100_319199/31912201/01.03.01_60/en_31912201v010301p.pdf">
    /// ETSI EN 319 122-1 V1.3.1</see> 5.2.7-countersignature-rfc5652-11.4.
    /// </remarks>
    [TestMethod]
    ...
    /// <remarks>
    /// Proves <see href="https://www.etsi.org/deliver/etsi_en/319100_319199/31912201/01.03.01_60/en_31912201v010301p.pdf">
    /// ETSI EN 319 122-1 V1.3.1</see> 5.5.3-note4-countersignature-no-own-ats, 5.5.3-note6-mutation-invalidates.
    /// </remarks>
    [TestMethod]
    ...
    /// both directions of this library compute the index and the imprint input with.
    /// </summary>
