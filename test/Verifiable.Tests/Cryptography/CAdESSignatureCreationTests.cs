...
internal sealed class CAdESSignatureCreationTests
{
    ...
    /// </summary>
    /// <remarks>
    /// Proves <see href="https://www.etsi.org/deliver/etsi_en/319100_319199/31912201/01.03.01_60/en_31912201v010301p.pdf">ETSI EN 319 122-1 V1.3.1</see>
    /// 4.1-cms-compliance, 6.3-req-a, 6.3-table1a-certificates. Proves
    /// <see href="https://www.etsi.org/deliver/etsi_en/319100_319199/31914201/01.02.01_60/en_31914201v010201p.pdf">ETSI EN 319 142-1 V1.2.1</see>
    /// PA-6.3-T01, PA-6.3-a.
    /// </remarks>
    [TestMethod]
    ...
    /// that this library's output verifies through the production consumer, not only a hand-rolled
    /// reader.
    /// </summary>
    [TestMethod]
    public async Task AttachedEcdsaSignatureVerifiesUnderTheShippedCAdESVerificationPath()
    {
        ...
        using(privateKey)
        {
            ...
            Assert.AreEqual(AdESBaselineLevel.BB, result.Level, "No timestamp was attached, so the level is baseline.");
    ...
    /// <summary>
    /// Proves the data-to-sign/signature-value split: phase (1)'s output is signed entirely OUTSIDE the
    ...
    /// <remarks>
    /// Proves <see href="https://www.etsi.org/deliver/etsi_en/319100_319199/31912201/01.03.01_60/en_31912201v010301p.pdf">ETSI EN 319 122-1 V1.3.1</see>
    /// 6.3-req-h, 6.3-table1a-spo-signing-certificate.
    /// </remarks>
    [TestMethod]
    ...
    /// <remarks>
    /// Proves <see href="https://www.etsi.org/deliver/etsi_en/319100_319199/31912201/01.03.01_60/en_31912201v010301p.pdf">ETSI EN 319 122-1 V1.3.1</see>
    /// 6.3-req-g, 6.3-req-i, 6.3-req-j, 6.3-table1a-spo-signing-certificate-v2, 6.3-table1a-svc-cert-protection.
    ...
    /// <remarks>
    /// Proves <see href="https://www.etsi.org/deliver/etsi_en/319100_319199/31912201/01.03.01_60/en_31912201v010301p.pdf">ETSI EN 319 122-1 V1.3.1</see>
    /// 6.3-table1a-cms-algorithm-protection.
    /// </remarks>
    [TestMethod]
    ...
    /// ETSI EN 319 122-1 V1.3.1</see> 6.3-table1a-content-type, 6.3-table1a-message-digest,
    /// 6.3-table1a-signing-time, 6.3-req-f.
    /// </remarks>
    [TestMethod]
    ...
    /// <remarks>
    /// Proves <see href="https://www.etsi.org/deliver/etsi_en/319100_319199/31912201/01.03.01_60/en_31912201v010301p.pdf">
    /// ETSI EN 319 122-1 V1.3.1</see> 4.6-no-degenerate-signerinfo.
    /// </remarks>
    [TestMethod]
    ...
    /// independently of the library's own reader through <see cref="CmsStructureOracle"/>.
    /// </summary>
