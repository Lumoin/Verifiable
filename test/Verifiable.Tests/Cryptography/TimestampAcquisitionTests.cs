...
internal sealed class TimestampAcquisitionTests
{
    ...
    /// R4, and <see href="https://www.etsi.org/deliver/etsi_ts/119500_119599/119511/01.02.01_60/ts_119511v010201p.pdf">ETSI TS 119 511 V1.2.1</see>
    /// OVR-9.2-01.
    /// </remarks>
    [TestMethod]
    ...
    /// <remarks>
    /// Proves <see href="https://www.etsi.org/deliver/etsi_en/319400_319499/319422/01.01.01_60/en_319422v010101p.pdf">ETSI EN 319 422 V1.1.1</see>
    /// 4.2.2-nonce, 4.2.2-nonce-echo, R12, R18.
    /// </remarks>
    [TestMethod]
    ...
    /// <summary>An arbitrary TSA policy object identifier the policy-binding tests ask a request for.</summary>
    ...
    /// <summary>
    /// (RFC 3161 §2.4.2): a CMS <c>SignedData</c> whose signature verifies but whose <c>eContentType</c> is
    ...
    /// <summary>
    /// (RFC 3161 §2.4.2 / EN 319 422 clause 4.1.2): a request that names a <c>reqPolicy</c>, answered by a
    ...
    /// <summary>
    /// An exploit regression (RFC 3161 §2.4.2 / EN 319 422 clause 4.1.2): a Time-Stamping Authority that issues
    ...
    /// <summary>
    /// (RFC 3161 §2.4.2): a granted response that nonetheless carries a <c>PKIFailureInfo</c> with a set bit
