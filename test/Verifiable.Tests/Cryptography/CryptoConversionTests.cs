...
namespace Verifiable.Tests.Cryptography
{
    ...
    public sealed class CryptoConversionTests
    {
        ...
        public void TestConversion2()
        {
            ...
            var (algorithm, purpose, scheme, keyMaterial) = CryptoFormatConversions.DefaultBase58ToAlgorithmConverter(Vector1, Verifiable.Core.Cryptography.SensitiveMemoryPool<byte>.Shared, TestSetup.Base58Decoder);
