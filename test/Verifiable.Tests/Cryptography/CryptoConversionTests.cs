...
namespace Verifiable.Tests.Cryptography
{
    ...
    public sealed class CryptoConversionTests
    {
        ...
        public void TestConversion1()
        {
            ...
            var (algorithm, purpose, scheme, keyMaterial) = VerifiableCryptoFormatConversions.DefaultBase58ToAlgorithmConverter(Vector1, Verifiable.Core.Cryptography.SensitiveMemoryPool<byte>.Shared, TestSetup.StackBase58Decoder);
