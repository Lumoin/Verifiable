...
internal sealed class CmsSignedAttributesEncodingTests
{
    ...
    /// ETSI EN 319 122-1 V1.3.1</see> 5.5.3-new-attrs-should-der.
    /// </remarks>
    [TestMethod]
    ...
    /// <remarks>
    /// Proves <see href="https://www.etsi.org/deliver/etsi_en/319100_319199/31912201/01.03.01_60/en_31912201v010301p.pdf">
    /// ETSI EN 319 122-1 V1.3.1</see> 4.7-der-signedattrs.
    /// </remarks>
    [TestMethod]
    ...
    /// <remarks>
    /// Proves <see href="https://www.etsi.org/deliver/etsi_en/319100_319199/31912201/01.03.01_60/en_31912201v010301p.pdf">
    /// ETSI EN 319 122-1 V1.3.1</see> 5.5.3-generation-der-preserving.
    /// </remarks>
    [TestMethod]
    public void RebuildsAnExistingSignedAttributeSetOctetForOctetWhateverOrderTheAttributesArriveIn()
    {
        ...
        //rebuilt is a collection of disposables, not one disposable value: a using declaration disposes one
        //variable's own value, not a collection's elements, so the foreach below in the finally block is the
        //release point.
