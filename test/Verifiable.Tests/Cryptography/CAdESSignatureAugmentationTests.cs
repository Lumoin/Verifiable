...
internal sealed class CAdESSignatureAugmentationTests
{
    ...
    /// <summary>An Annex A.1.3 attribute this library never emits (<c>signer-attributes-v2</c> is not implemented), carried as a literal because no production getter names it — recognising an unimplemented attribute is a test-only concern.</summary>
    private const string AttributeCertificateReferencesAttributeOid = "1.2.840.113549.1.9.16.2.44";

    /// <summary>An Annex A.1.4 attribute this library never emits, for the same reason as <see cref="AttributeCertificateReferencesAttributeOid"/>.</summary>
    ...
    /// ETSI EN 319 122-1 V1.3.1</see> 6.3-table1a-signature-time-stamp, 4.8.1-tst-format.
    /// </remarks>
    [TestMethod]
    public async Task AddsASignatureTimestampTheIndependentOraclesAccept()
    {
        ...
        Assert.AreEqual(AdESBaselineLevel.BT, verification.Level, "A signature carrying a verified signature-time-stamp has reached the time-stamp level.");
    ...
    /// <remarks>
    /// Proves <see href="https://www.etsi.org/deliver/etsi_en/319100_319199/31912201/01.03.01_60/en_31912201v010301p.pdf">
    /// ETSI EN 319 122-1 V1.3.1</see> 6.3-table1b-svc-revocation-values-ltv, 6.3-table1b-spo-crls-crl,
    /// 6.3-table1b-spo-crls-other, 6.3-req-d, 6.3-req-o, 6.3-req-q, 6.3-req-r, 5.5.3-strategy1-root and
    /// <see href="https://www.etsi.org/deliver/etsi_ts/119500_119599/119511/01.02.01_60/ts_119511v010201p.pdf">
    /// ETSI TS 119 511 V1.2.1</see> OVR-7.16-01, OVR-9.3-01, OVR-A-02.
    /// </remarks>
    [TestMethod]
    ...
    /// <remarks>
    /// Proves <see href="https://www.etsi.org/deliver/etsi_en/319100_319199/31912201/01.03.01_60/en_31912201v010301p.pdf">
    /// ETSI EN 319 122-1 V1.3.1</see> a122-revocationvalues-closed-set, a122-ocsp-type-routing.
    /// </remarks>
    [TestMethod]
    ...
    /// <remarks>
    /// Proves <see href="https://www.etsi.org/deliver/etsi_en/319100_319199/31912201/01.03.01_60/en_31912201v010301p.pdf">
    /// ETSI EN 319 122-1 V1.3.1</see> 6.3-req-p and
    /// <see href="https://www.etsi.org/deliver/etsi_ts/119500_119599/119511/01.02.01_60/ts_119511v010201p.pdf">
    /// ETSI TS 119 511 V1.2.1</see> OVR-9.3-02.
    /// </remarks>
    [TestMethod]
    ...
    /// <remarks>
    /// Proves <see href="https://www.etsi.org/deliver/etsi_en/319100_319199/31912201/01.03.01_60/en_31912201v010301p.pdf">
    /// ETSI EN 319 122-1 V1.3.1</see> 5.5.3-delta-crl and
    /// <see href="https://www.etsi.org/deliver/etsi_ts/119500_119599/119511/01.02.01_60/ts_119511v010201p.pdf">
    /// ETSI TS 119 511 V1.2.1</see> OVR-9.3-02.
    /// </remarks>
    [TestMethod]
    ...
    /// <remarks>
    /// Proves <see href="https://www.etsi.org/deliver/etsi_en/319100_319199/31912201/01.03.01_60/en_31912201v010301p.pdf">
    /// ETSI EN 319 122-1 V1.3.1</see> 6.3-table1b-certificate-values, 6.3-table1b-revocation-values,
    /// 5.5.3-strategy2-root-untouched, 5.5.3-strategy2-placement, a112-certvalues-closed-set,
    /// a122-revocationvalues-closed-set.
    /// </remarks>
    [TestMethod]
    ...
    /// <remarks>
    /// Proves <see href="https://www.etsi.org/deliver/etsi_en/319100_319199/31912201/01.03.01_60/en_31912201v010301p.pdf">
    /// ETSI EN 319 122-1 V1.3.1</see> 5.5.3-strategy2-placement, a2.1-general.
    /// </remarks>
    [TestMethod]
    ...
    /// <remarks>
    /// Proves <see href="https://www.etsi.org/deliver/etsi_en/319100_319199/31912201/01.03.01_60/en_31912201v010301p.pdf">
    /// ETSI EN 319 122-1 V1.3.1</see> 5.5.3-lockdown.
    /// </remarks>
    [TestMethod]
    ...
    /// <remarks>
    /// Proves <see href="https://www.etsi.org/deliver/etsi_en/319100_319199/31912201/01.03.01_60/en_31912201v010301p.pdf">
    /// ETSI EN 319 122-1 V1.3.1</see> 6.3-table1b-archive-time-stamp-v3 and
    /// <see href="https://www.etsi.org/deliver/etsi_ts/119500_119599/119511/01.02.01_60/ts_119511v010201p.pdf">
    /// ETSI TS 119 511 V1.2.1</see> 511-D.3.
    /// </remarks>
    [TestMethod]
    ...
    /// <remarks>
    /// Proves <see href="https://www.etsi.org/deliver/etsi_en/319100_319199/31912201/01.03.01_60/en_31912201v010301p.pdf">
    /// ETSI EN 319 122-1 V1.3.1</see> 6.3-req-s, 5.5.3-precondition-extend and
    /// <see href="https://www.etsi.org/deliver/etsi_ts/119500_119599/119511/01.02.01_60/ts_119511v010201p.pdf">
    /// ETSI TS 119 511 V1.2.1</see> OVR-7.15-03.
    /// </remarks>
    [TestMethod]
    ...
    /// <remarks>
    /// Proves <see href="https://www.etsi.org/deliver/etsi_en/319100_319199/31912201/01.03.01_60/en_31912201v010301p.pdf">
    /// ETSI EN 319 122-1 V1.3.1</see> 4.4-version-rule.
    /// </remarks>
    [TestMethod]
    ...
    /// <remarks>
    /// Proves <see href="https://www.etsi.org/deliver/etsi_en/319100_319199/31912201/01.03.01_60/en_31912201v010301p.pdf">
    /// ETSI EN 319 122-1 V1.3.1</see> a2.1-general, a2.4-atsv2, a2.5-long-term-validation, a2.6-ats-hash-index.
    /// </remarks>
    [TestMethod]
    ...
    /// <remarks>
    /// Proves <see href="https://www.etsi.org/deliver/etsi_en/319100_319199/31912201/01.03.01_60/en_31912201v010301p.pdf">
    /// ETSI EN 319 122-1 V1.3.1</see> 6.3-table1b-complete-certificate-references,
    /// 6.3-table1b-complete-revocation-references, 6.3-table1b-attribute-certificate-references,
    /// 6.3-table1b-attribute-revocation-references, 6.3-table1b-cades-c-timestamp,
    /// 6.3-table1b-time-stamped-certs-crls-references, 6.3-req-n.
    /// </remarks>
    [TestMethod]
    ...
    /// <remarks>
    /// Proves <see href="https://www.etsi.org/deliver/etsi_en/319100_319199/31912201/01.03.01_60/en_31912201v010301p.pdf">
    /// ETSI EN 319 122-1 V1.3.1</see> 5.5.3-preservation.
    /// </remarks>
    [TestMethod]
    ...
    /// <remarks>
    /// Proves <see href="https://www.etsi.org/deliver/etsi_en/319100_319199/31912201/01.03.01_60/en_31912201v010301p.pdf">
    /// ETSI EN 319 122-1 V1.3.1</see> 4.7.2-ats-computation-der-only.
    /// </remarks>
    [TestMethod]
