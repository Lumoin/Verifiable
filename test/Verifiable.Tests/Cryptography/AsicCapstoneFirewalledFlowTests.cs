...
internal sealed class AsicCapstoneFirewalledFlowTests
{
    ...
    /// ETSI TS 119 511 V1.2.1</see> 511-4.2-pds-pgd, OVR-9.3-04.
    /// </remarks>
    [TestMethod]
    ...
    public async Task MintedArtifactsPassTheIndependentOracleChainAcrossTheArchiveTheSignatureTheTokensAndBothRenewals()
    {
        ...
        Assert.IsNotEmpty(message.Container, "Minting completed and produced a container; the assertions above already ran against it.");
    }
    ...
    private sealed class ReconstructedAsicVerifyingParty: IDisposable
    {
        ...
        private void AssembleInputs()
        {
            ...
            // object; what this template carries that matters is the constraints and the trust anchor. The
            // trust anchor stands in as the placeholder Signed Data Object for the same reason the world's
