...
/// <c>TOTAL-PASSED</c> run would carry an empty constraints report, even though clause 4.3.5.1 requires a report
/// element for a constraint that was applied and passed, not only for a constraint that failed.
/// </para>
/// </remarks>
[TestClass]
