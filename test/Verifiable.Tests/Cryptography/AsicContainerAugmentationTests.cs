...
internal sealed class AsicContainerAugmentationTests
{
    ...
    /// <summary>The data object shared by the Annex A.7 chain and multi-signature scenarios of this class.</summary>
    private static byte[] RootDataObject { get; } = [.. "the archived data object of the Annex A.7 chain"u8];

    /// <summary>The data object the nested container of <see cref="ASignedFileObjectMayItselfBeAContainer"/> carries.</summary>
    ...
    /// </summary>
    /// <remarks>
    /// Proves <see href="https://www.etsi.org/deliver/etsi_en/319100_319199/31916201/01.01.01_60/en_31916201v010101p.pdf">ETSI EN 319 162-1 V1.1.1</see>
    /// ratified-b-t.
    /// </remarks>
    [TestMethod]
    ...
    /// <remarks>
    /// Proves <see href="https://www.etsi.org/deliver/etsi_en/319100_319199/31916201/01.01.01_60/en_31916201v010101p.pdf">ETSI EN 319 162-1 V1.1.1</see>
    /// p1-4.4.5-2a, p1-A.7-1, p1-A.7-2, p1-A.7-4c-a, p1-A.7-4c-b, p1-A.7-4c-c, ratified-b-lta-container.
    /// Proves <see href="https://www.etsi.org/deliver/etsi_en/319100_319199/31916202/01.01.01_60/en_31916202v010101p.pdf">ETSI EN 319 162-2 V1.1.1</see>
    /// p2-4.3.1-b.
    /// </remarks>
    [TestMethod]
    ...
    /// <remarks>
    /// Proves <see href="https://www.etsi.org/deliver/etsi_en/319100_319199/31916201/01.01.01_60/en_31916201v010101p.pdf">ETSI EN 319 162-1 V1.1.1</see>
    /// p1-A.7-3, p1-A.7-5a, p1-A.7-5b-i, p1-A.7-5b-iii-reference, p1-A.7-5b-iii-rootfile, p1-A.7-5b-iv.
    /// </remarks>
    [TestMethod]
    ...
    /// <remarks>
    /// Proves <see href="https://www.etsi.org/deliver/etsi_en/319100_319199/31916201/01.01.01_60/en_31916201v010101p.pdf">ETSI EN 319 162-1 V1.1.1</see>
    /// p1-5.1-2, p1-5.3.2.2-table3-a, ratified-b-b, ratified-level-min.
    /// </remarks>
    [TestMethod]
    ...
    /// route — is <see cref="TheSimpleTimeAssertionProfileRefusesTheCertificateValuesRoute"/>; this test is the
    /// positive half, which nothing else in the suite drove: every other Annex A.7 test runs against an ASiC-E
    /// container. The container is taken apart by the independent raw-ZIP oracle, its manifest read by an
    /// independent XML reader, its digests recomputed independently and its token validated by the independent
    /// Time-Stamp Protocol validator.
    /// Proves <see href="https://www.etsi.org/deliver/etsi_en/319100_319199/31916201/01.01.01_60/en_31916201v010101p.pdf">ETSI EN 319 162-1 V1.1.1</see>
    /// p1-4.3.3.2-5a, p1-4.3.4-2, p1-A.7-4a.
    /// Proves <see href="https://www.etsi.org/deliver/etsi_en/319100_319199/31916202/01.01.01_60/en_31916202v010101p.pdf">ETSI EN 319 162-2 V1.1.1</see>
    /// p2-4.2.1-b, p2-4.2.1-d-i, p2-4.2.1-d-ii.
    /// </remarks>
    ...
    public async Task TheSimpleTimeAssertionContainerGainsTheAnnexA7ChainUnderTheSignedDataRoute()
    {
        ...
        List<ArchiveManifestReference> references = ReadReferences(payloadsAfter[archived.ArchiveManifestEntryName!]);
        ...
        {
            Assert.IsNull(reference.RootFile, "A first addition points back at nothing, so no reference states Rootfile.");
            Assert.AreSequenceEqual(EvidenceRecordOracle.Hash(payloadsAfter[reference.EntryName], reference.Algorithm), reference.Digest,
                $"The digest stated for '{reference.EntryName}' must be the digest of that entry as the container now stores it.");
        }
    ...
    /// <see cref="TheContainerLevelIsTheLowestLevelOfTheSignaturesItIncorporates"/> established, and the only
    /// multi-signature shape reachable while parallel <c>SignerInfo</c> creation is an owner flag. An ASiC-S
    /// container is used because clause 4.3.3.2 item 4 b makes every CAdES object of such a container detached
    /// over the single root data file, so both objects are raisable without a manifest naming each.
    /// Proves <see href="https://www.etsi.org/deliver/etsi_en/319100_319199/31916201/01.01.01_60/en_31916201v010101p.pdf">ETSI EN 319 162-1 V1.1.1</see>
    /// p1-4.3.4-1-all-signatures, ratified-raise-all.
    /// </remarks>
    /// <returns>A task that completes when the assertions have run.</returns>
    [TestMethod]
    ...
    /// <summary>
    /// Builds an ASiC-S container carrying one CAdES object detached over the single data file, whose content is
    /// <see cref="FirstDataObject"/> and which states no media type of its own.
    /// </summary>
    /// <param name="world">The minted signer and Time-Stamping Authority.</param>
    /// <returns>The container. The caller owns and disposes it.</returns>
    private async Task<AsicContainerCreationResult> CreateSimpleCAdESAsync(AugmentationWorld world) =>
        await CreateSimpleCAdESAsync(world, FirstDataObject, null).ConfigureAwait(false);
    ...
    /// <returns>The container. The caller owns and disposes it.</returns>
    private async Task<AsicContainerCreationResult> CreateSimpleCAdESAsync(AugmentationWorld world, byte[] content, string? mediaType) =>
        await AsicContainerCreation.SignAsync(
            new AsicContainerSignatureContext
            {
                Shape = AsicContainerShape.Simple,
