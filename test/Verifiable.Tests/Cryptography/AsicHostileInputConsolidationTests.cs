...
/// <summary>
/// The hostile-input prong of this library, consolidated where the per-component tests left a gap: the
/// three membership rules of the Evidence Record family cross-fed each other's violations, the stored
/// order of a reduced hash tree, and truncation at the boundaries an attacker's octets arrive through.
/// </summary>
/// <remarks>
/// <para>
/// <strong>Three membership rules, three different correct answers.</strong> This library ships three
/// mechanisms that each answer "does this set of hash values name exactly these objects", and they answer it
...
internal sealed class AsicHostileInputConsolidationTests
{
    ...
    /// took the stored order as given would pass every other test in this library.
    /// </summary>
    /// <remarks>
    ...
    /// on octets that are not a record, and this library's fail-closed rule is that the boundary composing it
