...
/// </summary>
/// <remarks>
/// Every test here is either the round trip through the model, a check on the particle order the encode seam
/// writes, or a document written to break the parse or the encoding. Every digest is computed through the
/// registered digest seam, and every carrier is rented from the house pool and disposed.
/// </remarks>
[TestClass]
internal sealed class AsicManifestXmlBindingTests
{
    ...
    /// p1-A.4.1-3, p1-A.4.2-dor-mimetype, p1-A.4.2-dor-rootfile, p1-A.4.2-sigreference-mimetype.
    /// </remarks>
    [TestMethod]
    ...
    /// <remarks>
    /// Proves <see href="https://www.etsi.org/deliver/etsi_en/319100_319199/31916201/01.01.01_60/en_31916201v010101p.pdf">ETSI EN 319 162-1 V1.1.1</see>
    /// p1-A.4.1-5, p1-A.4.2-extension-wellformed.
    /// </remarks>
    [TestMethod]
