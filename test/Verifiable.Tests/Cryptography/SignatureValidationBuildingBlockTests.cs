...
internal sealed class SignatureValidationBuildingBlockTests
{
    ...
    /// </summary>
    /// <remarks>
    /// Proves <see href="https://www.etsi.org/deliver/etsi_en/319400_319499/319422/01.01.01_60/en_319422v010101p.pdf">
    /// ETSI EN 319 422 V1.1.1</see> 4.2.1, 4.2.2-accuracy, 4.2.2-ordering, R9, R13, R14, R21, R22.
    /// </remarks>
    [TestMethod]
    ...
    /// </summary>
    /// <remarks>
    /// Proves <see href="https://www.etsi.org/deliver/etsi_en/319100_319199/31910201/01.04.01_60/en_31910201v010401p.pdf">
    /// ETSI EN 319 102-1 V1.4.1</see> 5.2.8.4.2.5-step2.
    /// </remarks>
    [TestMethod]
    ...
    /// <remarks>
    /// Proves <see href="https://www.etsi.org/deliver/etsi_en/319100_319199/31910201/01.04.01_60/en_31910201v010401p.pdf">
    /// ETSI EN 319 102-1 V1.4.1</see> 5.2.2.1.
    /// </remarks>
    [TestMethod]
    ...
    /// <remarks>
    /// Proves <see href="https://www.etsi.org/deliver/etsi_en/319100_319199/31910201/01.04.01_60/en_31910201v010401p.pdf">
    /// ETSI EN 319 102-1 V1.4.1</see> 5.6.2.3-classification-by-timestamp-class.
    /// </remarks>
    [TestMethod]
    ...
    /// <remarks>
    /// Proves <see href="https://www.etsi.org/deliver/etsi_en/319100_319199/31910201/01.04.01_60/en_31910201v010401p.pdf">
    /// ETSI EN 319 102-1 V1.4.1</see> 5.2.2.3-failed.
    /// </remarks>
    [TestMethod]
    ...
    /// <remarks>
    /// Proves <see href="https://www.etsi.org/deliver/etsi_en/319400_319499/319422/01.01.01_60/en_319422v010101p.pdf">
    /// ETSI EN 319 422 V1.1.1</see> R17.
    /// Proves <see href="https://www.etsi.org/deliver/etsi_en/319100_319199/31910201/01.04.01_60/en_31910201v010401p.pdf">
    /// ETSI EN 319 102-1 V1.4.1</see> 5.2.3.3-success, 5.2.3.4-step1, 5.2.3.4-step3.
    /// </remarks>
    [TestMethod]
    ...
    /// <remarks>
    /// Proves <see href="https://www.etsi.org/deliver/etsi_en/319100_319199/31910201/01.04.01_60/en_31910201v010401p.pdf">
    /// ETSI EN 319 102-1 V1.4.1</see> 5.2.3.3-not-found, 5.2.3.4-step2, 5.3.4-step2-isc.
    /// </remarks>
    [TestMethod]
    ...
    /// <remarks>
    /// Proves <see href="https://www.etsi.org/deliver/etsi_en/319100_319199/31910201/01.04.01_60/en_31910201v010401p.pdf">
    /// ETSI EN 319 102-1 V1.4.1</see> 5.2.3.4-no-reference, 5.2.7.4-step1-obtain-data, 5.2.7.4-step3-verify.
    /// </remarks>
    [TestMethod]
    ...
    /// <remarks>
    /// Proves <see href="https://www.etsi.org/deliver/etsi_en/319100_319199/31910201/01.04.01_60/en_31910201v010401p.pdf">
    /// ETSI EN 319 102-1 V1.4.1</see> 5.2.7.4-step2-hash, Table15-vocabulary, 5.3.4-step5-cv-not-passed.
    /// </remarks>
    [TestMethod]
    ...
    /// <remarks>
    /// Proves <see href="https://www.etsi.org/deliver/etsi_en/319100_319199/31910201/01.04.01_60/en_31910201v010401p.pdf">
    /// ETSI EN 319 102-1 V1.4.1</see> 5.2.7.4-step4-crypto-failure, Table15-vocabulary.
    /// </remarks>
    [TestMethod]
    public async Task SignatureValueTamperingReportsSignatureCryptographicFailure()
    {
        ...
        using var signerCertificate = CmsSignedDataTestFactory.MintSelfSignedCertificate(signingKey, notBefore, notAfter);
        using var otherCertificate = CmsSignedDataTestFactory.MintSelfSignedCertificate(otherKey, notBefore, notAfter);
        using CmsSignedData carrier = CmsSignedDataTestFactory.SignAsCAdES("the tampering content"u8, signerCertificate, TestClock.CanonicalEpoch);
        using SignatureFacts facts = await ExtractAsync(carrier).ConfigureAwait(false);
    ...
    /// <remarks>
    /// Proves <see href="https://www.etsi.org/deliver/etsi_en/319100_319199/31910201/01.04.01_60/en_31910201v010401p.pdf">
    /// ETSI EN 319 102-1 V1.4.1</see> 5.2.4.3-passed, 5.2.4.4-default-policy, 5.2.4.1-scope.
    /// </remarks>
    [TestMethod]
    ...
    /// <remarks>
    /// Proves <see href="https://www.etsi.org/deliver/etsi_en/319100_319199/31910201/01.04.01_60/en_31910201v010401p.pdf">
    /// ETSI EN 319 102-1 V1.4.1</see> 5.2.5.4-step1-constraint-value, 5.2.5.4-step2.
    /// Proves <see href="https://www.etsi.org/deliver/etsi_ts/119100_119199/11917204/01.02.01_60/ts_11917204v010201p.pdf">
    /// ETSI TS 119 172-4 V1.2.1</see> REQ-4.2-03-c-ii.
    /// </remarks>
    [TestMethod]
    ...
    /// <remarks>
    /// Proves <see href="https://www.etsi.org/deliver/etsi_en/319100_319199/31910201/01.04.01_60/en_31910201v010401p.pdf">
    /// ETSI EN 319 102-1 V1.4.1</see> 5.2.5.4-step1-nextupdate-fallback, 5.2.5.4-note1-no-nextupdate.
    /// </remarks>
    [TestMethod]
    ...
    /// <remarks>
    /// Proves <see href="https://www.etsi.org/deliver/etsi_en/319100_319199/31910201/01.04.01_60/en_31910201v010401p.pdf">
    /// ETSI EN 319 102-1 V1.4.1</see> 5.2.6.4-step1a, 5.2.6.4-step1b, 5.2.6.4-step3, 5.6.2.2.4-step1a.
    /// Proves <see href="https://www.etsi.org/deliver/etsi_ts/119100_119199/11917204/01.02.01_60/ts_11917204v010201p.pdf">
    /// ETSI TS 119 172-4 V1.2.1</see> REQ-4.2-03-d.
    /// </remarks>
    [TestMethod]
    ...
    /// <remarks>
    /// Proves <see href="https://www.etsi.org/deliver/etsi_en/319100_319199/31910201/01.04.01_60/en_31910201v010401p.pdf">
    /// ETSI EN 319 102-1 V1.4.1</see> 5.1.4.2-x509, 5.2.6.4-step2-other-certificates, 5.2.6.4-step4-rfc5280,
    /// 5.2.6.4-step4-latest-revocation, 5.2.6.4-step4a-fresh, 5.2.6.4-step4b-revoked-signing,
    /// 5.2.6.4-step4d-revoked-ca, 5.2.6.4-step9-passed, Table13-passed, Table13-indeterminate-rows,
    /// 5.5.4-step7-try-later-suspended.
    /// </remarks>
    [TestMethod]
    ...
    /// <remarks>
    /// Proves <see href="https://www.etsi.org/deliver/etsi_en/319100_319199/31910201/01.04.01_60/en_31910201v010401p.pdf">
    /// ETSI EN 319 102-1 V1.4.1</see> 5.2.6.4-step4c-on-hold.
    /// </remarks>
    [TestMethod]
    ...
    /// <remarks>
    /// Proves <see href="https://www.etsi.org/deliver/etsi_en/319100_319199/31910201/01.04.01_60/en_31910201v010401p.pdf">
    /// ETSI EN 319 102-1 V1.4.1</see> 5.2.6.4-step8-revocation-out-of-bounds.
    /// </remarks>
    [TestMethod]
    ...
    /// <remarks>
    /// Proves <see href="https://www.etsi.org/deliver/etsi_en/319100_319199/31910201/01.04.01_60/en_31910201v010401p.pdf">
    /// ETSI EN 319 102-1 V1.4.1</see> 5.1.4.4-elements, 5.2.8.4.1-malformed-as-absent, 5.2.8.4.1-passed,
    /// 5.2.8.4.1-may-ignore-unconstrained, 5.2.8.4.2.1-references-outside-path,
    /// 5.2.8.4.2.2-claimed-time-unconstrained, Table17-vocabulary, 5.6.3.4-step5c-ii-sav-at-earliest-time.
    /// </remarks>
    [TestMethod]
    ...
    /// <remarks>
    /// Proves <see href="https://www.etsi.org/deliver/etsi_en/319100_319199/31910201/01.04.01_60/en_31910201v010401p.pdf">
    /// ETSI EN 319 102-1 V1.4.1</see> Table5-indeterminate, 5.2.8.4.1-sig-constraints-failure, 5.2.8.4.2.5-step3,
    /// 5.3.4-step6-sav-otherwise.
    /// </remarks>
    [TestMethod]
    ...
    /// <remarks>
    /// Proves <see href="https://www.etsi.org/deliver/etsi_ts/119100_119199/11917204/01.02.01_60/ts_11917204v010201p.pdf">
    /// ETSI TS 119 172-4 V1.2.1</see> REQ-4.2-03-g.
    /// </remarks>
    [TestMethod]
    ...
    /// <remarks>
    /// Proves <see href="https://www.etsi.org/deliver/etsi_en/319100_319199/31910201/01.04.01_60/en_31910201v010401p.pdf">
    /// ETSI EN 319 102-1 V1.4.1</see> 5.2.8.4.1-crypto-failure, 5.3.4-step6-sav-crypto-content-timestamp,
    /// 5.5.4-step4c-crypto-no-poe, 5.6.2.2.4-step2d-unassertable, 5.6.2.4.4-step4-crypto-no-poe.
    /// Proves <see href="https://www.etsi.org/deliver/etsi_ts/119100_119199/11917204/01.02.01_60/ts_11917204v010201p.pdf">
    /// ETSI TS 119 172-4 V1.2.1</see> REQ-4.2-03-e, REQ-4.2-03-f.
    /// </remarks>
    [TestMethod]
    ...
    /// <summary>
    /// Builds a cryptographic constraints table asserting only the ring's own ECDSA-with-SHA-256 signature
    /// algorithm reliable without expiry, so a test naming that single algorithm is decided by the step under
    /// test and not by an unrelated entry of a wider table. Distinct from <see cref="EllipticCurveSignatureAlgorithms"/>,
    /// which also lists an alternate signature algorithm and a bare digest entry that these tests do not need.
    /// </summary>
    /// <returns>The table.</returns>
