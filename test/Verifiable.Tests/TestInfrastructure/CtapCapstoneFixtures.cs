...
/// <summary>
/// Shared fixtures for the CTAP capstone flow tests: the RP/client-side plumbing the capstone
/// needs on top of <see cref="CtapMakeCredentialGetAssertionFixtures"/> — the independently-computed
...
/// </summary>
internal static class CtapCapstoneFixtures
{
    ...
    /// client-side translation a real platform performs, mirrored here since it is not part of the
    /// library's shipped production surface (only the reverse, response-side translation is).
    /// </summary>
    ...
    /// <see langword="null"/> to send no PIN/UV auth token at all — the PIN/UV token leg a real
