...
/// every token-gated command, so this fixture reuses <see cref="CtapConfigFixtures.EstablishPinAsync"/>/
/// <see cref="CtapConfigFixtures.IssueTokenAsync"/>/<see cref="CtapConfigFixtures.GetInfoAsync"/>/
/// <see cref="CtapConfigFixtures.ComputeSignatureAsync"/> unchanged — all four are already
...
/// <see cref="CtapMakeCredentialGetAssertionFixtures"/>'s envelope-building role for the mc/ga surface.
/// </summary>
internal static class CtapCredentialManagementFixtures
{
    ...
    /// <see cref="CtapConfigFixtures.BuildMessage"/>'s own compound shape).
    /// </summary>
