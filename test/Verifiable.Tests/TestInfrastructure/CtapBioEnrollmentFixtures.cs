...
/// envelope assembly and the platform-side <c>pinUvAuthParam</c> verify message
...
/// command, so this fixture reuses <see cref="CtapConfigFixtures.EstablishPinAsync"/>/
/// <see cref="CtapConfigFixtures.IssueTokenAsync"/>/<see cref="CtapConfigFixtures.ComputeSignatureAsync"/>
/// unchanged, mirroring <see cref="CtapCredentialManagementFixtures"/>'s identical role for
/// <c>authenticatorCredentialManagement</c>.
/// </summary>
internal static class CtapBioEnrollmentFixtures
{
    ...
    /// <summary>
    /// Assembles <c>authenticatorBioEnrollment</c>'s verify message:
    ...
    /// <see cref="CtapCredentialManagementFixtures.BuildMessage"/>'s own elision convention but with a two-byte prefix.
    /// </summary>
