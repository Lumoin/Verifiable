...
{
    /// <summary>Forwards to <see cref="MicrosoftHmacFunctions.ComputeHmacAsync(System.ReadOnlyMemory{byte}, System.ReadOnlyMemory{byte}, int, Lumoin.Base.Tag, Lumoin.Base.BaseMemoryPool, System.TimeProvider, System.Collections.Frozen.FrozenDictionary{string, object}?, System.Threading.CancellationToken)"/> with the suite's canonical fixed clock, <see cref="TestCryptoAdapterClock.Instance"/>.</summary>
    ...
    /// <summary>Forwards to <see cref="MicrosoftHmacFunctions.ComputeHmacAsync(System.Buffers.ReadOnlySequence{byte}, System.ReadOnlyMemory{byte}, int, Lumoin.Base.Tag, Lumoin.Base.BaseMemoryPool, System.TimeProvider, System.Collections.Frozen.FrozenDictionary{string, object}?, System.Threading.CancellationToken)"/> with the suite's canonical fixed clock, <see cref="TestCryptoAdapterClock.Instance"/>.</summary>
    ...
    /// <summary>Forwards to <see cref="MicrosoftHmacFunctions.VerifyHmacAsync(System.ReadOnlyMemory{byte}, System.ReadOnlyMemory{byte}, System.ReadOnlyMemory{byte}, Lumoin.Base.Tag, Lumoin.Base.BaseMemoryPool, System.TimeProvider, System.Collections.Frozen.FrozenDictionary{string, object}?, System.Threading.CancellationToken)"/> with the suite's canonical fixed clock, <see cref="TestCryptoAdapterClock.Instance"/>.</summary>
    ...
    /// <summary>Forwards to <see cref="MicrosoftHmacFunctions.VerifyHmacAsync(System.Buffers.ReadOnlySequence{byte}, System.ReadOnlyMemory{byte}, System.ReadOnlyMemory{byte}, Lumoin.Base.Tag, Lumoin.Base.BaseMemoryPool, System.TimeProvider, System.Collections.Frozen.FrozenDictionary{string, object}?, System.Threading.CancellationToken)"/> with the suite's canonical fixed clock, <see cref="TestCryptoAdapterClock.Instance"/>.</summary>
