...
namespace Verifiable.Tests
{
    ...
    public sealed class MulticodecTestVectorTests
    {
        ...
        public void RoundtripEd25519()
        {
            ...
            var decodedVector1 = MultibaseSerializer.Decode(Vector1, Verifiable.Core.Cryptography.SensitiveMemoryPool<byte>.Shared, TestSetup.StackBase58Decoder).Memory.Span;
            ...
            var decodedVector2 = MultibaseSerializer.Decode(Vector2, Verifiable.Core.Cryptography.SensitiveMemoryPool<byte>.Shared, TestSetup.StackBase58Decoder).Memory.Span;
            var reEncodedVector2 = MultibaseSerializer.Encode(decodedVector2, MulticodecHeaders.Ed25519PublicKey, MultibaseAlgorithms.Base58Btc, TestSetup.TestBase58ArrayEncoder);
            Assert.AreEqual(Vector2, reEncodedVector2);

            var decodedVector3 = MultibaseSerializer.Decode(Vector3, Verifiable.Core.Cryptography.SensitiveMemoryPool<byte>.Shared, TestSetup.StackBase58Decoder).Memory.Span;
            var reEncodedVector3 = MultibaseSerializer.Encode(decodedVector3, MulticodecHeaders.Ed25519PublicKey, MultibaseAlgorithms.Base58Btc, TestSetup.TestBase58ArrayEncoder);
            Assert.AreEqual(Vector3, reEncodedVector3);

            //A sanity check, some (in practice 'any') other vector type should not work.
            var reEncodedVector1WithWrongHeader = MultibaseSerializer.Encode(decodedVector1, MulticodecHeaders.P256PublicKey, MultibaseAlgorithms.Base58Btc, TestSetup.TestBase58ArrayEncoder);
        ...
        public void RoundtripX25519()
        {
            ...
            var decodedVector1 = MultibaseSerializer.Decode(Vector1, Verifiable.Core.Cryptography.SensitiveMemoryPool<byte>.Shared, TestSetup.StackBase58Decoder).Memory.Span;
            var reEncodedVector1 = MultibaseSerializer.Encode(decodedVector1, MulticodecHeaders.X25519PublicKey, MultibaseAlgorithms.Base58Btc, TestSetup.TestBase58ArrayEncoder);
            Assert.AreEqual(Vector1, reEncodedVector1);

            var decodedVector2 = MultibaseSerializer.Decode(Vector2, Verifiable.Core.Cryptography.SensitiveMemoryPool<byte>.Shared, TestSetup.StackBase58Decoder).Memory.Span;
            var reEncodedVector2 = MultibaseSerializer.Encode(decodedVector2, MulticodecHeaders.X25519PublicKey, MultibaseAlgorithms.Base58Btc, TestSetup.TestBase58ArrayEncoder);
            Assert.AreEqual(Vector2, reEncodedVector2);

            var decodedVector3 = MultibaseSerializer.Decode(Vector3, Verifiable.Core.Cryptography.SensitiveMemoryPool<byte>.Shared, TestSetup.StackBase58Decoder).Memory.Span;
            var reEncodedVector3 = MultibaseSerializer.Encode(decodedVector3, MulticodecHeaders.X25519PublicKey, MultibaseAlgorithms.Base58Btc, TestSetup.TestBase58ArrayEncoder);
            Assert.AreEqual(Vector3, reEncodedVector3);
        ...
        public void RoundtripSecp256k1()
        {
            ...
            var decodedVector1 = MultibaseSerializer.Decode(Vector1, Verifiable.Core.Cryptography.SensitiveMemoryPool<byte>.Shared, TestSetup.StackBase58Decoder).Memory.Span;
            var reEncodedVector1 = MultibaseSerializer.Encode(decodedVector1, MulticodecHeaders.Secp256k1PublicKey, MultibaseAlgorithms.Base58Btc, TestSetup.TestBase58ArrayEncoder);
            Assert.AreEqual(Vector1, reEncodedVector1);

            var decodedVector2 = MultibaseSerializer.Decode(Vector2, Verifiable.Core.Cryptography.SensitiveMemoryPool<byte>.Shared, TestSetup.StackBase58Decoder).Memory.Span;
            var reEncodedVector2 = MultibaseSerializer.Encode(decodedVector2, MulticodecHeaders.Secp256k1PublicKey, MultibaseAlgorithms.Base58Btc, TestSetup.TestBase58ArrayEncoder);
            Assert.AreEqual(Vector2, reEncodedVector2);

            var decodedVector3 = MultibaseSerializer.Decode(Vector3, Verifiable.Core.Cryptography.SensitiveMemoryPool<byte>.Shared, TestSetup.StackBase58Decoder).Memory.Span;
            var reEncodedVector3 = MultibaseSerializer.Encode(decodedVector3, MulticodecHeaders.Secp256k1PublicKey, MultibaseAlgorithms.Base58Btc, TestSetup.TestBase58ArrayEncoder);
            Assert.AreEqual(Vector3, reEncodedVector3);
        ...
        public void RoundtripBls12381()
        {
            ...
            var decodedVector1 = MultibaseSerializer.Decode(Vector1, Verifiable.Core.Cryptography.SensitiveMemoryPool<byte>.Shared, TestSetup.StackBase58Decoder).Memory.Span;
            var reEncodedVector1 = MultibaseSerializer.Encode(decodedVector1, MulticodecHeaders.Bls12381G2PublicKey, MultibaseAlgorithms.Base58Btc, TestSetup.TestBase58ArrayEncoder);
            Assert.AreEqual(Vector1, reEncodedVector1);

            var decodedVector2 = MultibaseSerializer.Decode(Vector2, Verifiable.Core.Cryptography.SensitiveMemoryPool<byte>.Shared, TestSetup.StackBase58Decoder).Memory.Span;
            var reEncodedVector2 = MultibaseSerializer.Encode(decodedVector2, MulticodecHeaders.Bls12381G2PublicKey, MultibaseAlgorithms.Base58Btc, TestSetup.TestBase58ArrayEncoder);
            Assert.AreEqual(Vector2, reEncodedVector2);
        ...
        public void RoundtripP256()
        {
            ...
            var decodedVector1 = MultibaseSerializer.Decode(Vector1, Verifiable.Core.Cryptography.SensitiveMemoryPool<byte>.Shared, TestSetup.StackBase58Decoder).Memory.Span;
            var reEncodedVector1 = MultibaseSerializer.Encode(decodedVector1, MulticodecHeaders.P256PublicKey, MultibaseAlgorithms.Base58Btc, TestSetup.TestBase58ArrayEncoder);
            Assert.AreEqual(Vector1, reEncodedVector1);

            var decodedVector2 = MultibaseSerializer.Decode(Vector2, Verifiable.Core.Cryptography.SensitiveMemoryPool<byte>.Shared, TestSetup.StackBase58Decoder).Memory.Span;
            var reEncodedVector2 = MultibaseSerializer.Encode(decodedVector2, MulticodecHeaders.P256PublicKey, MultibaseAlgorithms.Base58Btc, TestSetup.TestBase58ArrayEncoder);
            Assert.AreEqual(Vector2, reEncodedVector2);

            //A sanity check, some (in practice 'any') other vector type should not work.
            var reEncodedVector1WithWrongHeader = MultibaseSerializer.Encode(decodedVector1, MulticodecHeaders.Bls12381G2PublicKey, MultibaseAlgorithms.Base58Btc, TestSetup.TestBase58ArrayEncoder);
            Assert.AreNotEqual(Vector1, reEncodedVector1WithWrongHeader);
        }
        ...
        public void RoundtripP384()
        {
            ...
            var decodedVector1 = MultibaseSerializer.Decode(Vector1, Verifiable.Core.Cryptography.SensitiveMemoryPool<byte>.Shared, TestSetup.StackBase58Decoder).Memory.Span;
            var reEncodedVector1 = MultibaseSerializer.Encode(decodedVector1, MulticodecHeaders.P384PublicKey, MultibaseAlgorithms.Base58Btc, TestSetup.TestBase58ArrayEncoder);
            Assert.AreEqual(Vector1, reEncodedVector1);

            var decodedVector2 = MultibaseSerializer.Decode(Vector2, Verifiable.Core.Cryptography.SensitiveMemoryPool<byte>.Shared, TestSetup.StackBase58Decoder).Memory.Span;
            var reEncodedVector2 = MultibaseSerializer.Encode(decodedVector2, MulticodecHeaders.P384PublicKey, MultibaseAlgorithms.Base58Btc, TestSetup.TestBase58ArrayEncoder);
            Assert.AreEqual(Vector2, reEncodedVector2);
        ...
        public void RoundtripP521()
        {
            ...
            var decodedVector1 = MultibaseSerializer.Decode(Vector1, Verifiable.Core.Cryptography.SensitiveMemoryPool<byte>.Shared, TestSetup.StackBase58Decoder).Memory.Span;
            var reEncodedVector1 = MultibaseSerializer.Encode(decodedVector1, MulticodecHeaders.P521PublicKey, MultibaseAlgorithms.Base58Btc, TestSetup.TestBase58ArrayEncoder);
            Assert.AreEqual(Vector1, reEncodedVector1);

            var decodedVector2 = MultibaseSerializer.Decode(Vector2, Verifiable.Core.Cryptography.SensitiveMemoryPool<byte>.Shared, TestSetup.StackBase58Decoder).Memory.Span;
            var reEncodedVector2 = MultibaseSerializer.Encode(decodedVector2, MulticodecHeaders.P521PublicKey, MultibaseAlgorithms.Base58Btc, TestSetup.TestBase58ArrayEncoder);
            Assert.AreEqual(Vector2, reEncodedVector2);
        ...
        public void RoundtripRsa2048()
        {
            ...
            var decodedVector1 = MultibaseSerializer.Decode(Vector1, Verifiable.Core.Cryptography.SensitiveMemoryPool<byte>.Shared, TestSetup.StackBase58Decoder).Memory.Span;
            var reEncodedVector1 = MultibaseSerializer.Encode(decodedVector1, MulticodecHeaders.RsaPublicKey, MultibaseAlgorithms.Base58Btc, TestSetup.TestBase58ArrayEncoder);
            Assert.AreEqual(Vector1, reEncodedVector1);
