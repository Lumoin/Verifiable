...
namespace Verifiable.Tests
{
    ...
    {                                       
        ...
        public void RoundtripEd25519()
        {
            ...
            var decodedVector2 = MultibaseSerializer.Decode(Vector2, ExactSizeMemoryPool<byte>.Shared, TestSetup.StackBase58Decoder).Memory.Span;
            ...
            var decodedVector3 = MultibaseSerializer.Decode(Vector3, ExactSizeMemoryPool<byte>.Shared, TestSetup.StackBase58Decoder).Memory.Span;
