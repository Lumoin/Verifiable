...
internal sealed class AnnexAValidationFixtureTests
{
    ...
    /// 5.4.4-step3-other-data, 5.5.4-step3a-imprint-check.
    /// </remarks>
    [TestMethod]
    ...
    public async Task RevokedCertificateWorldSignedDataObjectVerifiesThroughTheShippedCAdESVerifier()
    {
        ...
        Assert.AreEqual(AdESBaselineLevel.BT, verification.Level, "A signature carrying a signature time-stamp is a signature with time.");
    ...
    /// <remarks>
    /// Proves <see href="https://www.etsi.org/deliver/etsi_en/319100_319199/31910201/01.04.01_60/en_31910201v010401p.pdf">ETSI EN 319 102-1 V1.4.1</see>
    /// 5.1.3-determinism-c, 5.6.1-da-supplied-poe, 5.6.3.4-note3-da-poe-used-as-is.
    /// </remarks>
    [TestMethod]
