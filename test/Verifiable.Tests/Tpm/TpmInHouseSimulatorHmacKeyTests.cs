...
internal sealed class TpmInHouseSimulatorHmacKeyTests
{
    ...
    private static byte[] SampleKey { get; } = Convert.FromHexString("0b0b0b0b0b0b0b0b0b0b0b0b0b0b0b0b0b0b0b0b");
    ...
    /// <see href="https://trustedcomputinggroup.org/resource/tpm-library-specification/">TPM 2.0 Library Part 3, clauses 12.1 and 12.4; Part 2, clause 8.3.2, Table 37; clause 8.3.3.14; clause 12.2.3.3, Table 227</see>.
    /// </summary>
    [TestMethod]
    ...
    public async Task UnsealOnAnHmacKeyIsRefusedWithAttributes()
    {
        ...
        Assert.AreEqual(HmacKeyHarness.HandleEncodedRc(TpmRcConstants.TPM_RC_ATTRIBUTES, 0), result.ResponseCode, "TPM2_Unseal() on an HMAC key must be refused with TPM_RC_ATTRIBUTES.");
    }
    ...
    public async Task UnsealOverAnHmacSessionOnAnHmacKeyIsRefusedWithAttributes()
    {
        ...
        try
        {
            using(session)
            {
                ...
                Assert.AreEqual(HmacKeyHarness.HandleEncodedRc(TpmRcConstants.TPM_RC_ATTRIBUTES, 0), result.ResponseCode, "TPM2_Unseal() over an HMAC session on an HMAC key must be refused with TPM_RC_ATTRIBUTES.");
            }
        }
        finally
        {
    ...
    public async Task CreateHmacKeyWithSensitiveDataOriginAndSuppliedDataIsRefusedWithAttributes()
    {
        ...
        using(tpm)
        {
            ...
            Assert.AreEqual(HmacKeyHarness.ParameterEncodedRc(TpmRcConstants.TPM_RC_ATTRIBUTES, 1), result.ResponseCode, "A sensitiveDataOrigin-SET template that supplies data must be refused with TPM_RC_ATTRIBUTES.");
        }
    }
    ...
    public async Task CreateHmacKeyWithoutSensitiveDataOriginAndNoDataIsRefusedWithAttributes()
    {
        ...
        using(tpm)
        {
            ...
            Assert.AreEqual(HmacKeyHarness.ParameterEncodedRc(TpmRcConstants.TPM_RC_ATTRIBUTES, 1), result.ResponseCode, "A sensitiveDataOrigin-CLEAR template with no data must be refused with TPM_RC_ATTRIBUTES.");
        }
    }
    ...
    public async Task CreateRestrictedHmacKeyWithACallerSuppliedKeyIsRefusedWithAttributes()
    {
        ...
        using(tpm)
        {
            ...
            Assert.AreEqual(HmacKeyHarness.ParameterEncodedRc(TpmRcConstants.TPM_RC_ATTRIBUTES, 1), result.ResponseCode, "A bound restricted HMAC key from a caller-supplied value must be refused with TPM_RC_ATTRIBUTES.");
        }
    }
    ...
    public async Task CreateHmacKeyWithAnOversizedKeyIsRefusedWithSize()
    {
        ...
        using(tpm)
        {
            ...
            Assert.AreEqual(HmacKeyHarness.ParameterEncodedRc(TpmRcConstants.TPM_RC_SIZE, 1), result.ResponseCode, "An HMAC key value larger than the scheme hash block size must be refused with TPM_RC_SIZE.");
        }
    }
    ...
    public async Task CreateHmacKeyOf129OctetsUnderSha512IsRefusedWithSize()
    {
        ...
        using(tpm)
        {
            ...
            Assert.AreEqual(
                ...
                "Table 18: inSensitive is TPM2_Create()'s first parameter (index 0); a 129-octet key value is not a TPM2B_SENSITIVE_DATA and must be refused with TPM_RC_SIZE there under every scheme hash.");
        }
    }
    ...
    public async Task CreateHmacKeyWithASha1SchemeIsRefusedWithHash()
    {
        ...
        using(tpm)
        {
            ...
            Assert.AreEqual(HmacKeyHarness.ParameterEncodedRc(TpmRcConstants.TPM_RC_HASH, 1), result.ResponseCode, "An HMAC key with a SHA-1 scheme must be refused with TPM_RC_HASH.");
        }
    }
    ...
    public async Task CreateSignOnlyKeyedHashWithANullSchemeIsRefusedWithScheme()
    {
        ...
        using(tpm)
        {
            ...
            Assert.AreEqual(HmacKeyHarness.ParameterEncodedRc(TpmRcConstants.TPM_RC_SCHEME, 1), result.ResponseCode, "A sign-only KEYEDHASH template with a NULL scheme must be refused with TPM_RC_SCHEME.");
        }
    }
    ...
    public async Task CreateKeyedHashWithSignAndDecryptBothSetAndANullSchemeIsRefusedWithAttributes()
    {
        ...
        using(tpm)
        {
            ...
            Assert.AreEqual(HmacKeyHarness.ParameterEncodedRc(TpmRcConstants.TPM_RC_ATTRIBUTES, 1), result.ResponseCode, "A KEYEDHASH template with sign and decrypt both SET must be refused with TPM_RC_ATTRIBUTES.");
        }
    }
    ...
    public async Task CreateKeyedHashWithSignAndDecryptBothSetAndAnHmacSchemeIsRefusedWithScheme()
    {
        ...
        using(tpm)
        {
            ...
            Assert.AreEqual(HmacKeyHarness.ParameterEncodedRc(TpmRcConstants.TPM_RC_SCHEME, 1), result.ResponseCode, "A both-SET template with a non-NULL scheme must be refused with rule 2's TPM_RC_SCHEME.");
        }
    }
    ...
    public async Task CreateDataObjectWithAnHmacSchemeIsRefusedWithScheme()
    {
        ...
        using(tpm)
        {
            ...
            Assert.AreEqual(HmacKeyHarness.ParameterEncodedRc(TpmRcConstants.TPM_RC_SCHEME, 1), result.ResponseCode, "A data object template with an HMAC scheme must be refused with TPM_RC_SCHEME.");
        }
    }
    ...
    public async Task CreateDecryptOnlyKeyedHashWithAnHmacSchemeIsRefusedWithScheme()
    {
        ...
        using(tpm)
        {
            ...
            Assert.AreEqual(HmacKeyHarness.ParameterEncodedRc(TpmRcConstants.TPM_RC_SCHEME, 1), result.ResponseCode, "A decrypt-only KEYEDHASH template with an HMAC scheme must be refused with TPM_RC_SCHEME.");
        }
    }
    ...
    public async Task CreateRestrictedDataObjectIsRefusedWithAttributes()
    {
        ...
        using(tpm)
        {
            ...
            Assert.AreEqual(HmacKeyHarness.ParameterEncodedRc(TpmRcConstants.TPM_RC_ATTRIBUTES, 1), result.ResponseCode, "A restricted data object must be refused with TPM_RC_ATTRIBUTES.");
        }
    }
    ...
    public async Task CreateXorKeyWithANullHashIsRefusedWithHash()
    {
        ...
        using(tpm)
        {
            ...
            Assert.AreEqual(HmacKeyHarness.ParameterEncodedRc(TpmRcConstants.TPM_RC_HASH, 1), result.ResponseCode, "An XOR key with a NULL scheme hash must be refused with TPM_RC_HASH.");
        }
    }
    ...
    public async Task CreateRestrictedXorKeyWithoutKdf1IsRefusedWithScheme()
    {
        ...
        using(tpm)
        {
            ...
            Assert.AreEqual(HmacKeyHarness.ParameterEncodedRc(TpmRcConstants.TPM_RC_SCHEME, 1), result.ResponseCode, "A restricted XOR key whose kdf is not KDF1_SP800_108 must be refused with TPM_RC_SCHEME.");
        }
    }
    ...
    public async Task LoadWithASignAttributeAddedToASealedDataPublicIsRefusedWithScheme()
    {
        ...
        using(outPrivate)
        {
            ...
            Assert.AreEqual(HmacKeyHarness.ParameterEncodedRc(TpmRcConstants.TPM_RC_SCHEME, 1), result.ResponseCode, "A sign-SET public area with a NULL scheme must be refused at Load with TPM_RC_SCHEME.");
        }
    }
    ...
    public async Task LoadWithRestrictedAddedToASealedDataPublicIsRefusedWithAttributes()
    {
        ...
        using(outPrivate)
        {
            ...
            Assert.AreEqual(HmacKeyHarness.ParameterEncodedRc(TpmRcConstants.TPM_RC_ATTRIBUTES, 1), result.ResponseCode, "A restricted data-object public area must be refused at Load with TPM_RC_ATTRIBUTES.");
        }
    }
    ...
    public async Task LoadWithASha1HmacSchemePublicIsRefusedWithHash()
    {
        ...
        using(outPrivate)
        {
            ...
            Assert.AreEqual(HmacKeyHarness.ParameterEncodedRc(TpmRcConstants.TPM_RC_HASH, 1), result.ResponseCode, "An HMAC-SHA-1 public area must be refused at Load with TPM_RC_HASH.");
        }
    }
    ...
    public async Task ImportOfABareDuplicateWithAnOversizedKeyValueIsRefusedWithKeySize()
    {
        ...
        using(tpm)
        {
            ...
            Assert.AreEqual(HmacKeyHarness.ParameterEncodedRc(TpmRcConstants.TPM_RC_KEY_SIZE, 2), result.ResponseCode, "A 65-octet key value under an HMAC-SHA-256 public area must be refused at Import with TPM_RC_KEY_SIZE at duplicate, parameter 3 of Table 40.");
        }
    }
    ...
    public async Task ImportOfABareDuplicateWithAWrongSizedSeedIsRefusedWithKeySize()
    {
        ...
        using(tpm)
        {
            ...
            Assert.AreEqual(HmacKeyHarness.ParameterEncodedRc(TpmRcConstants.TPM_RC_KEY_SIZE, 2), result.ResponseCode, "A 33-octet seedValue under a SHA-256 nameAlg must be refused at Import with TPM_RC_KEY_SIZE at duplicate, parameter 3 of Table 40.");
        }
    }
    ...
    public async Task CreateHmacKeyOverAnHmacSessionWithSensitiveDataOriginAndSuppliedDataIsRefusedWithAttributes()
    {
        ...
        try
        {
            using(session)
            {
                ...
                Assert.AreEqual(HmacKeyHarness.ParameterEncodedRc(TpmRcConstants.TPM_RC_ATTRIBUTES, 1), result.ResponseCode, "The session form must refuse a sensitiveDataOrigin-SET template that supplies data with TPM_RC_ATTRIBUTES.");
            }
        }
        finally
        {
    ...
    public async Task LoadWithATamperedUniqueIsRefusedWithIntegrity()
    {
        ...
        Assert.AreEqual(HmacKeyHarness.ParameterEncodedRc(TpmRcConstants.TPM_RC_INTEGRITY, 0), result.ResponseCode, "A tampered unique changes the Name, so the outer HMAC must refuse the blob with TPM_RC_INTEGRITY at inPrivate, parameter 1 of Table 20, before any binding recomputation.");
    }
    ...
    public async Task ImportOfABareDuplicateChecksTheUniqueBinding()
    {
        ...
        using(Tpm2bPrivate duplicate = BareSensitive(pool, seedSize: 32, SampleKey))
        {
            ...
            Assert.AreEqual(HmacKeyHarness.ParameterEncodedRc(TpmRcConstants.TPM_RC_BINDING, 2), refused.ResponseCode, "A public area whose unique does not re-derive from the presented sensitive area must be refused with TPM_RC_BINDING at duplicate, parameter 3 of Table 40.");
        }
    ...
    public async Task ImportOfABareRestrictedXorObjectBindsThroughTheHmacUnique()
    {
        ...
        using(Tpm2bPrivate duplicate = BareSensitive(pool, seedSize: 32, SampleKey))
        {
            ...
            Assert.AreEqual(HmacKeyHarness.ParameterEncodedRc(TpmRcConstants.TPM_RC_BINDING, 2), refused.ResponseCode, "A derivation parent's public area carrying the plain-hash unique must be refused with TPM_RC_BINDING at duplicate, parameter 3 of Table 40 — its arm is the HMAC.");
        }
    ...
    private async Task<(TpmResponseRegistry Registry, TpmDevice Tpm, TpmSimulator Simulator, uint ParentHandle)> SetUpAsync(string name)
    {
        ...
        TpmDevice tpm = TpmDevice.Create(simulator.SubmitAsync, BaseMemoryPool.Shared, TestEntropy.NewCounterStream());
        TpmResponseRegistry registry = HmacKeyHarness.CreateRegistry();
