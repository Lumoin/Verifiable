...
internal sealed class TpmInHouseSimulatorCreationDataTests
{
    ...
    /// <summary>
    /// A regression check: <c>Extensions/Seal</c>'s <see cref="Verifiable.Tpm.Extensions.Seal.TpmDeviceExtensions.extension(Verifiable.Tpm.TpmDevice).SealAsync"/> drops the creation
