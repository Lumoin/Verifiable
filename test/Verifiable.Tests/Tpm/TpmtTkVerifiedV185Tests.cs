...
internal sealed class TpmtTkVerifiedV185Tests
{
    ...
    /// Specification</see>, Part 2: Structures, clause 10.6.5, Tables 111-113).
    /// </summary>
    [TestMethod]
    ...
    /// (<see href="https://trustedcomputinggroup.org/resource/tpm-library-specification/">TPM 2.0 Library
    /// Specification</see>, Part 2: Structures, clause 10.6.5, Tables 111-112).
    /// </summary>
    [TestMethod]
    ...
    /// (<see href="https://trustedcomputinggroup.org/resource/tpm-library-specification/">TPM 2.0 Library
    /// Specification</see>, Part 2: Structures, clause 10.6.4, Table 111; Section 9.31, Table 77).
    /// </summary>
    [TestMethod]
