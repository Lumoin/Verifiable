...
internal sealed class TpmInHouseSimulatorEndorsementKeyTemplateTests
{
    ...
    /// all-zero template placeholder (proving the RSA storage-parent effect retained and exported it), and
    ...
    public async Task RsaEndorsementKeyTemplateMatchesTheStandardProfile()
    {
        ...
        try
        {
            ...
            //placeholder (TCG EK Credential Profile, Annex B.3.1) — proving BuildRsaStorageParentArtifacts
