...
internal sealed class TpmInHouseSimulatorNvCertifyTests
{
    ...
    /// <summary>
    /// Defines <see cref="NvIndexHandle"/> (via <see cref="DefineNvIndexAsync(Verifiable.Tpm.TpmDevice, Verifiable.Tpm.Infrastructure.TpmResponseRegistry, Lumoin.Base.BaseMemoryPool, Verifiable.Tpm.Spec.Attributes.TpmaNv)"/>) and then writes
        ...
        TpmAlgIdConstants nameAlg, ReadOnlyMemory<byte> message, BaseMemoryPool pool, CancellationToken cancellationToken)
    {
        (HashAlgorithmName algorithm, int digestSize) = nameAlg switch
        {
            ...
            TpmAlgIdConstants.TPM_ALG_ERROR => throw new NotSupportedException($"No Name-algorithm oracle is transcribed for '{nameAlg}'."),
            TpmAlgIdConstants.TPM_ALG_RSA => throw new NotSupportedException($"No Name-algorithm oracle is transcribed for '{nameAlg}'."),
            TpmAlgIdConstants.TPM_ALG_TDES => throw new NotSupportedException($"No Name-algorithm oracle is transcribed for '{nameAlg}'."),
            TpmAlgIdConstants.TPM_ALG_SHA => throw new NotSupportedException($"No Name-algorithm oracle is transcribed for '{nameAlg}'."),
            TpmAlgIdConstants.TPM_ALG_HMAC => throw new NotSupportedException($"No Name-algorithm oracle is transcribed for '{nameAlg}'."),
            TpmAlgIdConstants.TPM_ALG_AES => throw new NotSupportedException($"No Name-algorithm oracle is transcribed for '{nameAlg}'."),
            TpmAlgIdConstants.TPM_ALG_MGF1 => throw new NotSupportedException($"No Name-algorithm oracle is transcribed for '{nameAlg}'."),
            TpmAlgIdConstants.TPM_ALG_KEYEDHASH => throw new NotSupportedException($"No Name-algorithm oracle is transcribed for '{nameAlg}'."),
            TpmAlgIdConstants.TPM_ALG_XOR => throw new NotSupportedException($"No Name-algorithm oracle is transcribed for '{nameAlg}'."),
            TpmAlgIdConstants.TPM_ALG_SHA512 => throw new NotSupportedException($"No Name-algorithm oracle is transcribed for '{nameAlg}'."),
            TpmAlgIdConstants.TPM_ALG_SHA256_192 => throw new NotSupportedException($"No Name-algorithm oracle is transcribed for '{nameAlg}'."),
            TpmAlgIdConstants.TPM_ALG_NULL => throw new NotSupportedException($"No Name-algorithm oracle is transcribed for '{nameAlg}'."),
            TpmAlgIdConstants.TPM_ALG_SM3_256 => throw new NotSupportedException($"No Name-algorithm oracle is transcribed for '{nameAlg}'."),
            TpmAlgIdConstants.TPM_ALG_SM4 => throw new NotSupportedException($"No Name-algorithm oracle is transcribed for '{nameAlg}'."),
            TpmAlgIdConstants.TPM_ALG_RSASSA => throw new NotSupportedException($"No Name-algorithm oracle is transcribed for '{nameAlg}'."),
            TpmAlgIdConstants.TPM_ALG_RSAES => throw new NotSupportedException($"No Name-algorithm oracle is transcribed for '{nameAlg}'."),
            TpmAlgIdConstants.TPM_ALG_RSAPSS => throw new NotSupportedException($"No Name-algorithm oracle is transcribed for '{nameAlg}'."),
            TpmAlgIdConstants.TPM_ALG_OAEP => throw new NotSupportedException($"No Name-algorithm oracle is transcribed for '{nameAlg}'."),
            TpmAlgIdConstants.TPM_ALG_ECDSA => throw new NotSupportedException($"No Name-algorithm oracle is transcribed for '{nameAlg}'."),
            TpmAlgIdConstants.TPM_ALG_ECDH => throw new NotSupportedException($"No Name-algorithm oracle is transcribed for '{nameAlg}'."),
            TpmAlgIdConstants.TPM_ALG_ECDAA => throw new NotSupportedException($"No Name-algorithm oracle is transcribed for '{nameAlg}'."),
            TpmAlgIdConstants.TPM_ALG_SM2 => throw new NotSupportedException($"No Name-algorithm oracle is transcribed for '{nameAlg}'."),
            TpmAlgIdConstants.TPM_ALG_ECSCHNORR => throw new NotSupportedException($"No Name-algorithm oracle is transcribed for '{nameAlg}'."),
            TpmAlgIdConstants.TPM_ALG_ECMQV => throw new NotSupportedException($"No Name-algorithm oracle is transcribed for '{nameAlg}'."),
            TpmAlgIdConstants.TPM_ALG_HKDF => throw new NotSupportedException($"No Name-algorithm oracle is transcribed for '{nameAlg}'."),
            TpmAlgIdConstants.TPM_ALG_KDF1_SP800_56A => throw new NotSupportedException($"No Name-algorithm oracle is transcribed for '{nameAlg}'."),
            TpmAlgIdConstants.TPM_ALG_KDF2 => throw new NotSupportedException($"No Name-algorithm oracle is transcribed for '{nameAlg}'."),
            TpmAlgIdConstants.TPM_ALG_KDF1_SP800_108 => throw new NotSupportedException($"No Name-algorithm oracle is transcribed for '{nameAlg}'."),
            TpmAlgIdConstants.TPM_ALG_ECC => throw new NotSupportedException($"No Name-algorithm oracle is transcribed for '{nameAlg}'."),
            TpmAlgIdConstants.TPM_ALG_SYMCIPHER => throw new NotSupportedException($"No Name-algorithm oracle is transcribed for '{nameAlg}'."),
            TpmAlgIdConstants.TPM_ALG_CAMELLIA => throw new NotSupportedException($"No Name-algorithm oracle is transcribed for '{nameAlg}'."),
            TpmAlgIdConstants.TPM_ALG_SHA3_256 => throw new NotSupportedException($"No Name-algorithm oracle is transcribed for '{nameAlg}'."),
            TpmAlgIdConstants.TPM_ALG_SHA3_384 => throw new NotSupportedException($"No Name-algorithm oracle is transcribed for '{nameAlg}'."),
            TpmAlgIdConstants.TPM_ALG_SHA3_512 => throw new NotSupportedException($"No Name-algorithm oracle is transcribed for '{nameAlg}'."),
            TpmAlgIdConstants.TPM_ALG_SHAKE128 => throw new NotSupportedException($"No Name-algorithm oracle is transcribed for '{nameAlg}'."),
            TpmAlgIdConstants.TPM_ALG_SHAKE256 => throw new NotSupportedException($"No Name-algorithm oracle is transcribed for '{nameAlg}'."),
            TpmAlgIdConstants.TPM_ALG_SHAKE256_192 => throw new NotSupportedException($"No Name-algorithm oracle is transcribed for '{nameAlg}'."),
            TpmAlgIdConstants.TPM_ALG_SHAKE256_256 => throw new NotSupportedException($"No Name-algorithm oracle is transcribed for '{nameAlg}'."),
            TpmAlgIdConstants.TPM_ALG_SHAKE256_512 => throw new NotSupportedException($"No Name-algorithm oracle is transcribed for '{nameAlg}'."),
            TpmAlgIdConstants.TPM_ALG_CMAC => throw new NotSupportedException($"No Name-algorithm oracle is transcribed for '{nameAlg}'."),
            TpmAlgIdConstants.TPM_ALG_CTR => throw new NotSupportedException($"No Name-algorithm oracle is transcribed for '{nameAlg}'."),
            TpmAlgIdConstants.TPM_ALG_OFB => throw new NotSupportedException($"No Name-algorithm oracle is transcribed for '{nameAlg}'."),
            TpmAlgIdConstants.TPM_ALG_CBC => throw new NotSupportedException($"No Name-algorithm oracle is transcribed for '{nameAlg}'."),
            TpmAlgIdConstants.TPM_ALG_CFB => throw new NotSupportedException($"No Name-algorithm oracle is transcribed for '{nameAlg}'."),
            TpmAlgIdConstants.TPM_ALG_ECB => throw new NotSupportedException($"No Name-algorithm oracle is transcribed for '{nameAlg}'."),
            TpmAlgIdConstants.TPM_ALG_CCM => throw new NotSupportedException($"No Name-algorithm oracle is transcribed for '{nameAlg}'."),
            TpmAlgIdConstants.TPM_ALG_GCM => throw new NotSupportedException($"No Name-algorithm oracle is transcribed for '{nameAlg}'."),
            TpmAlgIdConstants.TPM_ALG_KW => throw new NotSupportedException($"No Name-algorithm oracle is transcribed for '{nameAlg}'."),
            TpmAlgIdConstants.TPM_ALG_KWP => throw new NotSupportedException($"No Name-algorithm oracle is transcribed for '{nameAlg}'."),
            TpmAlgIdConstants.TPM_ALG_EAX => throw new NotSupportedException($"No Name-algorithm oracle is transcribed for '{nameAlg}'."),
            TpmAlgIdConstants.TPM_ALG_EDDSA => throw new NotSupportedException($"No Name-algorithm oracle is transcribed for '{nameAlg}'."),
            TpmAlgIdConstants.TPM_ALG_EDDSA_PH => throw new NotSupportedException($"No Name-algorithm oracle is transcribed for '{nameAlg}'."),
            TpmAlgIdConstants.TPM_ALG_LMS => throw new NotSupportedException($"No Name-algorithm oracle is transcribed for '{nameAlg}'."),
            TpmAlgIdConstants.TPM_ALG_XMSS => throw new NotSupportedException($"No Name-algorithm oracle is transcribed for '{nameAlg}'."),
            TpmAlgIdConstants.TPM_ALG_KEYEDXOF => throw new NotSupportedException($"No Name-algorithm oracle is transcribed for '{nameAlg}'."),
            TpmAlgIdConstants.TPM_ALG_KMACXOF128 => throw new NotSupportedException($"No Name-algorithm oracle is transcribed for '{nameAlg}'."),
            TpmAlgIdConstants.TPM_ALG_KMACXOF256 => throw new NotSupportedException($"No Name-algorithm oracle is transcribed for '{nameAlg}'."),
            TpmAlgIdConstants.TPM_ALG_KMAC128 => throw new NotSupportedException($"No Name-algorithm oracle is transcribed for '{nameAlg}'."),
            TpmAlgIdConstants.TPM_ALG_KMAC256 => throw new NotSupportedException($"No Name-algorithm oracle is transcribed for '{nameAlg}'."),
            TpmAlgIdConstants.TPM_ALG_MLKEM => throw new NotSupportedException($"No Name-algorithm oracle is transcribed for '{nameAlg}'."),
            TpmAlgIdConstants.TPM_ALG_MLDSA => throw new NotSupportedException($"No Name-algorithm oracle is transcribed for '{nameAlg}'."),
            TpmAlgIdConstants.TPM_ALG_HASH_MLDSA => throw new NotSupportedException($"No Name-algorithm oracle is transcribed for '{nameAlg}'."),
