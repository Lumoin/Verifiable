...
internal sealed class TpmCreationDataCarrierTests
{
    ...
    /// Specification</see>, Part 2: Structures, clause 15.1, Table 261, printed page 219).
    /// </summary>
    [TestMethod]
    ...
    /// an empty selection
    /// (<see href="https://trustedcomputinggroup.org/resource/tpm-library-specification/">TPM 2.0 Library
    /// Specification</see>, Part 4: Supporting Routines' <c>FillInCreationData()</c>). <see cref="Tpm2bDigest.Parse"/>
    ...
    /// <c>objectName</c> then the <c>creationHash</c> (TPM 2.0 Library Part 2, clause 10.11.7, Table 149).
    /// </summary>
    ...
    /// (TPM 2.0 Library Part 2, clause 10.11.13, Table 155). Used to drive a malformation nested inside the
