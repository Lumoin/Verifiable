...
namespace Verifiable.Tests
{
    ...
    public class CryptoFunctionRegistryTests
    {
        ...
        {
            var keys = MicrosoftKeyMaterialCreator.CreateRsa2048Keys(ExactSizeMemoryPool<byte>.Shared);
            ...
            var signature = await privateKey(keys.PrivateKey.AsReadOnlySpan(), TestData, ExactSizeMemoryPool<byte>.Shared);
