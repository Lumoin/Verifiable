...
public sealed class SelectiveDisclosureTests
{
    ...
    public void ComputeMinimumDisclosureIncludesMandatoryAndRequested()
    {
        ...
        var (disclosures, unavailable) = Core.Disclosure.SelectiveDisclosure.ComputeMinimumDisclosure(lattice, requested);
    ...
    public void ComputeMaximumDisclosureReturnsAllMinusExclusions()
    {
        ...
        var result = Core.Disclosure.SelectiveDisclosure.ComputeMaximumDisclosure(lattice, exclusions);
    ...
    public void ComputeOptimalDisclosureSatisfiesWhenNoConflict()
    {
        ...
        var result = Core.Disclosure.SelectiveDisclosure.ComputeOptimalDisclosure(lattice, requested, exclusions);
    ...
    public void ComputeOptimalDisclosureReturnsUnavailableClaims()
    {
        ...
        var result = Core.Disclosure.SelectiveDisclosure.ComputeOptimalDisclosure(lattice, requested);
    ...
    public void ComputeOptimalDisclosureWithNullInputsReturnsOnlyMandatory()
    {
        ...
        var result = Core.Disclosure.SelectiveDisclosure.ComputeOptimalDisclosure(lattice);
    ...
    public void ValidateDisclosureReturnsTrueForValidSet()
    {
        ...
        var result = Core.Disclosure.SelectiveDisclosure.ValidateDisclosure(lattice, disclosures, requirements);
        ...
        var credentials = new List<(string Credential, IBoundedDisclosureLattice<string> Lattice)>
    {
        ...
        var result = Core.Disclosure.SelectiveDisclosure.SelectCredentials(credentials, requirements);
