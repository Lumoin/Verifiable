...
public sealed class DisclosureLatticeIntegrationTests
{
    ...
    public void EcdsaSd2023ScenarioWithMandatoryAndSelectiveClaims()
    {
        ...
        var result = Core.Disclosure.SelectiveDisclosure.ComputeOptimalDisclosure(lattice, verifierRequest);
        ...
        var allClaims = new HashSet<string>
    {
        ...
        var result = Core.Disclosure.SelectiveDisclosure.ComputeOptimalDisclosure(
            lattice,
            verifierRequest,
            userExclusions);
