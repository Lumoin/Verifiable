...
/// <summary>
/// Tests for <see cref="SdJwtPathExtraction"/>, which maps disclosures in an issued
/// SD-JWT token back to <see cref="CredentialPath"/> values.
/// </summary>
/// <remarks>
/// <para>
/// These tests verify the extraction (verification/presentation) direction per
/// <see href="https://datatracker.ietf.org/doc/rfc9901/">RFC 9901</see>. Given a
/// signed JWT payload containing <c>_sd</c> digest arrays and a set of disclosures,
/// <see cref="SdJwtPathExtraction.ExtractPaths"/> recomputes digests and matches them
