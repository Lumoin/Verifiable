...
internal class JwkThumbprintMalformedInputTests
{
    ...
    {
        _ = Assert.Throws<ArgumentNullException>(() => JwkThumbprintUtilities.ComputeRsaThumbprint(BaseMemoryPool.Shared, null!, "RSA", "validModulus"));
    }

    [TestMethod]
    public void ComputeRsaThumbprintNullKeyTypeThrowsArgumentNullException()
    {
        _ = Assert.Throws<ArgumentNullException>(() => JwkThumbprintUtilities.ComputeRsaThumbprint(BaseMemoryPool.Shared, "AQAB", null!, "validModulus"));
    }

    [TestMethod]
    public void ComputeRsaThumbprintNullModulusThrowsArgumentNullException()
    {
        _ = Assert.Throws<ArgumentNullException>(() => JwkThumbprintUtilities.ComputeRsaThumbprint(BaseMemoryPool.Shared, "AQAB", "RSA", null!));
    }

    [TestMethod]
    public void ComputeECThumbprintNullCurveThrowsArgumentNullException()
    {
        _ = Assert.Throws<ArgumentNullException>(() => JwkThumbprintUtilities.ComputeECThumbprint(BaseMemoryPool.Shared, null!, "EC", "validX", "validY"));
    }

    [TestMethod]
    public void ComputeECThumbprintNullKeyTypeThrowsArgumentNullException()
    {
        _ = Assert.Throws<ArgumentNullException>(() => JwkThumbprintUtilities.ComputeECThumbprint(BaseMemoryPool.Shared, "P-256", null!, "validX", "validY"));
    }

    [TestMethod]
    public void ComputeECThumbprintNullXCoordinateThrowsArgumentNullException()
    {
        _ = Assert.Throws<ArgumentNullException>(() => JwkThumbprintUtilities.ComputeECThumbprint(BaseMemoryPool.Shared, "P-256", "EC", null!, "validY"));
    }

    [TestMethod]
    public void ComputeECThumbprintNullYCoordinateThrowsArgumentNullException()
    {
        _ = Assert.Throws<ArgumentNullException>(() => JwkThumbprintUtilities.ComputeECThumbprint(BaseMemoryPool.Shared, "P-256", "EC", "validX", null!));
    }

    [TestMethod]
    public void ComputeEdDsaThumbprintNullCurveThrowsArgumentNullException()
    {
        _ = Assert.Throws<ArgumentNullException>(() => JwkThumbprintUtilities.ComputeEdDsaThumbprint(BaseMemoryPool.Shared, null!, "OKP", "validX"));
    }

    [TestMethod]
    public void ComputeEcdhThumbprintNullPublicKeyThrowsArgumentNullException()
    {
        _ = Assert.Throws<ArgumentNullException>(() => JwkThumbprintUtilities.ComputeEcdhThumbprint(BaseMemoryPool.Shared, "X25519", "OKP", null!));
    }

    [TestMethod]
    public void ComputeOctThumbprintNullKeyValueThrowsArgumentNullException()
    {
        _ = Assert.Throws<ArgumentNullException>(() => JwkThumbprintUtilities.ComputeOctThumbprint(BaseMemoryPool.Shared, null!, "oct"));
    }

    [TestMethod]
    public void ComputeMlDsaThumbprintNullAlgorithmThrowsArgumentNullException()
    {
        _ = Assert.Throws<ArgumentNullException>(() => JwkThumbprintUtilities.ComputeMlDsaThumbprint(BaseMemoryPool.Shared, null!, "MLDSA", "validX"));
    }

    [TestMethod]
    public void ComputeMlKemThumbprintNullAlgorithmThrowsArgumentNullException()
    {
        _ = Assert.Throws<ArgumentNullException>(() => JwkThumbprintUtilities.ComputeMlKemThumbprint(BaseMemoryPool.Shared, null!, "MLKEM", "validX"));
    }

    [TestMethod]
    public void ComputeSlhDsaThumbprintNullAlgorithmThrowsArgumentNullException()
    {
        _ = Assert.Throws<ArgumentNullException>(() => JwkThumbprintUtilities.ComputeSlhDsaThumbprint(BaseMemoryPool.Shared, null!, "SLHDSA", "validX"));
    }

    [TestMethod]
    public void ComputeGenericThumbprintNullParametersThrowsArgumentNullException()
    {
        _ = Assert.Throws<ArgumentNullException>(() => JwkThumbprintUtilities.ComputeGenericThumbprint(BaseMemoryPool.Shared, null!));
    }
    ...
    public void ComputeGenericThumbprintEmptyParametersThrowsArgumentException()
    {
        ...
        _ = Assert.Throws<ArgumentException>(() => JwkThumbprintUtilities.ComputeGenericThumbprint(BaseMemoryPool.Shared, emptyParams));
    }
