...
internal sealed class JwtChecksTests
{
    ...
    {
        var header = new JwtHeader { [JwkProperties.Alg] = WellKnownJwaValues.None };
    ...
    {
        var header = new JwtHeader { [JwkProperties.Alg] = WellKnownJwaValues.Es256 };
    ...
    {
        var header = new UnverifiedJwtHeader { [JwkProperties.Alg] = WellKnownJwaValues.None };
    ...
    {
        var header = new UnverifiedJwtHeader { [JwkProperties.Alg] = WellKnownJwaValues.Es256 };
    ...
    {
        var header = new JwtHeader { [JwkProperties.Kty] = WellKnownKeyTypeValues.Ec };
    ...
    {
        var header = new JwtHeader { [JwkProperties.Kty] = string.Empty };
    ...
    public void HasRequiredEcFieldsReturnsTrueWhenAllEcFieldsPresent()
    {
        var header = new JwtHeader
        {
            ...
            [JwkProperties.X] = "f83OJ3D2xF1Bg8vub9tLe1gHMzV76e8Tus9uPHvRVEU",
            [JwkProperties.Y] = "x_FEzRu9m36HLN_tue659LNpXW6pCyStikYjKIWI5a0"
        };
    ...
    {
        var header = new JwtHeader { [JwkProperties.Crv] = WellKnownCurveValues.P256 };
    ...
    {
        var header = new JwtHeader { [JwkProperties.Crv] = WellKnownCurveValues.Ed25519 };
    ...
    {
        var header = new JwtHeader { [JwkProperties.Kty] = WellKnownKeyTypeValues.Okp };
    ...
    {
        var header = new JwtHeader { [JwkProperties.Crv] = WellKnownCurveValues.X25519 };
    ...
    public void HasValidRsaFieldsReturnsTrueForRsa2048ModulusLength()
    {
        var header = new JwtHeader
        {
            ...
            [JwkProperties.N] = new string('A', 342)
        };
    ...
    public void HasValidRsaFieldsReturnsTrueForRsa4096ModulusLength()
    {
        ...
        {
            [JwkProperties.E] = "AQAB",
            [JwkProperties.N] = new string('A', 683)
        };
    ...
    {
        var header = new JwtHeader { [JwkProperties.N] = new string('A', 342) };
    ...
    public void HasValidRsaFieldsReturnsFalseWhenModulusLengthIsWrong()
    {
        ...
        {
            [JwkProperties.E] = "AQAB",
            [JwkProperties.N] = new string('A', 100)
        };
    ...
    public void TrustBoundaryIsStructuralAlgNoneProducesSameResultOnBothTypes()
    {
        ...
        var trusted = new JwtHeader { [JwkProperties.Alg] = alg };
        var untrusted = new UnverifiedJwtHeader { [JwkProperties.Alg] = alg };
    ...
    public void IsExpiredReturnsFalseWhenTokenNotYetExpired()
    {
        ...
        {
            [JwkProperties.Exp] = (long)(now.AddMinutes(5).ToUnixTimeSeconds())
        };
    ...
    public void IsExpiredReturnsTrueWhenTokenHasExpired()
    {
        ...
        var payload = new JwtPayload
        {
            [JwkProperties.Exp] = (long)(now.AddMinutes(-1).ToUnixTimeSeconds())
        };
    ...
    public void IsExpiredRespectClockSkewAllowance()
    {
        ...
        var payload = new JwtPayload
        {
            [JwkProperties.Exp] = (long)(now.AddSeconds(-30).ToUnixTimeSeconds())
        };
    ...
    public void IsNotYetValidReturnsTrueWhenNbfIsInFuture()
    {
        ...
        var payload = new JwtPayload
        {
            [JwkProperties.Nbf] = (long)(now.AddMinutes(5).ToUnixTimeSeconds())
        };
    ...
    public void IsNotYetValidReturnsFalseWhenNbfIsPast()
    {
        ...
        var payload = new JwtPayload
        {
            [JwkProperties.Nbf] = (long)(now.AddMinutes(-1).ToUnixTimeSeconds())
        };
    ...
    public void IsIssuedInFutureReturnsTrueWhenIatIsInFuture()
    {
        ...
        var payload = new JwtPayload
        {
            [JwkProperties.Iat] = (long)(now.AddMinutes(5).ToUnixTimeSeconds())
        };
    ...
    public void IsIssuedInFutureReturnsFalseWhenIatIsNow()
    {
        ...
        var payload = new JwtPayload
        {
            [JwkProperties.Iat] = (long)now.ToUnixTimeSeconds()
        };
    ...
    public void LifetimeExceedsReturnsTrueWhenExpMinusNbfExceedsMaximum()
    {
        ...
        var payload = new JwtPayload
        {
            [JwkProperties.Nbf] = (long)now.ToUnixTimeSeconds(),
            [JwkProperties.Exp] = (long)now.AddSeconds(120).ToUnixTimeSeconds()
        };
    ...
    public void LifetimeExceedsReturnsFalseWhenExpMinusNbfIsWithinMaximum()
    {
        ...
        {
            [JwkProperties.Nbf] = (long)now.ToUnixTimeSeconds(),
            [JwkProperties.Exp] = (long)now.AddSeconds(60).ToUnixTimeSeconds()
        };
    ...
    public void IsExpBeforeNbfReturnsTrueWhenExpIsBeforeNbf()
    {
        ...
        var payload = new JwtPayload
        {
            [JwkProperties.Nbf] = (long)now.AddSeconds(60).ToUnixTimeSeconds(),
            [JwkProperties.Exp] = (long)now.ToUnixTimeSeconds()
        };
    ...
    public void TrustBoundaryIsStructuralTimeChecksProduceSameResultOnBothPayloadTypes()
    {
        ...
        var trusted = new JwtPayload { [JwkProperties.Exp] = expSeconds };
        var untrusted = new UnverifiedJwtPayload { [JwkProperties.Exp] = expSeconds };
