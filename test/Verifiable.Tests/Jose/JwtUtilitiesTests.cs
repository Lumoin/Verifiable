    ...
    internal sealed class JwtUtilitiesTests
    {
        ...
        */
        ...
        public void RfcRsaTestVector()
        {
            ...
            using var thumbPrintBytes = JwkThumbprintUtilities.ComputeRsaThumbprint(BaseMemoryPool.Shared,e, kty, n);
        ...
        {
            //This is the Ed25519 test case from https://w3c-ccg.github.io/lds-jws2020.
            var kty = "OKP";
            var crv = "Ed25519";
            var x = "VCpo2LMLhn6iWku8MKvSLg2ZAoC-nlOyPVQaO3FxVeQ";
            using var thumbPrintBytes = JwkThumbprintUtilities.ComputeEdDsaThumbprint(BaseMemoryPool.Shared,crv, kty, x);
        ...
        public void Secp256k1EcLdsJws2020CryptoSuiteExample()
        {
            ...
            using var thumbPrintBytes = JwkThumbprintUtilities.ComputeECThumbprint(BaseMemoryPool.Shared,crv, kty, x, y);
        ...
        {
            //This is the RSA test case from https://w3c-ccg.github.io/lds-jws2020.
            var e = RsaExponent65537;
            var kty = "RSA";
        ...
        public void NistP256LdsJws2020CryptoSuiteExample()
        {
            ...
            var thumbprint = TestSetup.Base64UrlEncoder(thumbPrintBytes.Memory.Span);
            var tbprint2 = System.Buffers.Text.Base64Url.EncodeToString(JwkThumbprintUtilities.ComputeECThumbprint(BaseMemoryPool.Shared,crv, kty, x, y).Memory.Span);
