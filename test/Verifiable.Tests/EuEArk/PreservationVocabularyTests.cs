...
/// ETSI TS 119 512 V1.2.1</see> this library ships — <see cref="PreservationWellKnown"/> for the goals, storage
...
internal sealed class PreservationVocabularyTests
{
    ...
    /// ETSI TS 119 511 V1.2.1</see> 511-4.1.2, 511-4.1.4, 511-4.2-pgd.
    /// Proves <see href="https://www.etsi.org/deliver/etsi_ts/119500_119599/119512/01.02.01_60/ts_119512v010201p.pdf">
    /// ETSI TS 119 512 V1.2.1</see> 512-5.3.3.2.1-2, 512-5.4.6.1-1.
    /// </remarks>
    [TestMethod]
    ...
    /// <remarks>
    /// Proves <see href="https://www.etsi.org/deliver/etsi_ts/119500_119599/119511/01.02.01_60/ts_119511v010201p.pdf">
    /// ETSI TS 119 511 V1.2.1</see> PRP-8.1-04.
    /// Proves <see href="https://www.etsi.org/deliver/etsi_ts/119500_119599/119512/01.02.01_60/ts_119512v010201p.pdf">
    /// ETSI TS 119 512 V1.2.1</see> 512-5.4.8.1-1.
    /// </remarks>
    [TestMethod]
    ...
    /// <remarks>
    /// Proves <see href="https://www.etsi.org/deliver/etsi_ts/119500_119599/119511/01.02.01_60/ts_119511v010201p.pdf">
    /// ETSI TS 119 511 V1.2.1</see> PRP-8.1-11.
    /// Proves <see href="https://www.etsi.org/deliver/etsi_ts/119500_119599/119512/01.02.01_60/ts_119512v010201p.pdf">
    /// ETSI TS 119 512 V1.2.1</see> 512-5.3.4.1.1-2b, 512-5.3.4.2.1-1, 512-5.4.2.1-1, 512-5.4.9.1-1.
    /// </remarks>
    [TestMethod]
    ...
    /// <remarks>
    /// Proves <see href="https://www.etsi.org/deliver/etsi_ts/119500_119599/119512/01.02.01_60/ts_119512v010201p.pdf">
    /// ETSI TS 119 512 V1.2.1</see> 512-5.3.2.1.1-3b, 512-5.3.4.1.1-3, 512-5.3.5.1.1-2.
    /// </remarks>
    [TestMethod]
    ...
    /// <remarks>
    /// Proves <see href="https://www.etsi.org/deliver/etsi_ts/119500_119599/119511/01.02.01_60/ts_119511v010201p.pdf">
    /// ETSI TS 119 511 V1.2.1</see> 511-4.1.2, PRP-8.1-10, PRP-8.1-15.
    /// Proves <see href="https://www.etsi.org/deliver/etsi_ts/119500_119599/119512/01.02.01_60/ts_119512v010201p.pdf">
    /// ETSI TS 119 512 V1.2.1</see> 512-5.2-1, 512-5.3.4.1.1-gate, 512-5.3.5.1.1-gate, 512-5.4.3.1-3.
    /// </remarks>
    [TestMethod]
    ...
    /// <remarks>
    /// Proves <see href="https://www.etsi.org/deliver/etsi_ts/119500_119599/119511/01.02.01_60/ts_119511v010201p.pdf">
    /// ETSI TS 119 511 V1.2.1</see> 511-4.3.3.
    /// Proves <see href="https://www.etsi.org/deliver/etsi_ts/119500_119599/119512/01.02.01_60/ts_119512v010201p.pdf">
    /// ETSI TS 119 512 V1.2.1</see> 512-5.4.7.1-10, 512-F-identifiers, 512-F.1, 512-F.2, 512-F.3, 512-F.4.
    /// </remarks>
    [TestMethod]
    ...
    /// <remarks>
    /// Proves <see href="https://www.etsi.org/deliver/etsi_ts/119500_119599/119512/01.02.01_60/ts_119512v010201p.pdf">
    /// ETSI TS 119 512 V1.2.1</see> 512-5.3.3.2-errors.
    /// </remarks>
    [TestMethod]
    ...
    /// <remarks>
    /// Proves <see href="https://www.etsi.org/deliver/etsi_ts/119500_119599/119512/01.02.01_60/ts_119512v010201p.pdf">
    /// ETSI TS 119 512 V1.2.1</see> 512-5.3.2.2-errors, 512-5.3.4.2-errors, 512-5.3.5.2-errors, 512-5.3.7.2-errors,
    /// 512-5.3.8.2-errors, 512-5.3.9.2-errors.
    /// </remarks>
    ...
    /// <remarks>
    /// Proves <see href="https://www.etsi.org/deliver/etsi_ts/119500_119599/119512/01.02.01_60/ts_119512v010201p.pdf">
    /// ETSI TS 119 512 V1.2.1</see> 512-5.3.3.2-errors, 512-5.3.6.2-errors.
    /// </remarks>
    [TestMethod]
    ...
    /// <remarks>
    /// Proves <see href="https://www.etsi.org/deliver/etsi_ts/119500_119599/119511/01.02.01_60/ts_119511v010201p.pdf">
    /// ETSI TS 119 511 V1.2.1</see> OVR-7.16-02.
    /// Proves <see href="https://www.etsi.org/deliver/etsi_ts/119500_119599/119512/01.02.01_60/ts_119512v010201p.pdf">
    /// ETSI TS 119 512 V1.2.1</see> 512-5.4.4.1-3, 512-6.1-2, 512-6.1-3, 512-A.1, 512-A.2.
    /// </remarks>
    [TestMethod]
    ...
    /// <summary>
    /// The library's vocabulary and this library's claim-identifier registry state the same seventeen result
    /// codes and the same eight operation names — two independently written lists that have to agree, since one
    /// is what a message carries and the other is what a requirements matrix and a consumer's graph key on.
    /// </summary>
    [TestMethod]
    ...
    /// <summary>
    /// No enumeration this library declares reads as a success, an admission or a stated value when it has not
    /// been assigned: every zero is the "nothing has been decided" case.
    /// </summary>
    [TestMethod]
