...
/// </summary>
/// <remarks>
/// Every test here is either the round trip through the model, a check on the section order the encode seam
/// writes, a document written to break the parse, or a bound the limits state. Every digest is computed through
/// the registered digest seam, every carrier is rented from the house pool, and every instant is stated rather
...
internal sealed class MetsXmlBindingTests
{
    ...
    /// </summary>
    /// <remarks>
    /// Proves <see href="https://earkcsip.dilcis.eu/specification/implementation/structure/">E-ARK CSIP v2.2.0</see>
    /// csip-principle-1.5, csip-filesec-no-nesting.
    /// </remarks>
    [TestMethod]
    ...
    /// <remarks>
    /// Proves <see href="https://earkcsip.dilcis.eu/specification/implementation/structure/">E-ARK CSIP v2.2.0</see>
    /// csip-considerations-not-embedded.
    /// </remarks>
