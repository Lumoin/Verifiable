...
internal sealed class PreservationSeamTests
{
    ...
    /// ETSI TS 119 512 V1.2.1</see> 512-5.4.5.1-2, 512-5.4.5.1-3.
    /// </remarks>
    [TestMethod]
    ...
    /// <remarks>
    /// Proves <see href="https://www.etsi.org/deliver/etsi_ts/119500_119599/119512/01.02.01_60/ts_119512v010201p.pdf">
    /// ETSI TS 119 512 V1.2.1</see> 512-5.4.5.1-1.
    /// </remarks>
    [TestMethod]
    ...
    /// <remarks>
    /// Proves <see href="https://www.etsi.org/deliver/etsi_ts/119500_119599/119512/01.02.01_60/ts_119512v010201p.pdf">
    /// ETSI TS 119 512 V1.2.1</see> 512-5.3.6.1.1-3.
    /// </remarks>
    [TestMethod]
    ...
    /// ETSI TS 119 511 V1.2.1</see> PRP-8.1-09.
    /// Proves <see href="https://www.etsi.org/deliver/etsi_ts/119500_119599/119512/01.02.01_60/ts_119512v010201p.pdf">
    ...
    {
        PreservationProfile conformantForNoGoal = PreservationMessageSource.Profile();
        using PreservationProfile noGoal = new()
        {
            ProfileIdentifier = conformantForNoGoal.ProfileIdentifier,
            Operations = conformantForNoGoal.Operations,
            Policies = conformantForNoGoal.Policies,
            ValidityPeriod = conformantForNoGoal.ValidityPeriod,
            StorageModel = conformantForNoGoal.StorageModel,
            PreservationGoals = [],
            EvidenceFormats = conformantForNoGoal.EvidenceFormats,
            SchemeIdentifier = conformantForNoGoal.SchemeIdentifier,
            Specifications = conformantForNoGoal.Specifications,
            Descriptions = conformantForNoGoal.Descriptions,
            ExpectedEvidenceDuration = conformantForNoGoal.ExpectedEvidenceDuration,
            PreservationEvidenceRetentionPeriod = conformantForNoGoal.PreservationEvidenceRetentionPeriod,
            Extensions = conformantForNoGoal.Extensions
        };
        Assert.AreEqual(PreservationMessageStatus.RequiredValueAbsent, StateOfProfile(noGoal));

        PreservationProfile conformantForNoPolicy = PreservationMessageSource.Profile();
        using PreservationProfile noPolicy = new()
        {
            ProfileIdentifier = conformantForNoPolicy.ProfileIdentifier,
            Operations = conformantForNoPolicy.Operations,
            Policies = [],
            ValidityPeriod = conformantForNoPolicy.ValidityPeriod,
            StorageModel = conformantForNoPolicy.StorageModel,
            PreservationGoals = conformantForNoPolicy.PreservationGoals,
            EvidenceFormats = conformantForNoPolicy.EvidenceFormats,
            SchemeIdentifier = conformantForNoPolicy.SchemeIdentifier,
            Specifications = conformantForNoPolicy.Specifications,
            Descriptions = conformantForNoPolicy.Descriptions,
            ExpectedEvidenceDuration = conformantForNoPolicy.ExpectedEvidenceDuration,
            PreservationEvidenceRetentionPeriod = conformantForNoPolicy.PreservationEvidenceRetentionPeriod,
            Extensions = conformantForNoPolicy.Extensions
        };
        Assert.AreEqual(PreservationMessageStatus.PolicyCountNotStated, StateOfProfile(noPolicy));

        PreservationProfile conformantForThreePolicies = PreservationMessageSource.Profile();
        using PreservationProfile threePolicies = new()
        {
            ProfileIdentifier = conformantForThreePolicies.ProfileIdentifier,
            Operations = conformantForThreePolicies.Operations,
            Policies =
            [
            ...
            ValidityPeriod = conformantForThreePolicies.ValidityPeriod,
            StorageModel = conformantForThreePolicies.StorageModel,
            PreservationGoals = conformantForThreePolicies.PreservationGoals,
            EvidenceFormats = conformantForThreePolicies.EvidenceFormats,
            SchemeIdentifier = conformantForThreePolicies.SchemeIdentifier,
            Specifications = conformantForThreePolicies.Specifications,
            Descriptions = conformantForThreePolicies.Descriptions,
            ExpectedEvidenceDuration = conformantForThreePolicies.ExpectedEvidenceDuration,
            PreservationEvidenceRetentionPeriod = conformantForThreePolicies.PreservationEvidenceRetentionPeriod,
            Extensions = conformantForThreePolicies.Extensions
        };
    ...
    public void EachNumericBoundRefusesWhatLiesBeyondIt()
    {
        ...
        PreservationObject objectWithoutRelated = PreservationMessageSource.Object("a", BaseMemoryPool.Shared);
        using PreservePreservationObjectRequest tooManyReferences = new()
        {
            ...
            [
                ...
                {
                    Content = objectWithoutRelated.Content,
                    ContentForm = objectWithoutRelated.ContentForm,
                    FormatId = objectWithoutRelated.FormatId,
                    MimeType = objectWithoutRelated.MimeType,
                    PronomId = objectWithoutRelated.PronomId,
                    Id = objectWithoutRelated.Id,
                    RelatedObjects = ["a", "b"]
                }
            ]
        };
        ...
        PreservationProfile conformantProfileForGoals = PreservationMessageSource.Profile();
        using RetrieveInfoResponse tooManyGoals = new()
        {
            ...
            [
                ...
                {
                    ProfileIdentifier = conformantProfileForGoals.ProfileIdentifier,
                    Operations = conformantProfileForGoals.Operations,
                    Policies = conformantProfileForGoals.Policies,
                    ValidityPeriod = conformantProfileForGoals.ValidityPeriod,
                    StorageModel = conformantProfileForGoals.StorageModel,
                    PreservationGoals = ["goal-1", "goal-2"],
                    EvidenceFormats = conformantProfileForGoals.EvidenceFormats,
                    SchemeIdentifier = conformantProfileForGoals.SchemeIdentifier,
                    Specifications = conformantProfileForGoals.Specifications,
                    Descriptions = conformantProfileForGoals.Descriptions,
                    ExpectedEvidenceDuration = conformantProfileForGoals.ExpectedEvidenceDuration,
                    PreservationEvidenceRetentionPeriod = conformantProfileForGoals.PreservationEvidenceRetentionPeriod,
                    Extensions = conformantProfileForGoals.Extensions
                }
            ]
        };
        Assert.AreEqual(
    ...
    public void AContextDefaultsToTheConformantBounds()
    {
        ...
        PreservationOperationContext<SearchRequest> narrower = new()
        {
            Request = context.Request,
            Limits = new PreservationMessageLimits { MaximumFilterLength = 2 }
        };
    ...
    /// <remarks>
    /// Proves <see href="https://www.etsi.org/deliver/etsi_ts/119500_119599/119512/01.02.01_60/ts_119512v010201p.pdf">
    /// ETSI TS 119 512 V1.2.1</see> 512-5.3.1.1.1-2b, 512-5.3.1.2.1-3.
    /// </remarks>
    [TestMethod]
    ...
    /// <remarks>
    /// Proves <see href="https://www.etsi.org/deliver/etsi_ts/119500_119599/119512/01.02.01_60/ts_119512v010201p.pdf">
    /// ETSI TS 119 512 V1.2.1</see> 512-5.4.4.1-2, 512-binding-choice.
    /// </remarks>
    [TestMethod]
