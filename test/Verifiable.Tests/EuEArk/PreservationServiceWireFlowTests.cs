...
/// ETSI TS 119 512 V1.2.1</see>: a preservation service, a Time-Stamping Authority and an OCSP
    ...
    public async Task PreserveDiscoverRetrieveRenewValidateAndTraceAcrossThreeKestrelHosts()
    {
        ...
        EArkValidationContext renewedContext = verifier.ValidationContext() with
        {
            ...
            [
                ...
                {
                    Kind = verifier.Artifact.Kind,
                    EntryName = verifier.Artifact.EntryName,
                    RepresentationLabel = verifier.Artifact.RepresentationLabel,
                    CoveredEntryNames = verifier.Artifact.CoveredEntryNames,
                    Evidence = verifier.Artifact.Evidence,
                    SelfDescription = verifier.Artifact.SelfDescription,
                    SelfDescriptionCarrier = verifier.Artifact.SelfDescriptionCarrier,
                    SelfDescriptionIsProtected = renewedRecord.ArchiveTimeStampSequence.Chains.Count > 1
                }
            ]
        };
