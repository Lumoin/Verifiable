...
/// carries in base 64 are asserted to be the same octets, because the whole point is one design rather than
...
internal sealed class EArkEvidenceSelfDescriptionTests
{
    ...
    /// design, three carriers — exactly the point of carrying one canonical encoding three ways.
    /// </summary>
    /// <remarks>
    /// Proves <see href="https://www.etsi.org/deliver/etsi_ts/119500_119599/119511/01.02.01_60/ts_119511v010201p.pdf">
    /// ETSI TS 119 511 V1.2.1</see> OVR-6.5-09.
    /// </remarks>
    [TestMethod]
