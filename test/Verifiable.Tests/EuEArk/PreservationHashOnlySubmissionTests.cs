...
internal sealed class PreservationHashOnlySubmissionTests
{
    ...
    /// ETSI TS 119 511 V1.2.1</see> OVR-9.3-05.
    /// </remarks>
    [TestMethod]
    ...
    /// <remarks>
    /// Proves <see href="https://www.etsi.org/deliver/etsi_ts/119500_119599/119511/01.02.01_60/ts_119511v010201p.pdf">
    /// ETSI TS 119 511 V1.2.1</see> OVR-9.3-06.
    /// </remarks>
    [TestMethod]
    public void AnInputFormatThatNamesNoComputableHashFunctionIsNotAnAcceptedOne()
    {
        PreservationProfile baseProfile = PreservationCapabilitySource.Profile();
        using PreservationProfile profile = new()
        {
            ProfileIdentifier = baseProfile.ProfileIdentifier,
            Operations =
            [
            ...
            Policies = baseProfile.Policies,
            ValidityPeriod = baseProfile.ValidityPeriod,
            StorageModel = baseProfile.StorageModel,
            PreservationGoals = baseProfile.PreservationGoals,
            EvidenceFormats = baseProfile.EvidenceFormats,
            SchemeIdentifier = baseProfile.SchemeIdentifier,
            Specifications = baseProfile.Specifications,
            Descriptions = baseProfile.Descriptions,
            ExpectedEvidenceDuration = baseProfile.ExpectedEvidenceDuration,
            PreservationEvidenceRetentionPeriod = baseProfile.PreservationEvidenceRetentionPeriod,
            Extensions = baseProfile.Extensions
        };
    ...
    /// <remarks>
    /// Proves <see href="https://www.etsi.org/deliver/etsi_ts/119500_119599/119511/01.02.01_60/ts_119511v010201p.pdf">
    /// ETSI TS 119 511 V1.2.1</see> 511-4.2-pgd, 511-4.2-hash-only, OVR-9.3-07.
    /// </remarks>
    [TestMethod]
    ...
    /// <summary>
    /// Both entry points refuse a null argument, and every enumeration this library declares puts its zero on a
    /// value that means nothing was computed.
    /// </summary>
    [TestMethod]
