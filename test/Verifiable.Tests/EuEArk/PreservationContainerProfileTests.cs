...
internal sealed class PreservationContainerProfileTests
{
    ...
    /// ETSI TS 119 512 V1.2.1</see> 512-A.3.1.
    /// </remarks>
    [TestMethod]
    ...
    /// ETSI TS 119 511 V1.2.1</see> OVR-7.16-01, and
    /// <see href="https://www.etsi.org/deliver/etsi_ts/119500_119599/119512/01.02.01_60/ts_119512v010201p.pdf">
    /// ETSI TS 119 512 V1.2.1</see> 512-6.2-1, 512-A.3.1.
    /// </remarks>
    [TestMethod]
    ...
    /// <remarks>
    /// Proves <see href="https://www.etsi.org/deliver/etsi_ts/119500_119599/119512/01.02.01_60/ts_119512v010201p.pdf">
    /// ETSI TS 119 512 V1.2.1</see> 512-A.3.1-tightening.
    /// </remarks>
    [TestMethod]
    ...
    public async Task AReferenceThatDoesNotNameAnEvidenceRecordFileIsRefused()
    {
        ...
        try
        {
            ...
            AsicManifest namesADataFile = new()
            {
                SignatureReference = parsed.SignatureReference with { Uri = "data-1.txt" },
                DataObjectReferences = parsed.DataObjectReferences,
            ...
            AsicManifest namesAMissingRecord = new()
            {
            ...
            AsicManifest namesNothingResolvable = new()
            {
            ...
            AsicManifest referencesNoDataObject = new()
            {
    ...
    /// <remarks>
    /// Proves <see href="https://www.etsi.org/deliver/etsi_ts/119500_119599/119512/01.02.01_60/ts_119512v010201p.pdf">
    /// ETSI TS 119 512 V1.2.1</see> 512-5.5-criticality.
    /// </remarks>
    [TestMethod]
    public async Task ACriticalExtensionThePolicyDoesNotRecogniseStopsTheProfile()
    {
        ...
        try
        {
            AsicManifest parsedManifest = manifests[0].Manifest!;
            AsicManifest extended = new()
            {
                SignatureReference = parsedManifest.SignatureReference,
                DataObjectReferences = parsedManifest.DataObjectReferences,
                Extensions = [encoded.Extension!]
            };
    ...
    /// <remarks>
    /// Proves <see href="https://www.etsi.org/deliver/etsi_ts/119500_119599/119512/01.02.01_60/ts_119512v010201p.pdf">
    /// ETSI TS 119 512 V1.2.1</see> 512-6.2-3.
    /// </remarks>
    [TestMethod]
