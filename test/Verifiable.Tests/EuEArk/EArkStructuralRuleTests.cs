...
internal sealed class EArkStructuralRuleTests
{
    ...
    /// </summary>
    /// <remarks>
    /// Proves <see href="https://earkcsip.dilcis.eu/specification/implementation/structure/">E-ARK CSIP
    /// v2.2.0</see> CSIPSTR5, CSIPSTR6, CSIPSTR7, CSIPSTR8, CSIPSTR9, CSIPSTR15, CSIPSTR16, csip-principle-3.2,
    /// csip-principle-3.3. Proves <see href="https://citspremis.dilcis.eu/">CS Preservation Metadata v1.0.1</see>
    /// premis-5.2-placement.
    /// </remarks>
    ...
    public async Task TheMetadataFolderRowsBindOnlyWhenTheMetadataExists()
    {
        ...
        static MetsDocument ManifestWithoutMetadataSections()
        {
            ...
            MetsAdministrativeMetadata conformantAdministrativeMetadata = conformant.AdministrativeMetadata!;
            ...
            return new MetsDocument
            {
                ...
                AdministrativeMetadata = new MetsAdministrativeMetadata
                {
                    ...
                    RightsSections = conformantAdministrativeMetadata.RightsSections
                },
    ...
    /// <remarks>
    /// Proves <see href="https://earkcsip.dilcis.eu/specification/implementation/structure/">E-ARK CSIP
    /// v2.2.0</see> CSIPSTR11, CSIPSTR13.
    /// </remarks>
    /// <returns>A task that completes when the package has been validated.</returns>
    [TestMethod]
    ...
    /// </summary>
    /// <remarks>
    /// Proves <see href="https://earkaip.dilcis.eu/">E-ARK AIP v2.2.0</see> AIP27.
    /// </remarks>
    /// <returns>A task that completes when the package has been validated.</returns>
    [TestMethod]
    ...
    /// recommendation then reports as a deviation rather than as met. Proves
    /// <see href="https://earkcsip.dilcis.eu/specification/implementation/structure/">E-ARK CSIP v2.2.0</see>
    /// CSIPSTR2.
    /// </remarks>
    [TestMethod]
