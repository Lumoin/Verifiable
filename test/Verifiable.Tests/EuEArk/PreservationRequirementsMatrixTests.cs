...
internal sealed class PreservationRequirementsMatrixTests
{
    ...
    [
        ...
        ("OVR-9.2-02", "[CONDITIONAL] If used, time-stamp tokens should conform to the ETSI EN 319 422 time-stamping protocol and token profile.",
            RequirementCoverageStatus.OutOfScope, "The EN 319 422 text is not cached in this repository and no profile-conformance check against it exists, so conformance of the shipped RFC 3161 client is UNVERIFIED rather than claimed. This is owner flag 1 of the wave contract: fetching the text and verifying the profile is a cheap follow-up stage on the owner's word."),
