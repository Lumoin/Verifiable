...
/// <summary>
/// Conformance tests for the two wire-name vocabularies this library ships — <see cref="MetsWellKnown"/> for
/// the METS profile of <see href="https://earkcsip.dilcis.eu/profile/E-ARK-CSIP.xml">E-ARK CSIP v2.2.0</see>
/// and <see cref="PremisWellKnown"/> for <see href="https://citspremis.dilcis.eu/">CS Preservation Metadata
...
internal sealed class EArkMetadataVocabularyTests
{
    ...
    /// </summary>
    /// <remarks>
    /// Proves <see href="https://earkcsip.dilcis.eu/profile/E-ARK-CSIP.xml">E-ARK CSIP v2.2.0</see> CSIP90.
    /// </remarks>
    [TestMethod]
    ...
    /// <remarks>
    /// Proves <see href="https://earkcsip.dilcis.eu/profile/E-ARK-CSIP.xml">E-ARK CSIP v2.2.0</see> CSIP114,
    /// CSIP107, csip-filesec-representation-group, csip-structmap-div-label-folder.
    /// </remarks>
    [TestMethod]
    ...
    /// <remarks>
    /// Proves <see href="https://earkcsip.dilcis.eu/specification/implementation/structure/">E-ARK CSIP v2.2.0
    /// clause 5.1</see> csip-5.1-ncname.
    /// </remarks>
    [TestMethod]
    ...
    /// </summary>
    /// <remarks>
    /// Proves <see href="https://earkcsip.dilcis.eu/profile/E-ARK-CSIP.xml">E-ARK CSIP v2.2.0</see>
    /// csip-mets-root-namespaces.
    /// </remarks>
    [TestMethod]
    ...
    /// the unset discriminator occupies zero is checked beside every other status this library declares, in
    /// <c>EArkFixityTests</c>.
    /// </summary>
    [TestMethod]
