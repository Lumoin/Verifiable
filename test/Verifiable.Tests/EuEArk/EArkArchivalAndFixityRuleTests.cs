...
internal sealed class EArkArchivalAndFixityRuleTests
{
    ...
    /// </summary>
    /// <remarks>
    /// Proves <see href="https://earkaip.dilcis.eu/">
    /// E-ARK AIP v2.2.0</see> AIPM5, AIPM7.
    /// Proves <see href="https://earkcsip.dilcis.eu/profile/E-ARK-CSIP.xml">
    /// E-ARK CSIP v2.2.0</see> CSIP31, CSIP33, CSIP36, CSIP37, CSIP38, CSIP40, CSIP41, CSIP42.
    /// </remarks>
    ...
    /// </summary>
    /// <remarks>
    /// Proves <see href="https://citspremis.dilcis.eu/">
    /// CS Preservation Metadata v1.0.1</see> premis-5.1.1-table1.
    /// Proves <see href="https://earkaip.dilcis.eu/">
    /// E-ARK AIP v2.2.0</see> AIPM6.
    /// Proves <see href="https://earkcsip.dilcis.eu/profile/E-ARK-CSIP.xml">
    /// E-ARK CSIP v2.2.0</see> CSIP39.
    /// </remarks>
    /// <returns>A task that completes when the manifest has been validated.</returns>
    [TestMethod]
    ...
    /// <remarks>
    /// Proves <see href="https://earkaip.dilcis.eu/">
    /// E-ARK AIP v2.2.0</see> AIPM5.
    /// Proves <see href="https://earkcsip.dilcis.eu/profile/E-ARK-CSIP.xml">
    /// E-ARK CSIP v2.2.0</see> CSIP35.
    /// </remarks>
    /// <returns>A task that completes when the manifest has been validated.</returns>
    [TestMethod]
    public async Task AManifestWithoutProvenanceMetadataFailsTheMandatoryPointerRow()
    {
        ...
        MetsAdministrativeMetadata administrativeMetadata = conformant.AdministrativeMetadata!;
        using MetsDocument manifest = new()
        {
            ...
            AdministrativeMetadata = new()
            {
                ...
                RightsSections = administrativeMetadata.RightsSections,
            },
    ...
    /// <remarks>
    /// Proves <see href="https://citspremis.dilcis.eu/">
    /// CS Preservation Metadata v1.0.1</see> PREMIS-EVENT-ID, premis-2.2-agent-recording.
    /// Proves <see href="https://earkaip.dilcis.eu/">
    /// E-ARK AIP v2.2.0</see> AIP12, AIP13, AIP15, AIP17.
    /// </remarks>
    ...
    /// <remarks>
    /// Proves <see href="https://citspremis.dilcis.eu/">
    /// CS Preservation Metadata v1.0.1</see> PM89, PREMIS-EVENT-AGENT.
    /// Proves <see href="https://earkaip.dilcis.eu/">
    /// E-ARK AIP v2.2.0</see> AIP18.
    /// </remarks>
    /// <returns>A task that completes when the document has been validated.</returns>
    [TestMethod]
    ...
    /// <remarks>
    /// Proves <see href="https://citspremis.dilcis.eu/">
    /// CS Preservation Metadata v1.0.1</see> PM87, PREMIS-AGENT.
    /// Proves <see href="https://earkaip.dilcis.eu/">
    /// E-ARK AIP v2.2.0</see> AIP16.
    /// </remarks>
    /// <returns>A task that completes when the document has been validated.</returns>
    [TestMethod]
    ...
    {
        PremisDocument conformant = EArkValidationSource.ConformantPreservationMetadata();
        PremisEvent firstEvent = conformant.Events[0];
        using PremisDocument document = new()
        {
            Version = conformant.Version,
            Objects = conformant.Objects,
            ...
            [
                new()
                {
                    Identifiers = firstEvent.Identifiers,
                    Type = firstEvent.Type,
                    EventDateTime = firstEvent.EventDateTime,
                    Outcome = firstEvent.Outcome,
                    LinkingAgentIdentifiers = [],
                    LinkingObjectIdentifiers = firstEvent.LinkingObjectIdentifiers,
                }
            ],
    ...
    /// <remarks>
    /// Proves <see href="https://citspremis.dilcis.eu/">
    /// CS Preservation Metadata v1.0.1</see> PREMIS-IP-INCLUDED.
    /// Proves <see href="https://earkaip.dilcis.eu/">
    /// E-ARK AIP v2.2.0</see> AIP-PARENT-CHAIN-LISTED.
    /// </remarks>
    /// <returns>A task that completes when the manifest has been validated.</returns>
    [TestMethod]
    ...
    public async Task APackagePointerNamingNoTargetFailsTheParentChainRule()
    {
        ...
        MetsDivision fourthDivision = root.Divisions[4];
        using MetsDocument manifest = new()
        {
            ObjectIdentifier = conformant.ObjectIdentifier,
            ContentCategory = conformant.ContentCategory,
                ...
                conformant.StructuralMaps[0] with
                {
                    RootDivision = new()
                    {
                        ...
                        [
                            ...
                            new()
                            {
                                Id = fourthDivision.Id,
                                Label = fourthDivision.Label,
                                AdministrativeMetadataIds = fourthDivision.AdministrativeMetadataIds,
                                DescriptiveMetadataIds = fourthDivision.DescriptiveMetadataIds,
                                FilePointers = fourthDivision.FilePointers,
                                Divisions = fourthDivision.Divisions,
                                MetsPointers =
                                [
    ...
    /// <remarks>
    /// Proves <see href="https://earkcsip.dilcis.eu/profile/E-ARK-CSIP.xml">
    /// E-ARK CSIP v2.2.0</see> CSIP29, CSIP43, CSIP56, csip-filesec-checksums-blanket.
    /// </remarks>
    /// <returns>A task that completes when the package has been validated.</returns>
    [TestMethod]
    ...
    /// <remarks>
    /// Proves <see href="https://citspremis.dilcis.eu/">
    /// CS Preservation Metadata v1.0.1</see> premis-4.1.7-references.
    /// Proves <see href="https://earkcsip.dilcis.eu/profile/E-ARK-CSIP.xml">
    /// E-ARK CSIP v2.2.0</see> CSIP24, CSIP79, csip-5.1-reference-format, csip-5.1-references.
    /// </remarks>
    /// <returns>A task that completes when both packages have been validated.</returns>
    [TestMethod]
    ...
    public async Task AnIdentifierThatIsNotALegalNameFailsTheIdentifierRule()
    {
        ...
        MetsFileSection fileSection = conformant.FileSection!;
        using MetsDocument manifest = new()
        {
            ObjectIdentifier = conformant.ObjectIdentifier,
            ContentCategory = conformant.ContentCategory,
            ...
            {
                Id = "1-file-section",
                FileGroups = fileSection.FileGroups,
            },
            StructuralMaps = conformant.StructuralMaps,
        };
        ...
        string? alsoStatingChecksum = null)
    {
        ...
        MetsAdministrativeMetadata administrativeMetadata = conformant.AdministrativeMetadata!;
        MetsAdministrativeMetadataSection provenanceSection = administrativeMetadata.DigitalProvenanceSections[0];
        MetsFileSection fileSection = conformant.FileSection!;
        ...
        return new()
        {
            ...
            AdministrativeMetadata = new()
            {
                ...
                [
                    new()
                    {
                        Id = provenanceSection.Id,
                        Status = provenanceSection.Status,
                        Reference = null,
                    }
                ],
                RightsSections = [],
            ...
            {
                Id = fileSection.Id,
                FileGroups = [fileSection.FileGroups[2]],
            },
            StructuralMaps = conformant.StructuralMaps,
        };
    }
