...
internal sealed class PreservationProfileConformanceTests
{
    ...
    /// ETSI TS 119 511 V1.2.1</see> 511-4.3.2, 511-4.3.2-identifiers.
    /// </remarks>
    [TestMethod]
    ...
    /// <remarks>
    /// Proves <see href="https://www.etsi.org/deliver/etsi_ts/119500_119599/119511/01.02.01_60/ts_119511v010201p.pdf">
    /// ETSI TS 119 511 V1.2.1</see> OVR-6.4-03.
    /// </remarks>
    [TestMethod]
    ...
    /// <remarks>
    /// Proves <see href="https://www.etsi.org/deliver/etsi_ts/119500_119599/119511/01.02.01_60/ts_119511v010201p.pdf">
    /// ETSI TS 119 511 V1.2.1</see> OVR-6.4-06.
    /// </remarks>
    [TestMethod]
    ...
    /// <remarks>
    /// Proves <see href="https://www.etsi.org/deliver/etsi_ts/119500_119599/119511/01.02.01_60/ts_119511v010201p.pdf">
    /// ETSI TS 119 511 V1.2.1</see> 511-4.3.3, 511-4.3.4, OVR-6.4-04.
    /// </remarks>
    [TestMethod]
    ...
    public void EveryObligationTakenAwayMakesTheProfileNonConformant()
    {
        ...
        PreservationProfile conformantForIdentifier = PreservationCapabilitySource.Profile();
        using(PreservationProfile withoutIdentifier = new()
        {
            ProfileIdentifier = string.Empty,
            Operations = conformantForIdentifier.Operations,
            Policies = conformantForIdentifier.Policies,
            ValidityPeriod = conformantForIdentifier.ValidityPeriod,
            StorageModel = conformantForIdentifier.StorageModel,
            PreservationGoals = conformantForIdentifier.PreservationGoals,
            EvidenceFormats = conformantForIdentifier.EvidenceFormats,
            SchemeIdentifier = conformantForIdentifier.SchemeIdentifier,
            Specifications = conformantForIdentifier.Specifications,
            Descriptions = conformantForIdentifier.Descriptions,
            ExpectedEvidenceDuration = conformantForIdentifier.ExpectedEvidenceDuration,
            PreservationEvidenceRetentionPeriod = conformantForIdentifier.PreservationEvidenceRetentionPeriod,
            Extensions = conformantForIdentifier.Extensions
        })
        {
        ...
        //The operations.
        PreservationProfile conformantForOperations = PreservationCapabilitySource.Profile();
        using(PreservationProfile withoutOperations = new()
        {
            ProfileIdentifier = conformantForOperations.ProfileIdentifier,
            Operations = [],
            Policies = conformantForOperations.Policies,
            ValidityPeriod = conformantForOperations.ValidityPeriod,
            StorageModel = conformantForOperations.StorageModel,
            PreservationGoals = conformantForOperations.PreservationGoals,
            EvidenceFormats = conformantForOperations.EvidenceFormats,
            SchemeIdentifier = conformantForOperations.SchemeIdentifier,
            Specifications = conformantForOperations.Specifications,
            Descriptions = conformantForOperations.Descriptions,
            ExpectedEvidenceDuration = conformantForOperations.ExpectedEvidenceDuration,
            PreservationEvidenceRetentionPeriod = conformantForOperations.PreservationEvidenceRetentionPeriod,
            Extensions = conformantForOperations.Extensions
        })
        {
        ...
        PreservationProfile conformantForFormats = PreservationCapabilitySource.Profile();
        using(PreservationProfile withoutFormats = new()
        {
            ProfileIdentifier = conformantForFormats.ProfileIdentifier,
            Operations = conformantForFormats.Operations,
            Policies = conformantForFormats.Policies,
            ValidityPeriod = conformantForFormats.ValidityPeriod,
            StorageModel = conformantForFormats.StorageModel,
            PreservationGoals = conformantForFormats.PreservationGoals,
            EvidenceFormats = [],
            SchemeIdentifier = conformantForFormats.SchemeIdentifier,
            Specifications = conformantForFormats.Specifications,
            Descriptions = conformantForFormats.Descriptions,
            ExpectedEvidenceDuration = conformantForFormats.ExpectedEvidenceDuration,
            PreservationEvidenceRetentionPeriod = conformantForFormats.PreservationEvidenceRetentionPeriod,
            Extensions = conformantForFormats.Extensions
        })
        {
    ...
    /// <remarks>
    /// Proves <see href="https://www.etsi.org/deliver/etsi_ts/119500_119599/119512/01.02.01_60/ts_119512v010201p.pdf">
    /// ETSI TS 119 512 V1.2.1</see> 512-5.4.7.1-5, 512-5.4.7.1-9.
    /// </remarks>
    [TestMethod]
    public void AValueTheVocabularyDoesNotNameIsUnusable()
    {
        ...
        PreservationProfile conformantForBadOperation = PreservationCapabilitySource.Profile();
        using(PreservationProfile badOperation = new()
        {
            ProfileIdentifier = conformantForBadOperation.ProfileIdentifier,
            Operations = [new PreservationOperationDescriptor { Name = "PreserveEverything" }],
            Policies = conformantForBadOperation.Policies,
            ValidityPeriod = conformantForBadOperation.ValidityPeriod,
            StorageModel = conformantForBadOperation.StorageModel,
            PreservationGoals = conformantForBadOperation.PreservationGoals,
            EvidenceFormats = conformantForBadOperation.EvidenceFormats,
            SchemeIdentifier = conformantForBadOperation.SchemeIdentifier,
            Specifications = conformantForBadOperation.Specifications,
            Descriptions = conformantForBadOperation.Descriptions,
            ExpectedEvidenceDuration = conformantForBadOperation.ExpectedEvidenceDuration,
            PreservationEvidenceRetentionPeriod = conformantForBadOperation.PreservationEvidenceRetentionPeriod,
            Extensions = conformantForBadOperation.Extensions
        })
        {
    ...
    /// <remarks>
    /// Proves <see href="https://www.etsi.org/deliver/etsi_ts/119500_119599/119512/01.02.01_60/ts_119512v010201p.pdf">
    /// ETSI TS 119 512 V1.2.1</see> 512-5.4.7.1-4.
    /// </remarks>
    [TestMethod]
    ...
    /// <para>
    /// Proves <see href="https://www.etsi.org/deliver/etsi_ts/119500_119599/119511/01.02.01_60/ts_119511v010201p.pdf">
    /// ETSI TS 119 511 V1.2.1</see> 511-4.3.5.
    /// </para>
    /// <para>
    /// Proves <see href="https://www.etsi.org/deliver/etsi_ts/119500_119599/119512/01.02.01_60/ts_119512v010201p.pdf">
    /// ETSI TS 119 512 V1.2.1</see> 512-5.4.7.1-3.
    /// </para>
    /// </remarks>
    [TestMethod]
    ...
    /// <para>
    /// Proves <see href="https://www.etsi.org/deliver/etsi_ts/119500_119599/119511/01.02.01_60/ts_119511v010201p.pdf">
    /// ETSI TS 119 511 V1.2.1</see> 511-4.1.3, OVR-6.4-05.
    /// </para>
    /// <para>
    /// Proves <see href="https://www.etsi.org/deliver/etsi_ts/119500_119599/119512/01.02.01_60/ts_119512v010201p.pdf">
    /// ETSI TS 119 512 V1.2.1</see> 512-5.4.7.1-11, 512-5.4.7.1-12.
    /// </para>
    /// </remarks>
    [TestMethod]
    ...
    /// <remarks>
    /// Proves <see href="https://www.etsi.org/deliver/etsi_ts/119500_119599/119512/01.02.01_60/ts_119512v010201p.pdf">
    /// ETSI TS 119 512 V1.2.1</see> 512-5.3.4.1.1-4, 512-5.4.7.1-2.
    /// </remarks>
    [TestMethod]
    public void OnlyAnOperationAcceptingSubmittedContentOwesAnInputFormat()
    {
        PreservationProfile conformantForInputFormats = PreservationCapabilitySource.Profile();
        using(PreservationProfile withoutInputFormats = new()
        {
            ProfileIdentifier = conformantForInputFormats.ProfileIdentifier,
            Operations = [new PreservationOperationDescriptor { Name = PreservationWellKnown.PreservePreservationObjectOperation }],
            Policies = conformantForInputFormats.Policies,
            ValidityPeriod = conformantForInputFormats.ValidityPeriod,
            StorageModel = conformantForInputFormats.StorageModel,
            PreservationGoals = conformantForInputFormats.PreservationGoals,
            EvidenceFormats = conformantForInputFormats.EvidenceFormats,
            SchemeIdentifier = conformantForInputFormats.SchemeIdentifier,
            Specifications = conformantForInputFormats.Specifications,
            Descriptions = conformantForInputFormats.Descriptions,
            ExpectedEvidenceDuration = conformantForInputFormats.ExpectedEvidenceDuration,
            PreservationEvidenceRetentionPeriod = conformantForInputFormats.PreservationEvidenceRetentionPeriod,
            Extensions = conformantForInputFormats.Extensions
        })
        {
        ...
        PreservationProfile conformantForRetrievalOnly = PreservationCapabilitySource.Profile();
        using(PreservationProfile retrievalOnly = new()
        {
            ProfileIdentifier = conformantForRetrievalOnly.ProfileIdentifier,
            Operations = [new PreservationOperationDescriptor { Name = PreservationWellKnown.RetrievePreservationObjectOperation }],
            Policies = conformantForRetrievalOnly.Policies,
            ValidityPeriod = conformantForRetrievalOnly.ValidityPeriod,
            StorageModel = conformantForRetrievalOnly.StorageModel,
            PreservationGoals = conformantForRetrievalOnly.PreservationGoals,
            EvidenceFormats = conformantForRetrievalOnly.EvidenceFormats,
            SchemeIdentifier = conformantForRetrievalOnly.SchemeIdentifier,
            Specifications = conformantForRetrievalOnly.Specifications,
            Descriptions = conformantForRetrievalOnly.Descriptions,
            ExpectedEvidenceDuration = conformantForRetrievalOnly.ExpectedEvidenceDuration,
            PreservationEvidenceRetentionPeriod = conformantForRetrievalOnly.PreservationEvidenceRetentionPeriod,
            Extensions = conformantForRetrievalOnly.Extensions
        })
        {
    ...
    /// <remarks>
    /// Proves <see href="https://www.etsi.org/deliver/etsi_ts/119500_119599/119512/01.02.01_60/ts_119512v010201p.pdf">
    /// ETSI TS 119 512 V1.2.1</see> 512-5.4.7.1-7, 512-5.4.7.1-8.
    /// </remarks>
    [TestMethod]
    public void APermissionIsNotADepartureAndAnUnregisteredValueIsReportedNotRefused()
    {
        PreservationProfile conformantForPermissions = PreservationCapabilitySource.Profile();
        using(PreservationProfile withoutPermissions = new()
        {
            ProfileIdentifier = conformantForPermissions.ProfileIdentifier,
            Operations = conformantForPermissions.Operations,
            Policies = conformantForPermissions.Policies,
            ValidityPeriod = conformantForPermissions.ValidityPeriod,
            StorageModel = conformantForPermissions.StorageModel,
            PreservationGoals = conformantForPermissions.PreservationGoals,
            EvidenceFormats = conformantForPermissions.EvidenceFormats,
            SchemeIdentifier = null,
            Specifications = [],
            Descriptions = conformantForPermissions.Descriptions,
            ExpectedEvidenceDuration = conformantForPermissions.ExpectedEvidenceDuration,
            PreservationEvidenceRetentionPeriod = conformantForPermissions.PreservationEvidenceRetentionPeriod,
            Extensions = conformantForPermissions.Extensions
        })
        {
        ...
        PreservationProfile conformantForHouseFormats = PreservationCapabilitySource.Profile();
        using(PreservationProfile houseFormats = new()
        {
            ProfileIdentifier = conformantForHouseFormats.ProfileIdentifier,
            Operations = conformantForHouseFormats.Operations,
            Policies = conformantForHouseFormats.Policies,
            ValidityPeriod = conformantForHouseFormats.ValidityPeriod,
            StorageModel = conformantForHouseFormats.StorageModel,
            PreservationGoals = conformantForHouseFormats.PreservationGoals,
            ...
            Specifications = conformantForHouseFormats.Specifications,
            Descriptions = conformantForHouseFormats.Descriptions,
            ExpectedEvidenceDuration = conformantForHouseFormats.ExpectedEvidenceDuration,
            PreservationEvidenceRetentionPeriod = conformantForHouseFormats.PreservationEvidenceRetentionPeriod,
            Extensions = conformantForHouseFormats.Extensions
        })
        {
