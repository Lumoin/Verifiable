    ...
    public class Base64UrlRoundtripTests
    {
        ...
        public void Base64UrlEncoderDecoderRoundtripTest()
        {
            ...
            foreach(var originalData in testData)
            {
                ...
                string ourBase64Url = TestSetup.Base64UrlEncoder(originalData, emptyCodecHeader, pool);
                Console.WriteLine($"Our Base64Url: {ourBase64Url}");

                //Decode using our Base64Url decoder.
                using var decodedOwner = TestSetup.Base64UrlDecoder(ourBase64Url, 0, memPool);
                ...
                using var netDecodedOwner = TestSetup.Base64UrlDecoder(netBase64Url, 0, memPool);
        ...
        public void Base64UrlCharacterReplacementTest()
        {
            ...
            string ourBase64Url = TestSetup.Base64UrlEncoder(testData, emptyCodecHeader, pool);
            Console.WriteLine($"Our Base64Url: {ourBase64Url}");
        ...
        public void Base64UrlPaddingTest()
        {
            ...
            foreach(var (data, expectedPadding) in testCases)
            {
                ...
                string ourBase64Url = TestSetup.Base64UrlEncoder(data, emptyCodecHeader, pool);
