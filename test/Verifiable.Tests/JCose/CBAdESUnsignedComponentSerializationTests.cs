...
/// <summary>
/// Round-trip and strict-conformance tests for the CB-AdES unsigned components this agent owns —
/// <c>sigPSt</c>, <c>valData</c>, <c>refs</c>, and the four <see cref="AdESTimestampContainer"/> alias
...
internal sealed class CBAdESUnsignedComponentSerializationTests
{
    ...
    public void SignaturePolicyStoreRoundTripsWithDocumentArmAndSpDSpec()
    {
        ...
        var model = new CBAdESSignaturePolicyStore(new CBAdESSignaturePolicyStoreDocument(document), new AdESObjectIdentifier(spDSpecId.OriginalString));
        ...
        bool parsed = CBAdESSerialization.TryParseSignaturePolicyStore(expected, out CBAdESSignaturePolicyStore? result);
        Assert.IsTrue(parsed);
        Assert.AreEqual(spDSpecId.OriginalString, result!.SpDSpec!.Id);
    }
    ...
    public void SignaturePolicyStoreRoundTripsWithLocalUriArmAndSpDSpec()
    {
        ...
        var model = new CBAdESSignaturePolicyStore(new CBAdESSignaturePolicyStoreLocalUri(localUri), new AdESObjectIdentifier(spDSpecId.OriginalString));
    ...
    public void ValidationDataRoundTripsWithMultipleCertificateValuesInWireOrder()
    {
        ...
        [
            new CBAdESX509Certificate(new AdESPkiObject { Val = x509 }),
            new CBAdESOtherCertificate(new AdESPkiObject { Val = other })
        ]);
    ...
    public void ValidationDataRoundTripsWithCrlValuesOnly()
    {
        ...
        var model = new CBAdESValidationData(revocationValues: new CBAdESRevocationValues(crlValues: [new AdESPkiObject { Val = crl }]));
    ...
    public void ValidationDataRoundTripsWithOcspValuesOnly()
    {
        ...
        var model = new CBAdESValidationData(revocationValues: new CBAdESRevocationValues(ocspValues: [new AdESPkiObject { Val = ocsp }]));
    ...
    public void ValidationDataRoundTripsWithOtherValuesOnly()
    {
        ...
        var model = new CBAdESValidationData(revocationValues: new CBAdESRevocationValues(otherValues: [new AdESPkiObject { Val = otherVal }]));
    ...
    public void ValidationDataRoundTripsWithAllThreeRevocationValueKindsCombined()
    {
        ...
        var model = new CBAdESValidationData(revocationValues: new CBAdESRevocationValues(
            crlValues: [new AdESPkiObject { Val = crl }],
            ocspValues: [new AdESPkiObject { Val = ocsp }],
            otherValues: [new AdESPkiObject { Val = otherVal }]));
    ...
    public void ValidationDataRoundTripsWithBothCertificateAndRevocationValues()
    {
        ...
        var model = new CBAdESValidationData(
            certificateValues: [new CBAdESX509Certificate(new AdESPkiObject { Val = x509 })],
            revocationValues: new CBAdESRevocationValues(crlValues: [new AdESPkiObject { Val = crl }]));
...
#pragma warning disable CA2000 // Dispose objects before losing scope: ownership chains into 'references' below, disposed by the trailing 'using'.
        var certificateReference = new CBAdESCertificateReference(
            new AdESCertificateThumbprint(new AdESDigestAlgorithmIntegerIdentifier(WellKnownCoseAlgorithms.Sha256), digest),
...
#pragma warning disable CA2000 // Dispose objects before losing scope
        var firstReference = new CBAdESCertificateReference(new AdESCertificateThumbprint(new AdESDigestAlgorithmIntegerIdentifier(WellKnownCoseAlgorithms.Sha256), firstDigest));
        var secondReference = new CBAdESCertificateReference(
            new AdESCertificateThumbprint(new AdESDigestAlgorithmIntegerIdentifier(WellKnownCoseAlgorithms.Sha384), secondDigest),
...
#pragma warning restore CA2000 // Dispose objects before losing scope
    ...
    /// <remarks>
    /// Proves <see href="https://www.etsi.org/deliver/etsi_ts/119100_119199/11915201/01.01.01_60/ts_11915201v010101p.pdf">ETSI TS 119 152-1 V1.1.1</see>
    /// CB-A.1.1-11, CB-A.1.1-12, CB-A.1.1-13.
    /// </remarks>
    [TestMethod]
...
#pragma warning disable CA2000 // Dispose objects before losing scope
        var crlReference = new CBAdESCrlReference(new AdESDigestAlgorithmIntegerIdentifier(WellKnownCoseAlgorithms.Sha256), digest);
...
#pragma warning restore CA2000 // Dispose objects before losing scope
    ...
    /// <remarks>
    /// Proves <see href="https://www.etsi.org/deliver/etsi_ts/119100_119199/11915201/01.01.01_60/ts_11915201v010101p.pdf">ETSI TS 119 152-1 V1.1.1</see>
    /// CB-A.1.1-14, CB-A.1.1-15, CB-A.1.1-16, CB-A.1.1-17.
    /// </remarks>
    [TestMethod]
...
#pragma warning restore CA2000 // Dispose objects before losing scope
    ...
    /// <remarks>
    /// Proves <see href="https://www.etsi.org/deliver/etsi_ts/119100_119199/11915201/01.01.01_60/ts_11915201v010101p.pdf">ETSI TS 119 152-1 V1.1.1</see>
    /// CB-A.1.1-20, CB-A.1.1-23, CB-A.1.1-25, CB-A.1.1-28.
    /// </remarks>
    [TestMethod]
...
#pragma warning restore CA2000 // Dispose objects before losing scope
    ...
    /// <summary>
    /// <c>OCSPRef</c>'s by-key responder identifier round-trips the raw DER
    /// <c>ResponderID.byKey</c> bytes byte-exactly — no base64 transformation in either direction.
    /// </summary>
    /// <remarks>
    /// Proves <see href="https://www.etsi.org/deliver/etsi_ts/119100_119199/11915201/01.01.01_60/ts_11915201v010101p.pdf">ETSI TS 119 152-1 V1.1.1</see>
    /// CB-A.1.1-22, CB-A.1.1-24, CB-A.1.1-27.
    /// </remarks>
    [TestMethod]
...
#pragma warning restore CA2000 // Dispose objects before losing scope
        ...
        using PooledMemory encoded = CBAdESSerialization.EncodeReferences(references, BaseMemoryPool.Shared);
        Assert.IsTrue(expected.AsSpan().SequenceEqual(encoded.AsReadOnlySpan()), "The encoded byKey bytes must be the raw DER bytes, not a base64 transformation.");
        ...
        using(result)
        {
            ...
            Assert.IsTrue(keyDigest.AsSpan().SequenceEqual(byKey.KeyDigest.Span), "The parsed byKey bytes must equal the raw DER bytes byte-exactly.");
    ...
    /// <summary>
    /// <c>otherRefs</c> items round-trip as opaque, byte-exact CBOR values (not OCSP-only,
    /// CB-A.1.1-29).
    /// </summary>
    [TestMethod]
...
#pragma warning disable CA2000 // Dispose objects before losing scope
        var certificateReference = new CBAdESCertificateReference(new AdESCertificateThumbprint(new AdESDigestAlgorithmIntegerIdentifier(WellKnownCoseAlgorithms.Sha256), certificateDigest));
        var crlReference = new CBAdESCrlReference(new AdESDigestAlgorithmIntegerIdentifier(WellKnownCoseAlgorithms.Sha256), crlDigest);
        var ocspReference = new CBAdESOcspReference(
            new AdESDigestAlgorithmIntegerIdentifier(WellKnownCoseAlgorithms.Sha256), ocspDigest,
...
#pragma warning restore CA2000 // Dispose objects before losing scope
    ...
    /// <summary><c>sigTst</c>'s wrapper codec round-trips through <see cref="AdESTimestampContainer"/>, disposing its parsed result.</summary>
    /// <remarks>
    /// Proves <see href="https://www.etsi.org/deliver/etsi_ts/119100_119199/11915201/01.01.01_60/ts_11915201v010101p.pdf">ETSI TS 119 152-1 V1.1.1</see>
    /// CB-5.3.3-01.
    /// </remarks>
    ...
    public void SignatureTimestampRoundTripsThroughWrapperCodec()
    {
        ...
        //CA2000: ownership of the inline AdESTimestampContainer transfers immediately into 'model' below,
...
#pragma warning restore CA2000 // Dispose objects before losing scope
    ...
    /// <summary><c>arcTst</c>'s wrapper codec round-trips through <see cref="AdESTimestampContainer"/>, disposing its parsed result.</summary>
    /// <remarks>
    /// Proves <see href="https://www.etsi.org/deliver/etsi_ts/119100_119199/11915201/01.01.01_60/ts_11915201v010101p.pdf">ETSI TS 119 152-1 V1.1.1</see>
    /// CB-5.3.5.1-04, CB-5.3.5.2-04.
    /// </remarks>
    [TestMethod]
...
#pragma warning restore CA2000 // Dispose objects before losing scope
    ...
    /// <summary><c>sigRTst</c>'s wrapper codec round-trips through <see cref="AdESTimestampContainer"/>, disposing its parsed result.</summary>
    /// <remarks>
    /// Proves <see href="https://www.etsi.org/deliver/etsi_ts/119100_119199/11915201/01.01.01_60/ts_11915201v010101p.pdf">ETSI TS 119 152-1 V1.1.1</see>
    /// CB-A.1.2.1-01.
    /// </remarks>
...
#pragma warning restore CA2000 // Dispose objects before losing scope
    ...
    /// <summary><c>rfsTst</c>'s wrapper codec round-trips through <see cref="AdESTimestampContainer"/>, disposing its parsed result.</summary>
    /// <remarks>
    /// Proves <see href="https://www.etsi.org/deliver/etsi_ts/119100_119199/11915201/01.01.01_60/ts_11915201v010101p.pdf">ETSI TS 119 152-1 V1.1.1</see>
    /// CB-A.1.2.2-01.
    /// </remarks>
...
#pragma warning restore CA2000 // Dispose objects before losing scope
    ...
    /// <summary>Builds a minimal, single-token <see cref="AdESTimestampContainer"/> fixture shared by every wrapper positive/negative test in this file.</summary>
    /// <returns>The built fixture.</returns>
    private static AdESTimestampContainer CreateTimestampContainerFixture() =>
        new([new AdESTimestampToken { Val = new byte[] { 0x30, 0x03, 0x02, 0x01, 0x01 } }]);
    ...
    /// <see cref="CborWriter"/> — the raw DER bytes go straight into the <c>bstr</c>,
    /// with no base64 transformation, matching this suite's independent-oracle discipline.
    /// </summary>
    /// <param name="writer">The CBOR writer.</param>
        ...
        IReadOnlyList<byte[]>? otherReferenceItems)
    {
        ...
        if(hasRRefs)
        {
            ...
            {
                writer.WriteInt32(3); // otherRefs, Table A.1 (rRefs) -- not OCSP-only.
