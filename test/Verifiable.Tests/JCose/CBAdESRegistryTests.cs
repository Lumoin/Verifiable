...
/// <summary>
/// Tests for the CB-AdES vocabulary registries — <see cref="CBAdESHeaderParameters"/> (clause 5.2.1
...
internal sealed class CBAdESRegistryTests
{
    ...
    /// cross-verified against Annex B's IANA registry entries and the inline CDDL
    ...
    /// CB-5.2.1-02, CB-5.2.1-03, CB-5.2.1-04, CB-5.2.2-02, CB-5.2.3-02, CB-5.2.4-02, CB-5.2.5-02, CB-5.2.6-02,
    /// CB-5.2.7-02, CB-5.2.8-02, CB-5.3.1-06.
    /// </remarks>
    [TestMethod]
