...
namespace Verifiable.Tests.Core
{
    ...
    public sealed class CryptographicCrossTests
    {
        ...
        {            
            ...
            using var signature = await privateKey.SignAsync(data, NSecAlgorithms.SignEd25519Async, ExactSizeMemoryPool<byte>.Shared);
        ...
        {            
            ...
            using var signature = await privateKey.SignAsync(data, BouncyCastleAlgorithms.SignEd25519Async, ExactSizeMemoryPool<byte>.Shared);
