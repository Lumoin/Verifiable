...
/// reader/writer composes: the CTAP2 canonical integer-width bands (CTAP 2.3 §8, Message Encoding) and
/// the <c>icon</c> forward-compatibility tolerance (CTAP 2.3 §6.1's MAY/MUST-NOT pair).
/// </summary>
[TestClass]
internal sealed class CtapCommandEntityCborCodecTests
{
    /// <summary>
    /// CTAP 2.3 §8: an <c>alg</c> value in [24, 255] (100) is written as the exact 2-byte
    ...
    /// <summary>
    /// CTAP 2.3 §8: an <c>alg</c> value in [256, 65535] (1000) is written as the exact 3-byte
    ...
    /// <summary>
    /// CTAP 2.3 §8: an <c>alg</c> value in [65536, 4294967295] (100000) is written as the exact 5-byte
    ...
    /// <summary>
    /// CTAP 2.3 §8: a 24-element <c>PublicKeyCredentialParameters</c> array's own length prefix is the
    ...
    /// <summary>
    /// CTAP 2.3 §6.1, both the MAY and MUST-NOT halves of "Authenticators MUST NOT error if
