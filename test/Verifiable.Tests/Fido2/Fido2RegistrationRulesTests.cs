...
internal sealed class Fido2RegistrationRulesTests
{
    ...
    {
        var issuer = new ClaimIssuer<RegistrationCeremonyInput>("fido2-registration-rules-test", Fido2ValidationProfiles.RegistrationRules(), new FakeTimeProvider(TestClock.CanonicalEpoch));
