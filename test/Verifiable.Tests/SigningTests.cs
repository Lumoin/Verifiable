...
namespace Verifiable.Tests
{
    ...
    public sealed class SigningTests
    {
        ...
        public async ValueTask CanSignDidWeb()
        {
            ...
            var multibaseDecodedPublicKey = MultibaseSerializer.Decode(Vc0PublicKey, Verifiable.Core.Cryptography.SensitiveMemoryPool<byte>.Shared, Base58.Bitcoin.Decode);
            var multibaseDecodedPrivateKey = MultibaseSerializer.Decode(Vc0PrivateKey, Verifiable.Core.Cryptography.SensitiveMemoryPool<byte>.Shared, Base58.Bitcoin.Decode);
            ...
            var pooledProofSignatureBytes = Verifiable.Core.Cryptography.SensitiveMemoryPool<byte>.Shared.Rent(proofValueBytes.Length);
