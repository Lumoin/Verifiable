...
namespace Verifiable.Tests.Did
{
    ...
    internal sealed class DidDocumentTests
    {
        ...
        /// <summary>
        /// Tests that DidDocument can read a DID documents that has <see cref="VerifiableCredentialService"/>
        /// this tests without a provided strong type to see if <see cref="Service"/> is serialized.</summary>
        /// <remarks>By default reading is allowed.
