...
internal sealed class SiopCombinedResponseTests
{
    ...
    /// Client ID — and serialise the presentation with key binding per RFC 9901 §4.3. Delegates to
    /// the shared <see cref="SdJwtVpFixture.PresentWithKeyBindingAsync"/>, the same composition
    /// <c>TestWallet</c> and the production wallet client run.
    /// </summary>
