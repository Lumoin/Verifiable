...
/// baseline. That test pins the producer's minimal spec-mandated output.
/// This test pins the contributor chain's extension-claim output.
/// Together they bracket every claim the token endpoint can emit.
/// </para>
/// </remarks>
[TestClass]
internal sealed class ContributorChainRegressionTests
{
    ...
    public void StandardRulesAreRegisteredInExpectedOrder()
    {
        ...
        Assert.HasCount(6, rules,
            "StandardRules registers six contributor rules: profile, email, address, phone, cnf, acr+amr+auth_time.");
