...
namespace Verifiable.Tests.Builders
{
    ...
    public sealed class KeyDidBuilderTests
    {
        ...
        public async ValueTask CreateAndPerformKeyExchangeUsingDidKey()
        {
            ...
            var keyPair = BouncyCastleKeyCreator.CreateX25519Keys(ExactSizeMemoryPool<byte>.Shared);
            ...
            var otherPartyKeyPair = BouncyCastleKeyCreator.CreateX25519Keys(ExactSizeMemoryPool<byte>.Shared);
            ...
            using var sharedSecret1 = await BouncyCastleCryptographicFunctions.DeriveX25519SharedSecretAsync(
                ...
                ExactSizeMemoryPool<byte>.Shared);
            ...
            using var sharedSecret3 = await DeriveSharedSecretAsync(
                keyAgreementMethod, otherPartyKeyPair.PrivateKey, ExactSizeMemoryPool<byte>.Shared);
