...
public sealed class CredentialBuilderTests
{
    ...
    public async Task BuildWithSingleSubjectCreatesValidCredential()
    {
        ...
        var credential = await CredentialBuilder.BuildAsync(issuer, subject, additionalTypes: [AlumniCredentialType]);
    ...
    public async Task BuildWithMultipleSubjectsCreatesValidCredential()
    {
        ...
        var credential = await CredentialBuilder.BuildAsync(issuer, subjects);
    ...
    public async Task BuildWithCustomIdUsesProvidedId()
    {
        ...
        var credential = await CredentialBuilder.BuildAsync(issuer, subject, credentialId: CustomCredentialId);
    ...
    public async Task BuildWithValidityPeriodSetsValidFromAndValidUntil()
    {
        ...
        var credential = await CredentialBuilder.BuildAsync(issuer, subject, validFrom: validFrom, validUntil: validUntil);
    ...
    public async Task BuildWithIssuerMetadataPreservesMetadata()
    {
        ...
        var credential = await CredentialBuilder.BuildAsync(issuer, subject);
    ...
    public async Task BuildWithCustomIdGeneratorUsesGenerator()
    {
        ...
        var credential1 = await customBuilder.BuildAsync(issuer, subject);
        var credential2 = await customBuilder.BuildAsync(issuer, subject);
    ...
    public async Task BuildWithSeedCredentialUsesProvidedSeed()
    {
        ...
        var credential = await CredentialBuilder.BuildAsync(seedCredential, issuer, [subject]);
    ...
    public async Task BuildWithNullIssuerThrowsArgumentNullException()
    {
        ...
        await Assert.ThrowsAsync<ArgumentNullException>(async () => await CredentialBuilder.BuildAsync(null!, subject));
    }
    ...
    public async Task BuildWithNullSubjectThrowsArgumentNullException()
    {
        ...
        await Assert.ThrowsAsync<ArgumentNullException>(async () => await CredentialBuilder.BuildAsync(issuer, (CredentialSubjectInput)null!));
    }
    ...
    public async Task BuildWithEmptySubjectsThrowsArgumentException()
    {
        ...
        var exception = await Assert.ThrowsAsync<ArgumentException>(async () => await CredentialBuilder.BuildAsync(issuer, emptySubjects));
    ...
    public async Task BuildWithExtendedBuilderAddsCustomTransformations()
    {
        ...
        var credential = await customBuilder.BuildAsync(issuer, subject);
    ...
    public async Task BuildWithAnonymousSubjectOmitsSubjectId()
    {
        ...
        var credential = await CredentialBuilder.BuildAsync(issuer, subject, additionalTypes: [MembershipCredentialType]);
    ...
    public async Task BuildWithDictionaryAndStronglyTypedClaimsProducesEquivalentCredentials()
    {
        ...
        var credentialFromDictionary = await CredentialBuilder.BuildAsync(issuer, dictionarySubject, additionalTypes: [AlumniCredentialType]);
        var credentialFromTyped = await CredentialBuilder.BuildAsync(issuer, typedSubject, additionalTypes: [AlumniCredentialType]);
