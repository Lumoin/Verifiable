...
namespace Verifiable.Tests
{
    ...
    public class DidDocumentTests
    {
        ...
        [Theory]
        [FilesData(TestInfrastructureConstants.RelativeTestPathToCurrentDid, "did-verifiablecredentialservice-1.json")]
        ...
        /// <param name="didDocumentFileContents">The DID document data file contents.</param>
        [Theory]
        [FilesData(TestInfrastructureConstants.RelativeTestPathToCurrentDid, ".json", SearchOption.AllDirectories)]
