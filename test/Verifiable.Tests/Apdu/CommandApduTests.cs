...
internal sealed class CommandApduTests
{
    ...
    public void Case1HeaderOnly()
    {
        ...
        ReadOnlySpan<byte> bytes = command.Memory.Span[..ApduConstants.CommandHeaderSize];
    ...
    public void Case2ShortLeEncoding()
    {
        ...
        ReadOnlySpan<byte> bytes = command.Memory.Span[..5];
        Assert.AreEqual((byte)0x00, bytes[0]);
    ...
    public void Case2ExtendedLeEncoding()
    {
        ...
        ReadOnlySpan<byte> bytes = command.Memory.Span[..7];
        Assert.AreEqual((byte)0x00, bytes[0]);
    ...
    public void Case3ShortLcEncoding()
    {
        ...
        ReadOnlySpan<byte> bytes = command.Memory.Span[..8];
        Assert.AreEqual((byte)0x00, bytes[0]);
        Assert.AreEqual((byte)0xCB, bytes[1]);
    ...
    public void Case3ExtendedLcForLargeData()
    {
        ...
        ReadOnlySpan<byte> bytes = command.Memory.Span[..307];
        Assert.AreEqual((byte)0x00, bytes[0]);
    ...
    public void Case4ShortEncoding()
    {
        ...
        ReadOnlySpan<byte> bytes = command.Memory.Span[..11];
        Assert.AreEqual((byte)0x00, bytes[0]);
        Assert.AreEqual((byte)0xCB, bytes[1]);
    ...
    public void Case4MatchesYubiKeyPivSelectFromTrace()
    {
        ...
        ReadOnlySpan<byte> bytes = command.Memory.Span[..15];
