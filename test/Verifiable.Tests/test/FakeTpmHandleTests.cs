...
namespace Verifiable.Tests.test
{
    ...
    public class FakeTpmHandleTests
    {
        ...
        public async ValueTask FakeTpmHandleTest()
        {
            ...
            var handleBytes = ExactSizeMemoryPool<byte>.Shared.Rent(Encoding.UTF8.GetByteCount(tpmHandle));
            ...
            var fakeSignature = new Signature(ExactSizeMemoryPool<byte>.Shared.Rent(64), Tag.Empty);
